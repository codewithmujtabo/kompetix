...
// Student guard for the exam player — mirrors the dashboard layout: a logged-in
// non-admin participant only; admins are bounced to the admin view.
...
export default function CompetitionExamLayout({ children }: { children: ReactNode }) {
