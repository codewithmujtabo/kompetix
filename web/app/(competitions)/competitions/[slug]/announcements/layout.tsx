...
// Student guard for the announcements feed — mirrors the dashboard layout:
// a logged-in non-admin participant only; admins are bounced.
...
export default function CompetitionAnnouncementsLayout({ children }: { children: ReactNode }) {
