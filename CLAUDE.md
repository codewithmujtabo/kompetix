...
### EMC Port (begins 2026-05-13) — Waves 1–3 ✅ COMPLETE · Wave 4 🚧 IN EXECUTION
...
- **Wave 2–12 preview** (Wave 4 re-scoped 2026-05-16 — question-bank UI split into its own wave, later waves shift +1): (2) professional web UI/UX unification ✅; (3) mobile app re-theme ✅; (4) `/competitions` catalog + admin move + per-competition step-flow engine; (5) question-bank authoring UI; (6) online + paper exam delivery; (7) test-center / area / webcam proctoring; (8) vouchers + products + orders UI; (9) referrals + announcements + materials; (10) mobile rollout of student surfaces; (11) certificate PDF + QR verify + barcode; (12) data import from legacy `kompetisi.net` MySQL.
...
### SPRINT 23 — EMC Wave 4: The Student Competition Experience (May 16, 2026 — Session 11) 🚧 IN EXECUTION
Wave 4 turns the student-facing competition flow from scaffolding into a real experience: a `/competitions` catalog, the admin competitions page relocated to `/admin/competitions`, and a config-driven per-competition step-flow engine (`competition_flows` table). The question-bank authoring UI was split out to Wave 5. Plan: `/Users/mujtabo/.claude/plans/effervescent-booping-horizon.md`. Phases: (1) catalog + admin move; (2) `competition_flows` schema + step-flow API; (3) stepper UI + admin flow editor.
| Task | What | Key files |
|---|---|---|
