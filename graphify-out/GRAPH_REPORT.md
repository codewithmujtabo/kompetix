...
## Corpus Check
- 322 files · ~3,397,640 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2683 nodes · 5460 edges · 202 communities (129 shown, 73 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 92 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `af3a95f7`
...
3. `Card()` - 60 edges
4. `apiRequest()` - 59 edges
5. `Button()` - 58 edges
6. `PageHeader()` - 47 edges
7. `Sprint Plan (Full Roadmap)` - 43 edges
8. `Brand` - 41 edges
9. `pool` - 40 edges
10. `Badge()` - 39 edges
...
## Communities (202 total, 73 thin omitted)

### Community 0 - "Admin Mobile Screens"
Cohesion: 0.04
Nodes (48): Registration, apiRequest(), RequestOptions, AuthResponse, getMe(), sendOtp(), sendPhoneOtp(), create() (+40 more)

### Community 1 - "School Auth Context"
Cohesion: 0.04
Nodes (40): Shadow, Spacing, Text, Type, Slide, slides, styles, IoniconName (+32 more)

### Community 2 - "Mobile API Service Layer"
Cohesion: 0.07
Nodes (43): BatchResult, BulkPaymentPage(), fmtRp(), RegistrationRow, CompetitionPicker(), QuestionBankDashboard(), QuestionRow, fmt() (+35 more)
...
Cohesion: 0.07
Nodes (49): questionBankHttp, { Provider, useHook }, CATEGORIES, CompetitionFormProps, DEFAULTS, GRADE_LEVELS, STATUSES, ExamsListPage() (+41 more)
...
Cohesion: 0.04
Nodes (44): compFilter(), liveFilter(), SOFT_DELETE_TABLES, softDelete(), requireRole(), CHECK_TYPES, CheckType, compId (+36 more)

### Community 7 - "Web Auth Contexts"
Cohesion: 0.07
Nodes (38): commerceHttp, CHECK_TYPE_LABEL, CHECK_TYPE_OPTIONS, CheckType, FlowEditorDialog(), FlowStep, FORM_DEFAULTS, ACTIONABLE (+30 more)
...
Cohesion: 0.06
Nodes (27): BulkJob, styles, Registration, School, Student, styles, HapticTab(), NotificationTabIcon() (+19 more)
...
Cohesion: 0.05
Nodes (44): code:block6 (T5 (reg_number) ──────────► T16 (mobile shows it)), Dependency Map, SPRINT 0 — Quick Wins ✅ COMPLETE, SPRINT 10 — Mobile Bug Fixes (May 6, 2026 Session 2) ✅ COMPLETE, SPRINT 11 — Bug Fixes (May 6, 2026 Session 3) ✅ COMPLETE, SPRINT 12 — Rebrand Kompetix → Competzy (May 8, 2026 Session 4) ✅ COMPLETE, SPRINT 13 — Production Infra Templates (May 9, 2026 Session 5) ✅ LOCAL ARTIFACTS DONE, SPRINT 14 — Compliance & Security Hardening (May 8–9, 2026 Sessions 4–5) ✅ COMPLETE (+36 more)
...
Cohesion: 0.08
Nodes (25): CatalogCompetition, CATEGORIES, CATS, CompetitionCard(), CompetitionsPage(), Field(), FILTERS, fmtDate() (+17 more)

### Community 19 - "Web Competitions Page"
Cohesion: 0.12
Nodes (19): FILTERS, schoolHttp, ExamRow, QueueRow, Competition, STATUS_BADGE, STATUS_STYLE, ProctoringPage() (+11 more)
...
Cohesion: 0.1
Nodes (20): CompetitionAdminPage(), EmcAdminPage(), PendingRow, StatusFilter, emcHttp, { Provider, useHook }, PortalCompetition, usePortalComp() (+12 more)

### Community 23 - "Teacher Mobile Flow"
Cohesion: 0.08
Nodes (20): navTheme, queryClient, RootLayout(), styles, AuthTab, styles, AppInput(), AppInputProps (+12 more)

### Community 24 - "Payments Backend"
Cohesion: 0.11
Nodes (31): area(), exam(), localToday(), main(), product(), question(), sampleOrder(), SeedQuestion (+23 more)
...
Cohesion: 0.09
Nodes (27): Separator(), Sidebar(), SidebarContent(), SidebarContext, SidebarContextProps, SidebarGroupAction(), SidebarGroupContent(), SidebarGroupLabel() (+19 more)
...
Cohesion: 0.14
Nodes (10): TYPES, FORM_DEFAULTS, PageHeader(), Pager(), Spinner(), Toast(), Input(), ROLE_CLS (+2 more)
...
Cohesion: 0.12
Nodes (14): useIsMobile(), QuestionBankProvider(), NAV, AppShell(), AppShellProps, AppShellUser, initials(), NavItem (+6 more)
...
Cohesion: 0.16
Nodes (13): CompetitionStudent, DashboardSummary, Deadline, getDashboardSummary(), getMyCompetitions(), getMyStudents(), getUpcomingDeadlines(), linkStudent() (+5 more)
...
Cohesion: 0.22
Nodes (10): fmtDate(), Order, OrderItem, OrdersPage(), rupiah(), STATUS_STYLE, StorefrontOrder, TABS (+2 more)
...
Cohesion: 0.24
Nodes (11): AppAutocomplete, AppInput, ProfileCompletionScreen, ProfileEditScreen, Brand + Colors + Category palettes, ThemedText, ThemedView, useColorScheme (native) (+3 more)
...
## Knowledge Gaps
- **1109 isolated node(s):** `{ defineConfig }`, `expoConfig`, `RegistrationStatus`, `AuthContextType`, `BulkJob` (+1104 more)
...
- **Why does `Button()` connect `Web Auth Contexts` to `Web Auth API`, `School Auth Context`, `Mobile API Service Layer`, `Cluster 66`, `Mobile Tabs Misc`, `Database Columns & Keys`, `Competitions CSV Seeder`, `Express Bootstrap & Errors`, `Cluster 102`, `Themed Components & Hooks`, `Cluster 79`, `Cluster 80`, `Mobile Doc & User Services`, `Web Competitions Page`, `Reset Project Script`, `Web API Index`, `Documents Backend`, `School Admin Routes`?**
  _High betweenness centrality (0.062) - this node is a cross-community bridge._
- **Why does `cn()` connect `Web Auth API` to `Mobile API Service Layer`, `Cluster 66`, `Mobile Tabs Misc`, `Database Columns & Keys`, `Competitions CSV Seeder`, `Web Auth Contexts`, `Themed Components & Hooks`, `Cluster 76`, `Cluster 80`, `Mobile Registrations Service`, `Mobile Doc & User Services`, `Web Competitions Page`, `Cluster 61`, `Documents Backend`, `School Admin Routes`?**
  _High betweenness centrality (0.036) - this node is a cross-community bridge._
- **Why does `Card()` connect `Mobile API Service Layer` to `Web Auth API`, `School Auth Context`, `Cluster 66`, `Express Bootstrap & Errors`, `Database Columns & Keys`, `Competitions CSV Seeder`, `Cluster 102`, `Web Auth Contexts`, `Cluster 79`, `Cluster 80`, `Mobile Registrations Service`, `Mobile Doc & User Services`, `Web Competitions Page`, `Web API Index`, `Documents Backend`?**
