...
## Corpus Check
- 273 files · ~3,341,676 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2276 nodes · 4117 edges · 200 communities (126 shown, 74 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 72 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `142be513`
...
## Communities (200 total, 74 thin omitted)

### Community 0 - "Admin Mobile Screens"
Cohesion: 0.05
Nodes (65): CompetitionAdminLayout(), CompetitionAdminPage(), EmcAdminPage(), PendingRow, StatusFilter, adminHttp, emcHttp, metadata (+57 more)

### Community 1 - "School Auth Context"
Cohesion: 0.05
Nodes (49): http, organizerHttp, req(), token(), authApi, competitionsApi, notificationsApi, organizerAuthApi (+41 more)
...
Cohesion: 0.08
Nodes (32): FILTERS, schoolHttp, { Provider, useHook }, SchoolContext, SchoolCtx, schoolFetch(), schoolHttp, useSchool() (+24 more)
...
Cohesion: 0.06
Nodes (28): Shadow, Spacing, Text, Type, PAYER_OPTIONS, PayerKind, PaymentState, STATE_CONTENT (+20 more)

### Community 7 - "Web Auth Contexts"
Cohesion: 0.08
Nodes (34): CATEGORIES, CompetitionFormProps, DEFAULTS, GRADE_LEVELS, STATUSES, cn(), TYPES, SchoolPendingPage() (+26 more)

### Community 8 - "Auth & Competitions Routes"
Cohesion: 0.07
Nodes (27): Kpi, LINKS, QUICK_LINKS, Activity, Competition, fmtRp(), OrganizerDashboardPage(), RecentActivity (+19 more)
...
Cohesion: 0.11
Nodes (18): STATUS_CLS, STATUS_STYLE, StatusBadge(), STATUSES, FORM_DEFAULTS, Pager(), PagerProps, Button() (+10 more)
...
Cohesion: 0.09
Nodes (18): CATEGORIES, CATS, FILTERS, FORM_DEFAULTS, ACTIONABLE, ACTIONABLE_STATUSES, Competition, Registration (+10 more)
...
Cohesion: 0.12
Nodes (22): Sidebar(), SidebarContext, SidebarContextProps, SidebarGroupAction(), SidebarInput(), SidebarMenu(), SidebarMenuAction(), SidebarMenuBadge() (+14 more)
...
Cohesion: 0.13
Nodes (13): errorHandler(), HttpError, Province, provinces, regencies, Regency, router, verifySignedUrlToken() (+5 more)
...
## Knowledge Gaps
- **908 isolated node(s):** `{ defineConfig }`, `expoConfig`, `RegistrationStatus`, `AuthContextType`, `BulkJob` (+903 more)
...
- **Why does `Button()` connect `Mobile Theme System` to `Admin Mobile Screens`, `Web Admin Layout`, `Admin / Audit Middleware`, `Web Auth Contexts`, `Auth Register Screen`, `Web UI Components`, `Concept / Rationale Nodes`, `Cluster 57`, `Cluster 58`, `Analytics & Competition Detail`?**
  _High betweenness centrality (0.046) - this node is a cross-community bridge._
- **Why does `Card()` connect `Auth & Competitions Routes` to `Admin Mobile Screens`, `Web Admin Layout`, `Cluster 58`, `Web Auth Contexts`, `Mobile Theme System`, `Web UI Components`, `Concept / Rationale Nodes`, `Cluster 57`, `Documents Backend`?**
  _High betweenness centrality (0.023) - this node is a cross-community bridge._
- **Why does `cn()` connect `Web Auth Contexts` to `Cluster 64`, `Web Admin Layout`, `Auth & Competitions Routes`, `Cluster 73`, `Auth Register Screen`, `Mobile Theme System`, `Web UI Components`, `Concept / Rationale Nodes`, `Profile Completion`, `Cluster 57`, `Cluster 58`, `Analytics & Competition Detail`?**
