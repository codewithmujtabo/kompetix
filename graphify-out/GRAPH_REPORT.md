...
## Corpus Check
- 310 files · ~3,385,052 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2607 nodes · 5176 edges · 195 communities (122 shown, 73 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 80 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `127b4ebf`
...
## Communities (195 total, 73 thin omitted)

### Community 0 - "Admin Mobile Screens"
Cohesion: 0.04
Nodes (53): navTheme, queryClient, styles, AuthTab, styles, AppInput(), AppInputProps, styles (+45 more)
...
Cohesion: 0.04
Nodes (58): compFilter(), liveFilter(), SOFT_DELETE_TABLES, softDelete(), audit(), AuditOptions, REDACT_KEYS, requireRole() (+50 more)

### Community 3 - "Web Admin Layout"
Cohesion: 0.06
Nodes (42): FILTERS, CATEGORIES, CATS, CompetitionsPage(), Field(), FILTERS, fmtForInput(), FORM_DEFAULTS (+34 more)

### Community 4 - "Database Columns & Keys"
Cohesion: 0.07
Nodes (48): questionBankHttp, { Provider, useHook }, CATEGORIES, CompetitionFormProps, DEFAULTS, GRADE_LEVELS, STATUSES, CHECK_TYPE_LABEL (+40 more)

### Community 5 - "Backend DB Bootstrap"
Cohesion: 0.07
Nodes (38): schoolHttp, { Provider, useHook }, SchoolContext, SchoolCtx, schoolFetch(), schoolHttp, useSchool(), BulkRegistrationPage() (+30 more)

### Community 6 - "Admin / Audit Middleware"
Cohesion: 0.07
Nodes (43): ExamsListPage(), GradingQueuePage(), QuestionEditorPage(), ProctoringPage(), ProctoringSession, CompetitionPicker(), useQuestionBank(), QuestionBankDashboard() (+35 more)

### Community 7 - "Web Auth Contexts"
Cohesion: 0.04
Nodes (53): mapProduct(), pageParams(), productCompIfAccessible(), ansByQ, byNumber, chosen, CLEARED_REG, compId (+45 more)
...
Cohesion: 0.09
Nodes (13): authApi, NAV, AuthProvider(), Ctx, useAuth(), DashboardLayout(), Dashboard(), DashboardPage() (+5 more)

### Community 29 - "School Admin Routes"
Cohesion: 0.1
Nodes (19): BatchResult, BulkPaymentPage(), fmtRp(), RegistrationRow, CatalogCompetition, CompetitionCard(), fmtDate(), fmtDateTime() (+11 more)
...
Cohesion: 0.12
Nodes (22): Sidebar(), SidebarContext, SidebarContextProps, SidebarGroup(), SidebarGroupAction(), SidebarHeader(), SidebarInput(), SidebarMenuAction() (+14 more)
...
Cohesion: 0.16
Nodes (11): metadata, RootLayout(), AuthContext, AuthCtx, AuthProvider(), { Provider, useHook }, useAuth(), NAV (+3 more)

### Community 58 - "Cluster 58"
Cohesion: 0.33
Nodes (9): CompetitionAdminLayout(), { Provider, useHook }, competitionPaths(), competitionRegistry, defaultPortalConfig(), getCompetitionConfig(), CompetitionDashboardLayout(), CompetitionExamLayout() (+1 more)

### Community 59 - "Cluster 59"
Cohesion: 0.13
Nodes (9): AuthContext, AuthContextType, RegistrationStatus, IoniconName, PAYER_OPTIONS, PayerKind, PaymentState, STATE_CONTENT (+1 more)
...
## Knowledge Gaps
- **1075 isolated node(s):** `{ defineConfig }`, `expoConfig`, `RegistrationStatus`, `AuthContextType`, `BulkJob` (+1070 more)
...
- **Why does `Button()` connect `School Admin Routes` to `Admin Mobile Screens`, `Web Admin Layout`, `Mobile Tabs Misc`, `Backend DB Bootstrap`, `Database Columns & Keys`, `Admin / Audit Middleware`, `Mobile Admin Service`, `Cluster 77`, `Cluster 79`, `Mobile Registrations Service`, `Reset Project Script`, `Web API Index`, `Document Vault Flow`, `Cluster 95`?**
  _High betweenness centrality (0.060) - this node is a cross-community bridge._
- **Why does `Card()` connect `Admin / Audit Middleware` to `Admin Mobile Screens`, `Web Admin Layout`, `Database Columns & Keys`, `Backend DB Bootstrap`, `Cluster 77`, `Organizer Competition Forms`, `Cluster 79`, `Web API Index`, `Document Vault Flow`, `Auth Login & Profile Setup`, `School Admin Routes`, `Cluster 95`?**
  _High betweenness centrality (0.032) - this node is a cross-community bridge._
- **Why does `cn()` connect `Web API Index` to `Web Admin Layout`, `Mobile Tabs Misc`, `Backend DB Bootstrap`, `Database Columns & Keys`, `Admin / Audit Middleware`, `Mobile Admin Service`, `Cluster 76`, `Cluster 77`, `Historical Phone Login`, `Cluster 79`, `Mobile Registrations Service`, `Cluster 56`, `School Admin Routes`, `Auth Login & Profile Setup`?**
