...
## Corpus Check
- 317 files · ~3,394,663 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2663 nodes · 5378 edges · 200 communities (126 shown, 74 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 91 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `22a62c74`
...
4. `Card()` - 57 edges
5. `Button()` - 55 edges
6. `PageHeader()` - 47 edges
7. `Sprint Plan (Full Roadmap)` - 42 edges
8. `Brand` - 41 edges
9. `pool` - 40 edges
10. `Badge()` - 38 edges
...
Cohesion: 0.04
Nodes (47): BulkJob, styles, Registration, apiRequest(), RequestOptions, AuthResponse, getMe(), sendOtp() (+39 more)

### Community 1 - "School Auth Context"
Cohesion: 0.04
Nodes (41): styles, AuthTab, styles, AppInput(), AppInputProps, styles, Shadow, Spacing (+33 more)

### Community 2 - "Mobile API Service Layer"
Cohesion: 0.07
Nodes (51): questionBankHttp, { Provider, useHook }, CATEGORIES, CompetitionFormProps, DEFAULTS, GRADE_LEVELS, STATUSES, CHECK_TYPE_LABEL (+43 more)

### Community 3 - "Web Admin Layout"
Cohesion: 0.04
Nodes (55): base, byId, codes, compId, discounted, id, imageUpload, { limit, offset, page } (+47 more)
...
Cohesion: 0.11
Nodes (24): FILTERS, schoolHttp, ExamRow, QueueRow, Competition, STATUS_BADGE, STATUS_STYLE, ProctoringSession (+16 more)
...
Cohesion: 0.06
Nodes (33): compFilter(), liveFilter(), SOFT_DELETE_TABLES, softDelete(), requireRole(), loadFlow(), compId, hasCompAccess() (+25 more)

### Community 11 - "Auth & Twilio OTP"
Cohesion: 0.08
Nodes (27): commerceHttp, ACTIONABLE, ACTIONABLE_STATUSES, Competition, Credential, Registration, STATUS_CLS, STATUS_STYLE (+19 more)
...
Cohesion: 0.06
Nodes (28): schoolHttp, { Provider, useHook }, SchoolContext, SchoolCtx, schoolFetch(), useSchool(), BatchResult, BulkPaymentPage() (+20 more)
...
Cohesion: 0.05
Nodes (41): SPRINT 0 — Quick Wins ✅ COMPLETE, SPRINT 10 — Mobile Bug Fixes (May 6, 2026 Session 2) ✅ COMPLETE, SPRINT 11 — Bug Fixes (May 6, 2026 Session 3) ✅ COMPLETE, SPRINT 12 — Rebrand Kompetix → Competzy (May 8, 2026 Session 4) ✅ COMPLETE, SPRINT 13 — Production Infra Templates (May 9, 2026 Session 5) ✅ LOCAL ARTIFACTS DONE, SPRINT 14 — Compliance & Security Hardening (May 8–9, 2026 Sessions 4–5) ✅ COMPLETE, SPRINT 15 — Launch 1 Polish (May 8, 2026 Session 4) ✅ COMPLETE, SPRINT 16 — School Portal Soft Launch (May 9, 2026 Session 5) ✅ COMPLETE (+33 more)
...
Cohesion: 0.11
Nodes (23): CatalogCompetition, CompetitionCard(), fmtDate(), ExamEditorPage(), ExamQuestion, GRADE_OPTIONS, LoadedExam, fmtDateTime() (+15 more)
...
Cohesion: 0.07
Nodes (31): ReviewQuestionPage(), cn(), StatusBadge(), SchoolPendingPage(), Avatar(), AvatarBadge(), AvatarFallback(), AvatarGroup() (+23 more)

### Community 25 - "Document Vault Flow"
Cohesion: 0.07
Nodes (29): productCompIfAccessible(), voucherGroupCompIfAccessible(), ansByQ, byNumber, chosen, CLEARED_REG, compId, correctPt (+21 more)
...
Cohesion: 0.07
Nodes (17): navTheme, queryClient, RootLayout(), Surface, AuthContextType, AuthProvider(), RegistrationStatus, IoniconName (+9 more)

### Community 30 - "Analytics & Competition Detail"
Cohesion: 0.11
Nodes (19): CompetitionAdminPage(), EmcAdminPage(), PendingRow, StatusFilter, emcHttp, PortalCompetition, usePortalComp(), AccessInfo (+11 more)
...
Cohesion: 0.09
Nodes (20): useIsMobile(), AppShellProps, AppShellUser, NavItem, DropdownMenu(), DropdownMenuCheckboxItem(), DropdownMenuContent(), DropdownMenuItem() (+12 more)

### Community 34 - "k6 Load Test"
Cohesion: 0.1
Nodes (15): questionMakerHttp, { Provider, useHook }, AuthContext, AuthCtx, { Provider, useHook }, useAuth(), { Provider, useHook }, createRoleAuth() (+7 more)

### Community 35 - "Mobile Admin Service"
Cohesion: 0.11
Nodes (20): ExamsListPage(), GradingQueuePage(), QuestionEditorPage(), Order, OrderItem, OrdersPage(), rupiah(), STATUS_STYLE (+12 more)
...
Cohesion: 0.13
Nodes (10): authApi, NAV, AuthContext, Ctx, useAuth(), DashboardLayout(), Dashboard(), DashboardPage() (+2 more)
...
Cohesion: 0.22
Nodes (12): CompetitionAdminLayout(), competitionPaths(), defaultPortalConfig(), getCompetitionConfig(), CompetitionDashboardLayout(), CompetitionExamLayout(), CompetitionPayLayout(), CompetitionPayPage() (+4 more)
...
Cohesion: 0.12
Nodes (13): adminOnly(), adminOrSchoolAdmin(), CHECK_TYPES, CheckType, compId, FlowStep, router, sets (+5 more)
...
## Knowledge Gaps
- **1105 isolated node(s):** `{ defineConfig }`, `expoConfig`, `RegistrationStatus`, `AuthContextType`, `BulkJob` (+1100 more)
...
- **Why does `Button()` connect `Admin Routes (Backend)` to `School Auth Context`, `Mobile API Service Layer`, `Mobile Admin Service`, `Cluster 99`, `Competitions CSV Seeder`, `Cluster 100`, `Web Auth Contexts`, `Express Bootstrap & Errors`, `Auth & Twilio OTP`, `Auth Register Screen`, `Mobile App Bootstrap`, `Cluster 82`, `Mobile Doc & User Services`, `Competition Detail Mobile`, `Teacher Mobile Flow`, `Payments Backend`, `Analytics & Competition Detail`?**
  _High betweenness centrality (0.064) - this node is a cross-community bridge._
- **Why does `cn()` connect `Payments Backend` to `Express Bootstrap & Errors`, `Mobile API Service Layer`, `Cluster 99`, `Mobile Tabs Misc`, `Competitions CSV Seeder`, `Mobile Admin Service`, `Web Auth Contexts`, `Auth & Twilio OTP`, `Mobile App Bootstrap`, `Cluster 82`, `Mobile Doc & User Services`, `Admin Routes (Backend)`, `Mobile Payments Service`, `Teacher Mobile Flow`?**
  _High betweenness centrality (0.031) - this node is a cross-community bridge._
- **Why does `Card()` connect `Admin Routes (Backend)` to `School Auth Context`, `Mobile API Service Layer`, `Mobile Admin Service`, `Cluster 99`, `Cluster 100`, `Mobile Tabs Misc`, `Web Auth Contexts`, `Auth & Twilio OTP`, `Mobile App Bootstrap`, `Cluster 79`, `Cluster 82`, `Mobile Doc & User Services`, `Competition Detail Mobile`, `Payments Backend`, `Analytics & Competition Detail`?**
