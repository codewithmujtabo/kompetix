...
## Corpus Check
- 281 files · ~3,352,646 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2369 nodes · 4406 edges · 202 communities (127 shown, 75 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 72 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `42ebb430`
...
4. `Brand` - 41 edges
5. `Sprint Plan (Full Roadmap)` - 36 edges
6. `pool` - 34 edges
7. `Card()` - 33 edges
8. `Button()` - 33 edges
9. `Text` - 32 edges
...
## Communities (202 total, 75 thin omitted)

### Community 0 - "Admin Mobile Screens"
Cohesion: 0.05
Nodes (57): CompetitionAdminLayout(), CompetitionAdminPage(), EmcAdminPage(), PendingRow, StatusFilter, emcHttp, RoleSelector(), UnifiedLogin() (+49 more)

### Community 1 - "School Auth Context"
Cohesion: 0.05
Nodes (32): pool, ACCOUNTS, main(), normalizePhone(), authMiddleware(), Request, fileContent, parsed (+24 more)
...
Cohesion: 0.09
Nodes (32): CATEGORIES, CATS, CompetitionsPage(), Field(), FILTERS, fmtForInput(), FORM_DEFAULTS, CATEGORIES (+24 more)
...
Cohesion: 0.06
Nodes (33): compFilter(), liveFilter(), SOFT_DELETE_TABLES, softDelete(), adminOnly(), requireRole(), CHECK_TYPES, CheckType (+25 more)

### Community 7 - "Web Auth Contexts"
Cohesion: 0.09
Nodes (28): FILTERS, adminHttp, defaultCompetition, destinationFor(), goTo(), Mode, ROLES, STATUS_CLS (+20 more)
...
Cohesion: 0.07
Nodes (22): BulkJob, styles, Registration, School, Student, styles, Brand, FontFamily (+14 more)
...
Cohesion: 0.1
Nodes (22): Competition, STATUS_BADGE, STATUS_STYLE, fmt(), fmtRp(), Revenue(), RevenueData, RevenuePage() (+14 more)

### Community 16 - "Web UI Components"
Cohesion: 0.08
Nodes (26): Activity, Competition, fmtRp(), OrganizerDashboardPage(), RecentActivity, Stats, ADMIN_QUICK, ADMIN_QUICK_LINKS (+18 more)

### Community 17 - "Concept / Rationale Nodes"
Cohesion: 0.09
Nodes (23): schoolHttp, { Provider, useHook }, SchoolContext, SchoolCtx, schoolFetch(), schoolHttp, useSchool(), BatchResult (+15 more)

### Community 18 - "Mobile Doc & User Services"
Cohesion: 0.08
Nodes (22): Spacing, Text, Type, Slide, slides, styles, HEIGHT, PAD_H (+14 more)
...
Cohesion: 0.11
Nodes (16): ACTIONABLE, ACTIONABLE_STATUSES, Competition, Credential, Registration, STATUS_CLS, STATUS_STYLE, FORM_DEFAULTS (+8 more)

### Community 26 - "Documents Backend"
Cohesion: 0.09
Nodes (13): authApi, NAV, AuthContext, Ctx, useAuth(), DashboardLayout(), Dashboard(), DashboardPage() (+5 more)
...
Cohesion: 0.12
Nodes (21): cn(), SchoolPendingPage(), Avatar(), AvatarBadge(), AvatarFallback(), AvatarGroup(), AvatarGroupCount(), AvatarImage() (+13 more)
...
Cohesion: 0.14
Nodes (12): competitionsApi, notificationsApi, schoolsApi, usersApi, PageHeader(), Pager(), Spinner(), Toast() (+4 more)
...
Cohesion: 0.13
Nodes (16): useIsMobile(), AppShell(), AppShellProps, AppShellUser, initials(), NavItem, SidebarContent(), SidebarGroup() (+8 more)
...
Cohesion: 0.14
Nodes (17): Sidebar(), SidebarContext, SidebarContextProps, SidebarFooter(), SidebarGroupAction(), SidebarInput(), SidebarMenuAction(), SidebarMenuButton() (+9 more)
...
Cohesion: 0.16
Nodes (11): AuthContext, AuthCtx, { Provider, useHook }, useAuth(), createRoleAuth(), Http, RoleAuthConfig, RoleAuthCtx (+3 more)
...
Cohesion: 0.22
Nodes (4): DOC_TYPES, Document, IoniconName, styles

### Community 82 - "Cluster 82"
Cohesion: 0.28
Nodes (5): INTEREST_CATEGORIES, InterestCategory, formatDateForDisplay(), ProfileEditScreen(), styles
...
## Knowledge Gaps
- **967 isolated node(s):** `{ defineConfig }`, `expoConfig`, `RegistrationStatus`, `AuthContextType`, `BulkJob` (+962 more)
...
- **Why does `Button()` connect `Web Auth Contexts` to `Admin Mobile Screens`, `Web Admin Layout`, `Mobile API Plumbing`, `Cluster 78`, `Parent Routes & Email`, `Push Notifications`, `Concept / Rationale Nodes`, `Mobile Doc & User Services`, `Document Vault Flow`, `School Admin Routes`?**
  _High betweenness centrality (0.052) - this node is a cross-community bridge._
- **Why does `Card()` connect `Web UI Components` to `Admin Mobile Screens`, `Web Admin Layout`, `Web Auth Contexts`, `Competitions Routes & Recs`, `Cluster 78`, `Parent Routes & Email`, `Concept / Rationale Nodes`, `Document Vault Flow`, `Documents Backend`, `School Admin Routes`?**
  _High betweenness centrality (0.024) - this node is a cross-community bridge._
- **Why does `Brand` connect `Cron & Background Jobs` to `Cluster 64`, `Cluster 65`, `Audit & Organizer Middleware`, `Competitions Routes & Recs`, `Themed Components & Hooks`, `Mobile Theme System`, `Cluster 79`, `Cluster 81`, `Cluster 82`, `Reset Project Script`, `Mobile Doc & User Services`, `Mobile Auth Service`, `Cluster 90`, `Organizer Competition Forms`?**
