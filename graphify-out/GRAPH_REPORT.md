...
## Corpus Check
- 268 files · ~3,344,474 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2212 nodes · 3584 edges · 204 communities (129 shown, 75 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 72 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9890f904`
...
Cohesion: 0.08
Nodes (38): useIsMobile(), AppShell(), AppShellProps, AppShellUser, initials(), NavItem, Separator(), Sidebar() (+30 more)
...
Cohesion: 0.07
Nodes (16): Shadow, Surface, Slide, slides, styles, PAYER_OPTIONS, PayerKind, PaymentState (+8 more)
...
Cohesion: 0.11
Nodes (24): cn(), Avatar(), AvatarBadge(), AvatarFallback(), AvatarGroup(), AvatarGroupCount(), AvatarImage(), ScrollArea() (+16 more)
...
Cohesion: 0.09
Nodes (19): Kpi, LINKS, QUICK_LINKS, ChartCard(), ChartCardProps, PageHeader(), PageHeaderProps, ACCENT (+11 more)
...
Cohesion: 0.22
Nodes (15): authApi, competitionsApi, notificationsApi, organizerAuthApi, organizerProfileApi, organizerRegistrationsApi, organizerRevenueApi, schoolsApi (+7 more)
...
Cohesion: 0.11
Nodes (12): queryClient, RootLayout(), NAV, AuthContext, AuthProvider(), Ctx, useAuth(), Dashboard() (+4 more)
...
Cohesion: 0.29
Nodes (4): Badge(), badgeVariants, Input(), Label()
...
## Knowledge Gaps
- **878 isolated node(s):** `{ defineConfig }`, `expoConfig`, `RegistrationStatus`, `AuthContextType`, `BulkJob` (+873 more)
...
- **Why does `cn()` connect `Concept / Rationale Nodes` to `Backend DB Bootstrap`, `Cluster 71`, `Cluster 82`, `Web Competitions Page`, `Mobile Auth Service`, `Cluster 58`, `Cluster 95`?**
  _High betweenness centrality (0.029) - this node is a cross-community bridge._
- **Why does `Button()` connect `Cluster 58` to `Concept / Rationale Nodes`, `Backend DB Bootstrap`, `Web API Index`?**
  _High betweenness centrality (0.027) - this node is a cross-community bridge._
- **Why does `Card()` connect `Web Competitions Page` to `Concept / Rationale Nodes`, `Mobile Theme System`?**
