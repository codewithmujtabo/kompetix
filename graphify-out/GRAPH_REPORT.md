...
## Corpus Check
- 305 files · ~3,378,261 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2562 nodes · 5060 edges · 202 communities (127 shown, 75 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 78 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3d103fc9`
...
Cohesion: 0.05
Nodes (45): styles, AuthTab, styles, AppInput(), AppInputProps, styles, Radius, Shadow (+37 more)

### Community 1 - "School Auth Context"
Cohesion: 0.08
Nodes (46): FILTERS, questionBankHttp, { Provider, useHook }, ExamRow, ExamsListPage(), GradingQueuePage(), QueueRow, Competition (+38 more)
...
Cohesion: 0.08
Nodes (41): defaultCompetition, destinationFor(), goTo(), Mode, ROLES, CATEGORIES, CompetitionFormProps, DEFAULTS (+33 more)
...
Cohesion: 0.05
Nodes (38): schoolHttp, { Provider, useHook }, SchoolContext, SchoolCtx, schoolFetch(), schoolHttp, useSchool(), BatchResult (+30 more)
...
Cohesion: 0.07
Nodes (27): adminHttp, ExamLite, PaperExam, PaperExamsPage(), Student, ACTIONABLE, ACTIONABLE_STATUSES, Competition (+19 more)
...
Cohesion: 0.1
Nodes (26): CATEGORIES, CATS, CompetitionsPage(), Field(), FILTERS, fmtForInput(), FORM_DEFAULTS, STATUS_CLS (+18 more)

### Community 13 - "Mobile App Bootstrap"
Cohesion: 0.06
Nodes (32): authMiddleware(), Request, errorHandler(), HttpError, fileContent, parsed, router, upload (+24 more)
...
Cohesion: 0.08
Nodes (31): QuestionEditorPage(), ReviewQuestionPage(), cn(), ExamPlayerPage(), fmt(), GradingSession, GradingSessionPage(), Option (+23 more)
...
Cohesion: 0.07
Nodes (18): navTheme, queryClient, RootLayout(), Surface, AuthContext, AuthContextType, AuthProvider(), RegistrationStatus (+10 more)
...
Cohesion: 0.17
Nodes (11): CompetitionAdminPage(), EmcAdminPage(), PendingRow, StatusFilter, emcHttp, { Provider, useHook }, EMC, PortalCompetition (+3 more)

### Community 37 - "Competitions CSV Seeder"
Cohesion: 0.12
Nodes (15): CatalogCompetition, CompetitionCard(), fmtDate(), Competition, CompetitionDetailPage(), ExamEditorPage(), ExamQuestion, fmtDate() (+7 more)
...
Cohesion: 0.22
Nodes (15): authApi, notificationsApi, organizerAuthApi, organizerProfileApi, organizerRegistrationsApi, organizerRevenueApi, registrationsApi, usersApi (+7 more)
...
Cohesion: 0.3
Nodes (10): CompetitionAdminLayout(), { Provider, useHook }, competitionPaths(), competitionRegistry, defaultPortalConfig(), getCompetitionConfig(), CompetitionDashboardLayout(), CompetitionDashboardPage() (+2 more)
...
## Knowledge Gaps
- **1055 isolated node(s):** `{ defineConfig }`, `expoConfig`, `RegistrationStatus`, `AuthContextType`, `BulkJob` (+1050 more)
...
- **Why does `Button()` connect `Database Columns & Keys` to `Admin Mobile Screens`, `School Auth Context`, `Cluster 64`, `Competitions CSV Seeder`, `Admin / Audit Middleware`, `Web API Client`, `Mobile Theme System`, `Reset Project Script`, `Mobile Payments Service`, `Legacy Vite/Express Stack`, `Web API Index`, `Cluster 59`?**
  _High betweenness centrality (0.061) - this node is a cross-community bridge._
- **Why does `Card()` connect `School Auth Context` to `Admin Mobile Screens`, `Cluster 64`, `Database Columns & Keys`, `Competitions CSV Seeder`, `Admin / Audit Middleware`, `Web API Client`, `Mobile Theme System`, `Reset Project Script`, `Web API Index`, `Organizer Competition Forms`, `Analytics & Competition Detail`?**
  _High betweenness centrality (0.034) - this node is a cross-community bridge._
- **Why does `Brand` connect `Mobile Doc & User Services` to `Admin Mobile Screens`, `Mobile Admin Service`, `Beyond Classroom PDF`, `Themed Components & Hooks`, `Historical Phone Login`, `Push Notifications`, `Parent Routes & Email`, `Cluster 56`, `Payments Backend`, `Cluster 93`?**
