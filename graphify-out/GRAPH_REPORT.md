...
## Corpus Check
- 339 files · ~3,410,695 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2782 nodes · 5806 edges · 199 communities (125 shown, 74 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 94 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `95fea3cd`
...
Cohesion: 0.04
Nodes (63): styles, AuthTab, styles, AppInput(), AppInputProps, styles, styles, styles (+55 more)

### Community 1 - "School Auth Context"
Cohesion: 0.04
Nodes (53): styles, WINDOW_NOTE, apiRequest(), RequestOptions, AuthResponse, getMe(), sendOtp(), sendPhoneOtp() (+45 more)

### Community 2 - "Mobile API Service Layer"
Cohesion: 0.07
Nodes (44): { Provider, useHook }, CATEGORIES, CompetitionFormProps, DEFAULTS, GRADE_LEVELS, STATUSES, Answer, COGNITIVE (+36 more)
...
Cohesion: 0.06
Nodes (46): AnnouncementsPage(), questionBankHttp, ExamsListPage(), GradingQueuePage(), QueueRow, ExamEditorPage(), QuestionEditorPage(), MaterialsPage() (+38 more)

### Community 5 - "Backend DB Bootstrap"
Cohesion: 0.05
Nodes (48): env, authLimiter, bulkUploadLimiter, otpSendLimiter, otpVerifyLimiter, passwordResetLimiter, pinVerifyLimiter, code (+40 more)
...
Cohesion: 0.08
Nodes (32): FILTERS, schoolHttp, useSchool(), BulkRegistrationPage(), Competition, CsvRow, JobStatus, STEPS (+24 more)
...
Cohesion: 0.05
Nodes (40): adminOnly(), adminOrSchoolAdmin(), audit(), AuditOptions, REDACT_KEYS, organizerOnly(), compId, compIdFilter (+32 more)
...
Cohesion: 0.09
Nodes (30): DEFAULTS, commerceHttp, marketingHttp, DEFAULTS, GRADES, ACTIONABLE, ACTIONABLE_STATUSES, Competition (+22 more)
...
Cohesion: 0.13
Nodes (23): CompetitionAdminLayout(), CompetitionAdminPage(), CompetitionAnnouncementsLayout(), { Provider, useHook }, BrandPanel(), Props, CompetitionPortalConfig, competitionPaths() (+15 more)
...
Cohesion: 0.09
Nodes (15): navTheme, queryClient, RootLayout(), INTEREST_CATEGORIES, InterestCategory, Surface, DOC_TYPES, Document (+7 more)
...
Cohesion: 0.1
Nodes (24): Separator(), Sidebar(), SidebarContext, SidebarContextProps, SidebarGroup(), SidebarGroupAction(), SidebarHeader(), SidebarInput() (+16 more)
...
Cohesion: 0.13
Nodes (13): STATUS_CLS, STATUS_STYLE, STATUSES, FORM_DEFAULTS, Pager(), PagerProps, PageHeader(), Pager() (+5 more)
...
Cohesion: 0.11
Nodes (12): AuthContext, AuthCtx, { Provider, useHook }, useAuth(), NAV, Sidebar(), Kpi, LINKS (+4 more)
...
Cohesion: 0.12
Nodes (13): BatchResult, BulkPaymentPage(), fmtRp(), RegistrationRow, Access, Competition, GRADES, QuestionMaker (+5 more)
...
Cohesion: 0.15
Nodes (13): organizerHttp, OrganizerContext, OrganizerCtx, { Provider, useHook }, useOrganizer(), Activity, Competition, fmtRp() (+5 more)
...
## Knowledge Gaps
- **1146 isolated node(s):** `{ defineConfig }`, `expoConfig`, `RegistrationStatus`, `AuthContextType`, `BulkJob` (+1141 more)
...
- **Why does `Button()` connect `Mobile API Service Layer` to `Admin Mobile Screens`, `Database Columns & Keys`, `Web Auth Contexts`, `Mobile App Bootstrap`, `Parent Routes & Email`, `Web Competitions Page`, `Web API Index`, `Documents Backend`, `Analytics & Competition Detail`, `Auth Login & Profile Setup`, `Competitions CSV Seeder`, `Themed Components & Hooks`, `Mobile Registrations Service`, `Cluster 80`, `Cluster 82`, `Cluster 88`, `Cluster 94`, `Cluster 100`, `Cluster 101`?**
  _High betweenness centrality (0.064) - this node is a cross-community bridge._
- **Why does `Card()` connect `Mobile API Service Layer` to `Admin Mobile Screens`, `Database Columns & Keys`, `Cluster 100`, `Cluster 101`, `Web Auth Contexts`, `Themed Components & Hooks`, `Mobile App Bootstrap`, `Push Notifications`, `Parent Routes & Email`, `Cluster 80`, `Mobile Registrations Service`, `Cluster 82`, `Web Competitions Page`, `Web API Index`, `Analytics & Competition Detail`, `Cluster 88`, `Cluster 60`, `Cluster 94`?**
  _High betweenness centrality (0.037) - this node is a cross-community bridge._
- **Why does `cn()` connect `Analytics & Competition Detail` to `Mobile API Service Layer`, `Database Columns & Keys`, `Competitions CSV Seeder`, `Web Auth Contexts`, `Competitions Routes & Recs`, `Themed Components & Hooks`, `Mobile App Bootstrap`, `Cluster 78`, `Parent Routes & Email`, `Cluster 80`, `Mobile Registrations Service`, `Push Notifications`, `Documents Backend`, `Auth Login & Profile Setup`?**
