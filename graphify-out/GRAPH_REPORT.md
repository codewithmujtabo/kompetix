...
## Corpus Check
- 307 files · ~3,382,144 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2577 nodes · 5092 edges · 196 communities (122 shown, 74 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 78 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6ddd7860`
...
4. `Card()` - 51 edges
5. `Button()` - 49 edges
6. `PageHeader()` - 42 edges
7. `Brand` - 41 edges
8. `Sprint Plan (Full Roadmap)` - 40 edges
9. `pool` - 39 edges
10. `Skeleton()` - 34 edges
...
Cohesion: 0.04
Nodes (48): styles, AuthTab, styles, AppInput(), AppInputProps, styles, Shadow, Spacing (+40 more)

### Community 1 - "School Auth Context"
Cohesion: 0.04
Nodes (45): Registration, apiRequest(), RequestOptions, AuthResponse, getMe(), sendOtp(), sendPhoneOtp(), create() (+37 more)
...
Cohesion: 0.08
Nodes (34): FILTERS, schoolHttp, Competition, CsvRow, JobStatus, STEPS, ExamRow, QueueRow (+26 more)
...
Cohesion: 0.04
Nodes (51): ansByQ, byNumber, chosen, CLEARED_REG, compId, correctPt, examCompIfAccessible(), examId (+43 more)
...
Cohesion: 0.08
Nodes (38): questionBankHttp, { Provider, useHook }, CATEGORIES, CompetitionFormProps, DEFAULTS, GRADE_LEVELS, STATUSES, Answer (+30 more)

### Community 9 - "Cron & Background Jobs"
Cohesion: 0.1
Nodes (31): adminHttp, BatchResult, RegistrationRow, ExamsListPage(), GradingQueuePage(), CompetitionPicker(), useQuestionBank(), QuestionBankDashboard() (+23 more)
...
Cohesion: 0.1
Nodes (25): ExamEditorPage(), ExamQuestion, GRADE_OPTIONS, LoadedExam, TYPES, FORM_DEFAULTS, ExamPlayerPage(), fmt() (+17 more)
...
Cohesion: 0.05
Nodes (39): SPRINT 0 — Quick Wins ✅ COMPLETE, SPRINT 10 — Mobile Bug Fixes (May 6, 2026 Session 2) ✅ COMPLETE, SPRINT 11 — Bug Fixes (May 6, 2026 Session 3) ✅ COMPLETE, SPRINT 12 — Rebrand Kompetix → Competzy (May 8, 2026 Session 4) ✅ COMPLETE, SPRINT 13 — Production Infra Templates (May 9, 2026 Session 5) ✅ LOCAL ARTIFACTS DONE, SPRINT 14 — Compliance & Security Hardening (May 8–9, 2026 Sessions 4–5) ✅ COMPLETE, SPRINT 15 — Launch 1 Polish (May 8, 2026 Session 4) ✅ COMPLETE, SPRINT 16 — School Portal Soft Launch (May 9, 2026 Session 5) ✅ COMPLETE (+31 more)
...
Cohesion: 0.12
Nodes (28): area(), exam(), localToday(), main(), question(), SeedQuestion, subject(), subtopic() (+20 more)

### Community 26 - "Documents Backend"
Cohesion: 0.08
Nodes (29): Sidebar(), SidebarContent(), SidebarContext, SidebarContextProps, SidebarFooter(), SidebarGroupAction(), SidebarGroupContent(), SidebarGroupLabel() (+21 more)
...
Cohesion: 0.13
Nodes (16): CompetitionAdminPage(), EmcAdminPage(), PendingRow, StatusFilter, emcHttp, questionMakerHttp, { Provider, useHook }, createRoleAuth() (+8 more)
...
Cohesion: 0.09
Nodes (26): ReviewQuestionPage(), cn(), StatusBadge(), Avatar(), AvatarBadge(), AvatarFallback(), AvatarGroup(), AvatarGroupCount() (+18 more)

### Community 31 - "Auth Login & Profile Setup"
Cohesion: 0.11
Nodes (20): metadata, defaultCompetition, destinationFor(), goTo(), Mode, ROLES, RoleSelector(), UnifiedLogin() (+12 more)

### Community 32 - "Web Auth API"
Cohesion: 0.1
Nodes (17): useIsMobile(), AppShellProps, AppShellUser, NavItem, DropdownMenu(), DropdownMenuCheckboxItem(), DropdownMenuContent(), DropdownMenuItem() (+9 more)
...
Cohesion: 0.1
Nodes (11): navTheme, queryClient, RootLayout(), AuthContext, AuthContextType, AuthProvider(), RegistrationStatus, IoniconName (+3 more)
...
Cohesion: 0.24
Nodes (11): CompetitionAdminLayout(), { Provider, useHook }, CatalogCompetition, CompetitionCard(), fmtDate(), competitionPaths(), competitionRegistry, defaultPortalConfig() (+3 more)
...
Cohesion: 0.12
Nodes (17): code:block1 (competzy/), code:bash (# From each subdirectory:), code:block3 (BACKEND_URL=http://localhost:3000), code:block4 (EXPO_PUBLIC_API_URL=http://<MAC_LAN_IP>:3000/api), code:block5 (<phase-A-sha>  chore(brand): ship unified login + de-brand t), Competzy — Claude Project Brief, Current Task Status (as of May 13, 2026 — Session 9), Current Task Status (as of May 9, 2026 — Session 5) (+9 more)
...
Cohesion: 0.15
Nodes (12): AuthContext, AuthCtx, { Provider, useHook }, useAuth(), Http, RoleAuthConfig, RoleAuthCtx, NAV (+4 more)
...
Cohesion: 0.23
Nodes (9): CATEGORIES, CATS, CompetitionsPage(), Field(), FILTERS, fmtForInput(), FORM_DEFAULTS, Pager() (+1 more)
...
## Knowledge Gaps
- **1059 isolated node(s):** `{ defineConfig }`, `expoConfig`, `RegistrationStatus`, `AuthContextType`, `BulkJob` (+1054 more)
...
- **Why does `Button()` connect `Mobile App Bootstrap` to `Admin Mobile Screens`, `Cluster 97`, `Cluster 64`, `Web Admin Layout`, `Web Auth API`, `Cluster 71`, `Auth & Competitions Routes`, `Cron & Background Jobs`, `Auth & Twilio OTP`, `Cluster 79`, `Mobile Registrations Service`, `Reset Project Script`, `Documents Backend`, `Analytics & Competition Detail`, `Auth Login & Profile Setup`?**
  _High betweenness centrality (0.060) - this node is a cross-community bridge._
- **Why does `Card()` connect `Cron & Background Jobs` to `Admin Mobile Screens`, `Cluster 97`, `Cluster 64`, `Web Admin Layout`, `Cluster 71`, `Auth & Competitions Routes`, `Cluster 74`, `Auth & Twilio OTP`, `CLAUDE.md Concepts`, `Mobile App Bootstrap`, `Cluster 79`, `Mobile Registrations Service`, `Web Competitions Page`, `Analytics & Competition Detail`?**
  _High betweenness centrality (0.031) - this node is a cross-community bridge._
- **Why does `cn()` connect `Analytics & Competition Detail` to `Web Auth API`, `Web Admin Layout`, `Auth & Competitions Routes`, `Cron & Background Jobs`, `Cluster 74`, `Auth & Twilio OTP`, `Mobile App Bootstrap`, `Cluster 79`, `Cluster 80`, `Cluster 81`, `Web Competitions Page`, `Documents Backend`, `Auth Login & Profile Setup`?**
