...
## Corpus Check
- 240 files · ~3,336,956 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2039 nodes · 3209 edges · 193 communities (119 shown, 74 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 70 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1c98a371`
...
Cohesion: 0.08
Nodes (25): BulkJob, styles, Shadow, Spacing, Text, Type, PAYER_OPTIONS, PayerKind (+17 more)
...
Cohesion: 0.12
Nodes (14): competitionsApi, registrationsApi, schoolsApi, usersApi, CATS, FORM_DEFAULTS, STATUS_CLS, STATUSES (+6 more)
...
Cohesion: 0.11
Nodes (12): authApi, queryClient, RootLayout(), NAV, Sidebar(), AuthContext, AuthProvider(), Ctx (+4 more)
...
Cohesion: 0.14
Nodes (12): metadata, AuthContext, AuthCtx, AuthProvider(), { Provider, useHook }, useAuth(), NAV, Dashboard() (+4 more)
...
Cohesion: 0.3
Nodes (11): notificationsApi, organizerAuthApi, organizerProfileApi, organizerRegistrationsApi, organizerRevenueApi, AuthUser, Competition, Pagination (+3 more)
...
Cohesion: 0.2
Nodes (11): AuthContext Registration type (external), auth.signup, config/api API_BASE_URL, historical.service, MyRegistrationDetailsScreen, payments.service, HistoryScreen, Registration Service (legacy) (+3 more)
...
Cohesion: 0.29
Nodes (7): Current Task Status (as of May 13, 2026 — Session 10), EMC Port (begins 2026-05-13) — Wave 1 ✅ COMPLETE (4 phases shipped), EMC Port (begins 2026-05-13) — Wave 1 IN EXECUTION (4 phases), Manual rollout still required (Sprint 13/17 — needs your access), Manual rollout still required (Sprint 13/17 — needs your access), Manual rollout still required (Sprint 13/17 — needs your access), Manual rollout still required (Sprint 13/17 — needs your access)
...
## Knowledge Gaps
- **861 isolated node(s):** `{ defineConfig }`, `expoConfig`, `RegistrationStatus`, `AuthContextType`, `BulkJob` (+856 more)
...
- **Why does `AuthUser` connect `Push Notifications` to `Admin Mobile Screens`, `School Auth Context`, `Mobile Admin Service`, `Registrations Routes`, `Parent Linking Flow`?**
  _High betweenness centrality (0.043) - this node is a cross-community bridge._
- **Why does `useAuth()` connect `Parent Linking Flow` to `Web Auth API`, `k6 Load Test`, `Mobile Admin Service`?**
  _High betweenness centrality (0.036) - this node is a cross-community bridge._
- **Why does `AuthProvider()` connect `Parent Linking Flow` to `Web Auth API`?**
