...
## Corpus Check
- 272 files · ~3,342,738 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2289 nodes · 4201 edges · 206 communities (132 shown, 74 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 72 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `61bc9e9a`
...
Cohesion: 0.06
Nodes (59): CompetitionAdminLayout(), CompetitionAdminPage(), EmcAdminPage(), PendingRow, StatusFilter, adminHttp, emcHttp, defaultCompetition (+51 more)
...
Cohesion: 0.12
Nodes (20): FILTERS, schoolHttp, Competition, CsvRow, JobStatus, STEPS, fmt(), fmtRp() (+12 more)

### Community 11 - "Auth & Twilio OTP"
Cohesion: 0.08
Nodes (18): organizerCompetitionsApi, CompetitionForm(), CATEGORIES, GRADE_LEVELS, Competition, CompetitionDetailPage(), fmtDate(), fmtRp() (+10 more)

### Community 12 - "Mobile Theme System"
Cohesion: 0.08
Nodes (24): Activity, Competition, fmtRp(), OrganizerDashboardPage(), RecentActivity, Stats, ADMIN_QUICK, ADMIN_QUICK_LINKS (+16 more)

### Community 13 - "Mobile App Bootstrap"
Cohesion: 0.09
Nodes (17): CATEGORIES, CATS, FILTERS, FORM_DEFAULTS, STATUS_CLS, STATUS_STYLE, StatusBadge(), STATUSES (+9 more)
...
Cohesion: 0.09
Nodes (22): schoolHttp, { Provider, useHook }, SchoolContext, SchoolCtx, schoolFetch(), useSchool(), BatchResult, BulkPaymentPage() (+14 more)
...
Cohesion: 0.08
Nodes (15): Radius, Slide, slides, styles, styles, Tab, formatDate(), MyRegistrationDetailsScreen() (+7 more)

### Community 18 - "Mobile Doc & User Services"
Cohesion: 0.09
Nodes (21): CATEGORIES, CompetitionFormProps, CompetitionFormValues, DEFAULTS, GRADE_LEVELS, STATUSES, ACTIONABLE, ACTIONABLE_STATUSES (+13 more)
...
Cohesion: 0.07
Nodes (30): SPRINT 0 — Quick Wins ✅ COMPLETE, SPRINT 10 — Mobile Bug Fixes (May 6, 2026 Session 2) ✅ COMPLETE, SPRINT 11 — Bug Fixes (May 6, 2026 Session 3) ✅ COMPLETE, SPRINT 12 — Rebrand Kompetix → Competzy (May 8, 2026 Session 4) ✅ COMPLETE, SPRINT 13 — Production Infra Templates (May 9, 2026 Session 5) ✅ LOCAL ARTIFACTS DONE, SPRINT 14 — Compliance & Security Hardening (May 8–9, 2026 Sessions 4–5) ✅ COMPLETE, SPRINT 15 — Launch 1 Polish (May 8, 2026 Session 4) ✅ COMPLETE, SPRINT 16 — School Portal Soft Launch (May 9, 2026 Session 5) ✅ COMPLETE (+22 more)
...
Cohesion: 0.08
Nodes (18): navTheme, queryClient, RootLayout(), Surface, AuthContextType, AuthProvider(), RegistrationStatus, IoniconName (+10 more)

### Community 25 - "Document Vault Flow"
Cohesion: 0.15
Nodes (13): TYPES, FORM_DEFAULTS, Pager(), PagerProps, Button(), buttonVariants, PageHeader(), Pager() (+5 more)
...
Cohesion: 0.11
Nodes (14): styles, AuthTab, styles, AppInput(), AppInputProps, styles, Shadow, Spacing (+6 more)
...
Cohesion: 0.21
Nodes (16): authApi, competitionsApi, notificationsApi, organizerAuthApi, organizerProfileApi, organizerRegistrationsApi, organizerRevenueApi, registrationsApi (+8 more)
...
Cohesion: 0.16
Nodes (18): cn(), Avatar(), AvatarBadge(), AvatarFallback(), AvatarGroup(), AvatarGroupCount(), AvatarImage(), CardAction() (+10 more)
...
Cohesion: 0.13
Nodes (16): useIsMobile(), AppShell(), AppShellProps, AppShellUser, initials(), NavItem, SidebarContent(), SidebarFooter() (+8 more)

### Community 45 - "Historical Phone Login"
Cohesion: 0.13
Nodes (9): NAV, AuthContext, Ctx, useAuth(), Dashboard(), DashboardPage(), fmtRp(), Login() (+1 more)
...
Cohesion: 0.14
Nodes (17): Sidebar(), SidebarContext, SidebarContextProps, SidebarGroupAction(), SidebarHeader(), SidebarInput(), SidebarMenuAction(), SidebarMenuButton() (+9 more)
...
Cohesion: 0.17
Nodes (17): analytics, AuthContext Registration type (external), CompetitionDetailArchive, CompetitionDetailPage, competitions.service, favorites.service, IconSymbol, MyCompetitionsScreen (+9 more)
...
Cohesion: 0.22
Nodes (12): apiRequest(), create(), Document, list(), remove(), create(), list(), Registration (+4 more)
...
Cohesion: 0.19
Nodes (10): Competition, Registration, STATUS_CLS, STATUS_STYLE, STATUS_TABS, Tabs(), TabsContent(), TabsList() (+2 more)
...
Cohesion: 0.21
Nodes (10): subjectColorFor(), Type, Pill, PillImpl(), Props, tonePalette(), pickLetter(), Props (+2 more)
...
- **Why does `Button()` connect `Document Vault Flow` to `Admin Mobile Screens`, `Mobile Admin Service`, `Web API Client`, `Auth & Twilio OTP`, `CLAUDE.md Concepts`, `Mobile App Bootstrap`, `Parent Routes & Email`, `Mobile Doc & User Services`, `Mobile Auth Service`, `Mobile Payments Service`, `Cluster 62`?**
  _High betweenness centrality (0.046) - this node is a cross-community bridge._
- **Why does `Card()` connect `Mobile Theme System` to `Admin Mobile Screens`, `Mobile Admin Service`, `Web API Client`, `Auth & Twilio OTP`, `Mobile App Bootstrap`, `Parent Routes & Email`, `Mobile Doc & User Services`, `Cluster 87`, `Document Vault Flow`, `Parent Linking Flow`, `Cluster 62`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **Why does `cn()` connect `Mobile Admin Service` to `Admin Mobile Screens`, `Web API Client`, `Auth & Twilio OTP`, `Mobile Theme System`, `Mobile App Bootstrap`, `CLAUDE.md Concepts`, `Parent Routes & Email`, `Cluster 80`, `Cluster 81`, `Mobile Doc & User Services`, `Mobile Auth Service`, `Cluster 56`, `Document Vault Flow`, `Cluster 62`?**
