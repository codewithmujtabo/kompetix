...
## Corpus Check
- 279 files · ~3,348,386 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2338 nodes · 4359 edges · 199 communities (125 shown, 74 thin omitted)
...
Cohesion: 0.09
Nodes (25): TYPES, STATUS_CLS, STATUS_STYLE, STATUSES, Competition, Registration, STATUS_CLS, STATUS_STYLE (+17 more)

### Community 6 - "Admin / Audit Middleware"
Cohesion: 0.1
Nodes (30): CATEGORIES, CATS, CompetitionsPage(), Field(), FILTERS, fmtForInput(), FORM_DEFAULTS, CHECK_TYPE_LABEL (+22 more)
...
Cohesion: 0.08
Nodes (24): Kpi, LINKS, QUICK_LINKS, Activity, Competition, fmtRp(), OrganizerDashboardPage(), RecentActivity (+16 more)
...
Cohesion: 0.08
Nodes (15): Shadow, Spacing, Slide, slides, styles, styles, Tab, formatDate() (+7 more)
...
Cohesion: 0.08
Nodes (20): { Provider, useHook }, SchoolContext, SchoolCtx, schoolFetch(), useSchool(), BulkRegistrationPage(), Competition, CsvRow (+12 more)
...
Cohesion: 0.1
Nodes (15): organizerCompetitionsApi, CATEGORIES, CompetitionForm(), CompetitionFormProps, CompetitionFormValues, DEFAULTS, GRADE_LEVELS, STATUSES (+7 more)
...
Cohesion: 0.11
Nodes (23): Sidebar(), SidebarContext, SidebarContextProps, SidebarFooter(), SidebarGroup(), SidebarGroupAction(), SidebarInput(), SidebarInset() (+15 more)
...
Cohesion: 0.11
Nodes (16): Text, Type, HEIGHT, PAD_H, Props, Size, styles, Variant (+8 more)
...
Cohesion: 0.12
Nodes (14): styles, AuthTab, styles, AppInput(), AppInputProps, styles, Radius, styles (+6 more)
...
Cohesion: 0.14
Nodes (13): BatchResult, BulkPaymentPage(), fmtRp(), RegistrationRow, Competition, CompetitionDetailPage(), fmtDate(), fmtRp() (+5 more)
...
Cohesion: 0.13
Nodes (15): useIsMobile(), AppShell(), AppShellProps, AppShellUser, initials(), NavItem, Separator(), SidebarContent() (+7 more)
...
Cohesion: 0.15
Nodes (6): NAV, useAuth(), Dashboard(), DashboardPage(), fmtRp(), LINKS
...
- **Why does `Button()` connect `Backend DB Bootstrap` to `Admin Mobile Screens`, `Express Bootstrap & Errors`, `Admin / Audit Middleware`, `Auth & Twilio OTP`, `CLAUDE.md Concepts`, `Push Notifications`, `Admin Routes (Backend)`, `Payments Backend`, `Documents Backend`, `Organizer Competition Forms`?**
  _High betweenness centrality (0.048) - this node is a cross-community bridge._
- **Why does `Card()` connect `Mobile App Bootstrap` to `Admin Mobile Screens`, `Backend DB Bootstrap`, `Admin / Audit Middleware`, `Auth & Twilio OTP`, `CLAUDE.md Concepts`, `Web UI Components`, `Admin Routes (Backend)`, `Payments Backend`, `Documents Backend`?**
  _High betweenness centrality (0.026) - this node is a cross-community bridge._
- **Why does `cn()` connect `Documents Backend` to `Admin Mobile Screens`, `Backend DB Bootstrap`, `Admin / Audit Middleware`, `Auth & Twilio OTP`, `CLAUDE.md Concepts`, `Mobile App Bootstrap`, `Cluster 76`, `Push Notifications`, `Admin Routes (Backend)`, `Cluster 56`, `Payments Backend`, `Organizer Competition Forms`?**
