...
## Corpus Check
- 306 files · ~3,380,279 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2575 nodes · 5084 edges · 188 communities (113 shown, 75 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 78 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a25a64a9`
...
Cohesion: 0.05
Nodes (64): CompetitionAdminLayout(), CompetitionAdminPage(), EmcAdminPage(), PendingRow, StatusFilter, emcHttp, questionBankHttp, questionMakerHttp (+56 more)

### Community 1 - "School Auth Context"
Cohesion: 0.04
Nodes (46): Elevation, Fonts, Motion, Shadow, Spacing, SubjectColors, Text, Type (+38 more)
...
Cohesion: 0.07
Nodes (47): CATEGORIES, CATS, CompetitionsPage(), Field(), FILTERS, fmtForInput(), FORM_DEFAULTS, CHECK_TYPE_LABEL (+39 more)
...
Cohesion: 0.08
Nodes (35): adminHttp, { Provider, useHook }, CATEGORIES, CompetitionFormProps, DEFAULTS, GRADE_LEVELS, STATUSES, HubAuthShell() (+27 more)

### Community 7 - "Web Auth Contexts"
Cohesion: 0.05
Nodes (39): schoolHttp, { Provider, useHook }, SchoolContext, SchoolCtx, schoolFetch(), schoolHttp, useSchool(), BatchResult (+31 more)
...
Cohesion: 0.1
Nodes (29): ExamRow, QueueRow, Competition, STATUS_BADGE, STATUS_STYLE, QuestionRow, STATUS_STYLE, Subject (+21 more)
...
Cohesion: 0.07
Nodes (36): ReviewQuestionPage(), cn(), StatusBadge(), Avatar(), AvatarBadge(), AvatarFallback(), AvatarGroup(), AvatarGroupCount() (+28 more)
...
Cohesion: 0.09
Nodes (23): FILTERS, STATUS_CLS, STATUS_STYLE, STATUSES, FORM_DEFAULTS, Pager(), PagerProps, DialogFooter() (+15 more)
...
Cohesion: 0.15
Nodes (20): ExamsListPage(), GradingQueuePage(), ExamEditorPage(), QuestionEditorPage(), PaperExamsPage(), CompetitionPicker(), useQuestionBank(), QuestionBankDashboard() (+12 more)
...
Cohesion: 0.09
Nodes (12): navTheme, queryClient, RootLayout(), Surface, AuthContext, AuthContextType, AuthProvider(), RegistrationStatus (+4 more)
...
Cohesion: 0.33
Nodes (10): area(), exam(), main(), question(), SeedQuestion, subject(), subtopic(), testCenter() (+2 more)
...
## Knowledge Gaps
- **1058 isolated node(s):** `{ defineConfig }`, `expoConfig`, `RegistrationStatus`, `AuthContextType`, `BulkJob` (+1053 more)
...
- **Why does `Button()` connect `Admin / Audit Middleware` to `Admin Mobile Screens`, `School Auth Context`, `Web Admin Layout`, `Web Auth Contexts`, `Beyond Classroom PDF`, `Cron & Background Jobs`, `Parent Routes & Email`, `Concept / Rationale Nodes`, `Payments Backend`, `Auth Login & Profile Setup`?**
  _High betweenness centrality (0.060) - this node is a cross-community bridge._
- **Why does `Card()` connect `Auth Login & Profile Setup` to `Admin Mobile Screens`, `School Auth Context`, `Express Bootstrap & Errors`, `Web Admin Layout`, `Admin / Audit Middleware`, `Web Auth Contexts`, `Beyond Classroom PDF`, `Cron & Background Jobs`, `Parent Routes & Email`, `Concept / Rationale Nodes`, `Analytics & Competition Detail`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
- **Why does `cn()` connect `Parent Routes & Email` to `Admin Mobile Screens`, `Express Bootstrap & Errors`, `Web Admin Layout`, `Admin / Audit Middleware`, `Web Auth Contexts`, `Beyond Classroom PDF`, `Cron & Background Jobs`, `Cluster 71`, `Themed Components & Hooks`, `Concept / Rationale Nodes`, `Mobile Payments Service`, `Payments Backend`, `Auth Login & Profile Setup`?**
