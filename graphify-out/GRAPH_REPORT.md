...
## Corpus Check
- 342 files · ~3,413,584 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2802 nodes · 5860 edges · 204 communities (131 shown, 73 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 94 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d01f3073`
...
7. `Brand` - 46 edges
8. `Sprint Plan (Full Roadmap)` - 46 edges
...
Cohesion: 0.07
Nodes (58): DEFAULTS, questionBankHttp, { Provider, useHook }, CATEGORIES, CompetitionFormProps, DEFAULTS, GRADE_LEVELS, STATUSES (+50 more)

### Community 1 - "School Auth Context"
Cohesion: 0.04
Nodes (47): apiRequest(), RequestOptions, AuthResponse, getMe(), sendOtp(), sendPhoneOtp(), create(), Document (+39 more)

### Community 2 - "Mobile API Service Layer"
Cohesion: 0.05
Nodes (48): AnnouncementsPage(), commerceHttp, marketingHttp, questionMakerHttp, schoolHttp, { Provider, useHook }, CatalogCompetition, CompetitionCard() (+40 more)

### Community 3 - "Web Admin Layout"
Cohesion: 0.07
Nodes (40): CATEGORIES, CATS, CompetitionsPage(), Field(), FILTERS, fmtForInput(), FORM_DEFAULTS, Order (+32 more)
...
Cohesion: 0.1
Nodes (25): FILTERS, schoolHttp, ExamRow, QueueRow, Competition, STATUS_BADGE, STATUS_STYLE, ProctoringSession (+17 more)

### Community 10 - "Web API Client"
Cohesion: 0.06
Nodes (32): ExamPlayerScreen(), fmtClock(), styles, styles, WINDOW_NOTE, Spacing, Text, Type (+24 more)

### Community 11 - "Auth & Twilio OTP"
Cohesion: 0.06
Nodes (26): navTheme, queryClient, styles, AuthTab, styles, AppInput(), AppInputProps, styles (+18 more)
...
Cohesion: 0.04
Nodes (47): code:block6 (T5 (reg_number) ──────────► T16 (mobile shows it)), Dependency Map, SPRINT 0 — Quick Wins ✅ COMPLETE, SPRINT 10 — Mobile Bug Fixes (May 6, 2026 Session 2) ✅ COMPLETE, SPRINT 11 — Bug Fixes (May 6, 2026 Session 3) ✅ COMPLETE, SPRINT 12 — Rebrand Kompetix → Competzy (May 8, 2026 Session 4) ✅ COMPLETE, SPRINT 13 — Production Infra Templates (May 9, 2026 Session 5) ✅ LOCAL ARTIFACTS DONE, SPRINT 14 — Compliance & Security Hardening (May 8–9, 2026 Sessions 4–5) ✅ COMPLETE (+39 more)

### Community 16 - "Web UI Components"
Cohesion: 0.06
Nodes (27): { Provider, useHook }, SchoolContext, SchoolCtx, schoolFetch(), useSchool(), BatchResult, BulkPaymentPage(), fmtRp() (+19 more)

### Community 17 - "Concept / Rationale Nodes"
Cohesion: 0.08
Nodes (28): QuestionBankDashboard(), QuestionRow, fmt(), fmtRp(), Revenue(), RevenueData, RevenuePage(), ADMIN_QUICK (+20 more)
...
Cohesion: 0.09
Nodes (39): announcement(), area(), exam(), localToday(), main(), material(), product(), question() (+31 more)
...
Cohesion: 0.14
Nodes (26): adminHttp, defaultCompetition, destinationFor(), goTo(), Mode, ROLES, RoleSelector(), UnifiedLogin() (+18 more)
...
Cohesion: 0.17
Nodes (18): CompetitionAdminLayout(), CompetitionAnnouncementsLayout(), { Provider, useHook }, BrandPanel(), Props, CompetitionPortalConfig, competitionPaths(), CompetitionPortalConfig (+10 more)
...
Cohesion: 0.13
Nodes (12): AnnouncementCard(), fmtDate(), styles, ExamResultScreen(), styles, sum(), styles, ExamSection (+4 more)
...
Cohesion: 0.13
Nodes (9): NAV, Sidebar(), AuthContext, AuthProvider(), Ctx, useAuth(), DashboardLayout(), Login() (+1 more)
...
Cohesion: 0.12
Nodes (10): AuthContextType, Registration, RegistrationStatus, AffiliatedAccess, create(), CreateParams, getCredentials(), RegistrationDetail (+2 more)
...
Cohesion: 0.13
Nodes (14): useIsMobile(), AppShellProps, AppShellUser, NavItem, Separator(), SidebarFooter(), SidebarGroup(), SidebarGroupContent() (+6 more)
...
Cohesion: 0.17
Nodes (6): { Provider, useHook }, createRoleAuth(), Http, RoleAuthConfig, RoleAuthCtx, EMC
...
Cohesion: 0.2
Nodes (8): metadata, RootLayout(), AuthProvider(), Theme, ThemeContext, ThemeContextValue, ThemeProvider(), Toaster()
...
Cohesion: 0.29
Nodes (6): AuthContext, AuthCtx, { Provider, useHook }, useAuth(), NAV, NAV
...
## Knowledge Gaps
- **1147 isolated node(s):** `{ defineConfig }`, `expoConfig`, `RegistrationStatus`, `AuthContextType`, `BulkJob` (+1142 more)
...
- **Why does `Button()` connect `Mobile API Service Layer` to `Admin Mobile Screens`, `Web Auth API`, `Cluster 98`, `Web Admin Layout`, `Mobile Admin Service`, `Cluster 72`, `Cron & Background Jobs`, `Web API Client`, `Web UI Components`, `Concept / Rationale Nodes`, `Cluster 82`, `Cluster 83`, `Cluster 85`, `Document Vault Flow`, `Cluster 58`, `Auth Login & Profile Setup`?**
  _High betweenness centrality (0.076) - this node is a cross-community bridge._
- **Why does `Card()` connect `Concept / Rationale Nodes` to `Admin Mobile Screens`, `Mobile API Service Layer`, `Web Admin Layout`, `Mobile Admin Service`, `Cluster 98`, `Competitions Routes & Recs`, `Cluster 72`, `Cron & Background Jobs`, `Auth & Twilio OTP`, `Cluster 79`, `Web UI Components`, `Cluster 82`, `Cluster 83`, `Cluster 85`, `Auth Login & Profile Setup`?**
  _High betweenness centrality (0.032) - this node is a cross-community bridge._
- **Why does `cn()` connect `Auth Login & Profile Setup` to `Admin Mobile Screens`, `Web Auth API`, `Mobile API Service Layer`, `Web Admin Layout`, `Cluster 99`, `Competitions Routes & Recs`, `Cron & Background Jobs`, `Web UI Components`, `Concept / Rationale Nodes`, `Cluster 82`, `Cluster 85`, `Document Vault Flow`, `Cluster 58`, `Cluster 57`, `Cluster 63`?**
