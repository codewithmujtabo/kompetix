...
## Corpus Check
- 281 files · ~3,354,119 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2374 nodes · 4411 edges · 203 communities (129 shown, 74 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 72 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ca7a59ca`
...
Cohesion: 0.05
Nodes (45): http, req(), token(), authApi, competitionsApi, notificationsApi, organizerAuthApi, organizerProfileApi (+37 more)

### Community 1 - "School Auth Context"
Cohesion: 0.08
Nodes (42): CATEGORIES, CATS, CompetitionsPage(), Field(), FILTERS, fmtForInput(), FORM_DEFAULTS, CHECK_TYPE_LABEL (+34 more)
...
Cohesion: 0.11
Nodes (25): FILTERS, schoolHttp, Competition, STATUS_BADGE, STATUS_STYLE, fmt(), fmtRp(), Revenue() (+17 more)
...
Cohesion: 0.06
Nodes (31): authMiddleware(), Request, errorHandler(), HttpError, fileContent, parsed, router, upload (+23 more)
...
Cohesion: 0.07
Nodes (24): schoolHttp, { Provider, useHook }, SchoolContext, SchoolCtx, schoolFetch(), useSchool(), BatchResult, BulkPaymentPage() (+16 more)

### Community 13 - "Mobile App Bootstrap"
Cohesion: 0.07
Nodes (26): CATEGORIES, CompetitionFormProps, DEFAULTS, GRADE_LEVELS, STATUSES, ACTIONABLE, ACTIONABLE_STATUSES, Competition (+18 more)
...
Cohesion: 0.08
Nodes (19): BulkJob, styles, Registration, School, Student, styles, Brand, FontFamily (+11 more)
...
Cohesion: 0.07
Nodes (26): CatalogCompetition, CompetitionCard(), fmtDate(), Activity, Competition, fmtRp(), OrganizerDashboard(), OrganizerDashboardPage() (+18 more)
...
Cohesion: 0.09
Nodes (17): navTheme, queryClient, RootLayout(), HapticTab(), NotificationTabIcon(), NotificationTabIconProps, styles, Surface (+9 more)
...
Cohesion: 0.22
Nodes (16): defaultCompetition, destinationFor(), goTo(), Mode, ROLES, ArrowRightIcon(), base, EyeIcon() (+8 more)
...
Cohesion: 0.18
Nodes (12): adminHttp, RoleSelector(), UnifiedLogin(), HubAuthShell(), HubAuthShellProps, ThemeToggle(), ForgotPasswordPage(), ResetPasswordInner() (+4 more)

### Community 56 - "Cluster 56"
Cohesion: 0.13
Nodes (9): MenuItem, ROLE_EMOJI, ROLE_ICON, ROLE_LABEL, styles, formatDate(), MyRegistrationDetailsScreen(), styles (+1 more)
...
Cohesion: 0.36
Nodes (8): CompetitionAdminLayout(), competitionPaths(), competitionRegistry, defaultPortalConfig(), getCompetitionConfig(), CompetitionDashboardLayout(), CompetitionDashboardPage(), CompetitionRegisterPage()
...
## Knowledge Gaps
- **969 isolated node(s):** `{ defineConfig }`, `expoConfig`, `RegistrationStatus`, `AuthContextType`, `BulkJob` (+964 more)
...
- **Why does `Button()` connect `School Auth Context` to `Express Bootstrap & Errors`, `Admin / Audit Middleware`, `Mobile Theme System`, `Mobile App Bootstrap`, `Historical Phone Login`, `Concept / Rationale Nodes`, `Mobile Doc & User Services`, `Reset Project Script`, `Legacy Vite/Express Stack`, `Cluster 55`, `School Admin Routes`, `Auth Login & Profile Setup`?**
  _High betweenness centrality (0.047) - this node is a cross-community bridge._
- **Why does `Card()` connect `Mobile Doc & User Services` to `Admin Mobile Screens`, `School Auth Context`, `Express Bootstrap & Errors`, `Admin / Audit Middleware`, `Mobile API Plumbing`, `Mobile Theme System`, `Mobile App Bootstrap`, `Legacy Vite/Express Stack`, `School Admin Routes`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **Why does `Brand` connect `Web UI Components` to `Cluster 64`, `Mobile Admin Service`, `Mobile Tabs Misc`, `Beyond Classroom PDF`, `Themed Components & Hooks`, `Mobile API Plumbing`, `Auth & Twilio OTP`, `Cluster 81`, `Concept / Rationale Nodes`, `Profile Edit & Interests`, `Cluster 56`, `Parent Linking Flow`?**
