...
## Corpus Check
- 315 files · ~3,391,174 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2644 nodes · 5307 edges · 194 communities (121 shown, 73 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 83 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `64da5c73`
...
## Communities (194 total, 73 thin omitted)

### Community 0 - "Admin Mobile Screens"
Cohesion: 0.05
Nodes (64): CompetitionAdminLayout(), CompetitionAdminPage(), EmcAdminPage(), FILTERS, PendingRow, StatusFilter, emcHttp, defaultCompetition (+56 more)

### Community 1 - "School Auth Context"
Cohesion: 0.05
Nodes (40): styles, AuthTab, styles, AppInput(), AppInputProps, styles, INTEREST_CATEGORIES, InterestCategory (+32 more)
...
Cohesion: 0.07
Nodes (41): adminHttp, commerceHttp, CATEGORIES, CATS, CompetitionsPage(), Field(), FILTERS, fmtForInput() (+33 more)

### Community 4 - "Database Columns & Keys"
Cohesion: 0.05
Nodes (46): env, authLimiter, bulkUploadLimiter, otpSendLimiter, otpVerifyLimiter, passwordResetLimiter, pinVerifyLimiter, code (+38 more)

### Community 5 - "Backend DB Bootstrap"
Cohesion: 0.04
Nodes (54): base, codes, compId, discounted, id, imageUpload, { limit, offset, page }, mapProduct() (+46 more)

### Community 6 - "Admin / Audit Middleware"
Cohesion: 0.07
Nodes (42): questionBankHttp, { Provider, useHook }, CATEGORIES, CompetitionFormProps, DEFAULTS, GRADE_LEVELS, STATUSES, Answer (+34 more)
...
Cohesion: 0.1
Nodes (26): ExamRow, QueueRow, Competition, STATUS_BADGE, STATUS_STYLE, ProctoringSession, Access, Competition (+18 more)
...
Cohesion: 0.06
Nodes (28): pool, ACCOUNTS, main(), normalizePhone(), authMiddleware(), Request, cached, competitions (+20 more)

### Community 11 - "Auth & Twilio OTP"
Cohesion: 0.05
Nodes (34): compFilter(), liveFilter(), SOFT_DELETE_TABLES, softDelete(), adminOnly(), CHECK_TYPES, CheckType, compId (+26 more)
...
Cohesion: 0.06
Nodes (26): BulkJob, styles, Registration, School, Student, styles, HapticTab(), NotificationTabIcon() (+18 more)
...
Cohesion: 0.05
Nodes (43): code:block6 (T5 (reg_number) ──────────► T16 (mobile shows it)), Dependency Map, SPRINT 0 — Quick Wins ✅ COMPLETE, SPRINT 10 — Mobile Bug Fixes (May 6, 2026 Session 2) ✅ COMPLETE, SPRINT 11 — Bug Fixes (May 6, 2026 Session 3) ✅ COMPLETE, SPRINT 12 — Rebrand Kompetix → Competzy (May 8, 2026 Session 4) ✅ COMPLETE, SPRINT 13 — Production Infra Templates (May 9, 2026 Session 5) ✅ LOCAL ARTIFACTS DONE, SPRINT 14 — Compliance & Security Hardening (May 8–9, 2026 Sessions 4–5) ✅ COMPLETE (+35 more)

### Community 17 - "Concept / Rationale Nodes"
Cohesion: 0.08
Nodes (32): ExamsListPage(), GradingQueuePage(), QuestionEditorPage(), PaperExamsPage(), ProctoringPage(), ProductsPage(), CompetitionPicker(), useQuestionBank() (+24 more)
...
Cohesion: 0.07
Nodes (32): ReviewQuestionPage(), cn(), StatusBadge(), Avatar(), AvatarBadge(), AvatarFallback(), AvatarGroup(), AvatarGroupCount() (+24 more)
...
Cohesion: 0.12
Nodes (19): BatchResult, BulkPaymentPage(), fmtRp(), RegistrationRow, ExamPlayerPage(), fmt(), fmtDateTime(), GradingSession (+11 more)
...
Cohesion: 0.13
Nodes (16): registrationsApi, TYPES, STATUS_CLS, STATUS_STYLE, STATUSES, PageHeader(), Pager(), Spinner() (+8 more)
...
Cohesion: 0.11
Nodes (17): metadata, RoleSelector(), UnifiedLogin(), AuthProvider(), ThemeToggle(), ForgotPasswordPage(), ResetPasswordInner(), Theme (+9 more)
...
Cohesion: 0.17
Nodes (11): CompetitionStudent, DashboardSummary, getDashboardSummary(), getMyStudents(), getUpcomingDeadlines(), linkStudent(), Student, StudentStats (+3 more)
...
Cohesion: 0.15
Nodes (11): requireRole(), areaId, id, { limit, offset, page }, loadTestCenter(), mapTestCenter(), name, params (+3 more)
...
Cohesion: 0.15
Nodes (4): NAV, AuthContext, Ctx, LINKS
...
## Knowledge Gaps
- **1094 isolated node(s):** `{ defineConfig }`, `expoConfig`, `RegistrationStatus`, `AuthContextType`, `BulkJob` (+1089 more)
...
- **Why does `Button()` connect `Parent Linking Flow` to `Admin Mobile Screens`, `Web Auth API`, `Web Admin Layout`, `Admin / Audit Middleware`, `Auth & Competitions Routes`, `Cluster 74`, `Cluster 75`, `Concept / Rationale Nodes`, `Admin Routes (Backend)`, `Web API Index`, `Cluster 55`, `Document Vault Flow`?**
  _High betweenness centrality (0.060) - this node is a cross-community bridge._
- **Why does `Card()` connect `Parent Linking Flow` to `Admin Mobile Screens`, `Express Bootstrap & Errors`, `Web Auth API`, `Web Admin Layout`, `Mobile Admin Service`, `Admin / Audit Middleware`, `Auth & Competitions Routes`, `Cluster 74`, `Cluster 75`, `Concept / Rationale Nodes`, `Admin Routes (Backend)`, `Web API Index`, `Cluster 55`?**
  _High betweenness centrality (0.028) - this node is a cross-community bridge._
- **Why does `cn()` connect `Web API Index` to `Admin Mobile Screens`, `Web Auth API`, `Web Admin Layout`, `Mobile Admin Service`, `Admin / Audit Middleware`, `Auth & Competitions Routes`, `Cluster 59`, `Cluster 74`, `Cluster 75`, `Mobile API Plumbing`, `Concept / Rationale Nodes`, `Admin Routes (Backend)`, `Mobile Payments Service`, `Document Vault Flow`, `Parent Linking Flow`?**
