...
## Corpus Check
- 343 files · ~3,414,363 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2808 nodes · 5876 edges · 204 communities (131 shown, 73 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 94 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f8901617`
...
7. `Brand` - 47 edges
8. `Sprint Plan (Full Roadmap)` - 47 edges
...
## Communities (204 total, 73 thin omitted)
...
Cohesion: 0.09
Nodes (49): DEFAULTS, commerceHttp, marketingHttp, CATEGORIES, CATS, CompetitionsPage(), Field(), FILTERS (+41 more)

### Community 2 - "Mobile API Service Layer"
Cohesion: 0.04
Nodes (60): mapOrder(), mapVoucherGroup(), pageParams(), productCompIfAccessible(), voucherGroupCompIfAccessible(), ansByQ, byNumber, chosen (+52 more)

### Community 3 - "Web Admin Layout"
Cohesion: 0.05
Nodes (39): ExamResultScreen(), styles, sum(), styles, WINDOW_NOTE, Elevation, Fonts, Motion (+31 more)

### Community 4 - "Database Columns & Keys"
Cohesion: 0.04
Nodes (46): compFilter(), liveFilter(), SOFT_DELETE_TABLES, softDelete(), audit(), AuditOptions, REDACT_KEYS, requireRole() (+38 more)

### Community 5 - "Backend DB Bootstrap"
Cohesion: 0.08
Nodes (35): ExamRow, ExamsListPage(), ProctoringPage(), ProctoringSession, CompetitionPicker(), QuestionBankDashboard(), QuestionRow, fmt() (+27 more)

### Community 6 - "Admin / Audit Middleware"
Cohesion: 0.07
Nodes (43): questionBankHttp, { Provider, useHook }, CATEGORIES, CompetitionFormProps, DEFAULTS, GRADE_LEVELS, STATUSES, CHECK_TYPE_LABEL (+35 more)
...
Cohesion: 0.06
Nodes (31): pool, ACCOUNTS, main(), normalizePhone(), authMiddleware(), Request, cached, competitions (+23 more)
...
Cohesion: 0.07
Nodes (38): authLimiter, bulkUploadLimiter, otpSendLimiter, otpVerifyLimiter, passwordResetLimiter, pinVerifyLimiter, code, e164 (+30 more)
...
Cohesion: 0.04
Nodes (48): code:block6 (T5 (reg_number) ──────────► T16 (mobile shows it)), Dependency Map, SPRINT 0 — Quick Wins ✅ COMPLETE, SPRINT 10 — Mobile Bug Fixes (May 6, 2026 Session 2) ✅ COMPLETE, SPRINT 11 — Bug Fixes (May 6, 2026 Session 3) ✅ COMPLETE, SPRINT 12 — Rebrand Kompetix → Competzy (May 8, 2026 Session 4) ✅ COMPLETE, SPRINT 13 — Production Infra Templates (May 9, 2026 Session 5) ✅ LOCAL ARTIFACTS DONE, SPRINT 14 — Compliance & Security Hardening (May 8–9, 2026 Sessions 4–5) ✅ COMPLETE (+40 more)
...
Cohesion: 0.07
Nodes (27): navTheme, queryClient, RootLayout(), styles, AuthTab, styles, AppInput(), AppInputProps (+19 more)
...
Cohesion: 0.07
Nodes (32): env, errorHandler(), HttpError, childrenMap, expiresAt, normalizedEmail, params, pin (+24 more)
...
Cohesion: 0.09
Nodes (21): FILTERS, TYPES, STATUS_CLS, STATUS_STYLE, STATUSES, Competition, Registration, STATUS_CLS (+13 more)

### Community 28 - "Organizer Competition Forms"
Cohesion: 0.1
Nodes (22): CompetitionAdminPage(), EmcAdminPage(), PendingRow, StatusFilter, emcHttp, PortalCompetition, usePortalComp(), AccessInfo (+14 more)

### Community 29 - "School Admin Routes"
Cohesion: 0.08
Nodes (26): AnnouncementsPage(), GradingQueuePage(), QueueRow, ExamEditorPage(), ExamQuestion, GRADE_OPTIONS, LoadedExam, MaterialsPage() (+18 more)
...
Cohesion: 0.1
Nodes (14): CatalogCompetition, CompetitionCard(), fmtDate(), Competition, STATUS_BADGE, STATUS_STYLE, GradingSession, GradingSessionPage() (+6 more)
...
Cohesion: 0.13
Nodes (17): adminHttp, metadata, AuthContext, AuthCtx, AuthProvider(), { Provider, useHook }, HubAuthShell(), HubAuthShellProps (+9 more)
...
Cohesion: 0.13
Nodes (14): OrganizerProvider(), useOrganizer(), Activity, Competition, fmtRp(), OrganizerDashboard(), OrganizerDashboardPage(), RecentActivity (+6 more)

### Community 48 - "Profile Completion"
Cohesion: 0.2
Nodes (19): announcement(), area(), exam(), localToday(), main(), material(), product(), question() (+11 more)

### Community 49 - "Mobile Registrations Service"
Cohesion: 0.13
Nodes (15): ExamPlayerScreen(), fmtClock(), styles, Radius, subjectColorFor(), ExamPeriod, GeometricHeader, GeometricHeaderImpl() (+7 more)

### Community 50 - "Mobile Auth Service"
Cohesion: 0.13
Nodes (10): AnnouncementCard(), fmtDate(), styles, styles, styles, Announcement, getAnnouncements(), getMaterials() (+2 more)
...
Cohesion: 0.15
Nodes (8): questionMakerHttp, { Provider, useHook }, { Provider, useHook }, createRoleAuth(), Http, RoleAuthConfig, RoleAuthCtx, { Provider, useHook }
...
Cohesion: 0.16
Nodes (10): organizerHttp, OrganizerContext, OrganizerCtx, { Provider, useHook }, Competition, CompetitionDetailPage(), fmtDate(), fmtRp() (+2 more)
...
Cohesion: 0.25
Nodes (6): useAuth(), NAV, Sidebar(), DashboardLayout(), NAV, Login()
...
## Knowledge Gaps
- **1150 isolated node(s):** `{ defineConfig }`, `expoConfig`, `RegistrationStatus`, `AuthContextType`, `BulkJob` (+1145 more)
...
- **Why does `Button()` connect `Mobile Tabs Misc` to `Web Auth API`, `School Auth Context`, `Cluster 64`, `Web Admin Layout`, `Cluster 99`, `Backend DB Bootstrap`, `Admin / Audit Middleware`, `Competitions Routes & Recs`, `Beyond Classroom PDF`, `Cluster 104`, `Registrations Routes`, `Web UI Components`, `Cluster 81`, `Mobile Doc & User Services`, `Cluster 83`, `Parent Linking Flow`, `Organizer Competition Forms`, `School Admin Routes`?**
  _High betweenness centrality (0.070) - this node is a cross-community bridge._
- **Why does `Card()` connect `Backend DB Bootstrap` to `Web Auth API`, `School Auth Context`, `Cluster 64`, `Web Admin Layout`, `Mobile Tabs Misc`, `Cluster 99`, `Admin / Audit Middleware`, `Cluster 104`, `Registrations Routes`, `Admin API Methods`, `Web UI Components`, `Cluster 81`, `Cluster 83`, `Cluster 87`, `Parent Linking Flow`, `Organizer Competition Forms`, `School Admin Routes`?**
  _High betweenness centrality (0.037) - this node is a cross-community bridge._
- **Why does `cn()` connect `Registrations Routes` to `Cluster 64`, `School Auth Context`, `Mobile Tabs Misc`, `Backend DB Bootstrap`, `Admin / Audit Middleware`, `Beyond Classroom PDF`, `Admin API Methods`, `Web UI Components`, `Cluster 81`, `Cluster 80`, `Mobile Doc & User Services`, `Cluster 57`, `Parent Linking Flow`, `School Admin Routes`?**
