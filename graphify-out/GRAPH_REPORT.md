...
## Corpus Check
- 272 files · ~3,341,786 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2283 nodes · 4156 edges · 204 communities (130 shown, 74 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 72 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ba9fea3a`
...
3. `apiRequest()` - 58 edges
4. `Brand` - 41 edges
5. `Card()` - 31 edges
6. `pool` - 31 edges
7. `Button()` - 30 edges
8. `Sprint Plan (Full Roadmap)` - 30 edges
9. `Spacing` - 29 edges
10. `Radius` - 29 edges
...
Cohesion: 0.06
Nodes (57): CompetitionAdminLayout(), CompetitionAdminPage(), EmcAdminPage(), PendingRow, StatusFilter, adminHttp, emcHttp, defaultCompetition (+49 more)
...
Cohesion: 0.07
Nodes (21): BulkJob, styles, Registration, School, Student, styles, HapticTab(), NotificationTabIcon() (+13 more)
...
Cohesion: 0.1
Nodes (20): CATEGORIES, CompetitionFormProps, CompetitionFormValues, DEFAULTS, GRADE_LEVELS, STATUSES, TYPES, Competition (+12 more)
...
Cohesion: 0.1
Nodes (20): CATEGORIES, CATS, FILTERS, FORM_DEFAULTS, STATUS_CLS, STATUS_STYLE, STATUSES, Pager() (+12 more)

### Community 12 - "Mobile Theme System"
Cohesion: 0.12
Nodes (19): FILTERS, schoolHttp, Competition, STATUS_BADGE, STATUS_STYLE, fmt(), fmtRp(), Revenue() (+11 more)

### Community 13 - "Mobile App Bootstrap"
Cohesion: 0.08
Nodes (22): schoolHttp, { Provider, useHook }, SchoolContext, SchoolCtx, schoolFetch(), useSchool(), BulkRegistrationPage(), Competition (+14 more)

### Community 14 - "Registrations Routes"
Cohesion: 0.09
Nodes (22): Spacing, Text, Type, formatDate(), MyRegistrationDetailsScreen(), styles, HEIGHT, PAD_H (+14 more)
...
Cohesion: 0.12
Nodes (17): ACTIONABLE, ACTIONABLE_STATUSES, Competition, Registration, STATUS_CLS, STATUS_STYLE, FORM_DEFAULTS, PendingSchool (+9 more)

### Community 17 - "Concept / Rationale Nodes"
Cohesion: 0.1
Nodes (22): authLimiter, bulkUploadLimiter, otpSendLimiter, otpVerifyLimiter, passwordResetLimiter, pinVerifyLimiter, code, e164 (+14 more)

### Community 18 - "Mobile Doc & User Services"
Cohesion: 0.08
Nodes (31): AppAutocomplete, AppInput, AuthContext / AuthProvider, 4-Tab Information Architecture (D3), Bulk CSV Registration (S11), UU PDP Consent Screen at Signup, Twilio Dev OTP Bypass (000000), Dual Auth (phone OTP + email) (+23 more)

### Community 19 - "Web Competitions Page"
Cohesion: 0.09
Nodes (15): Shadow, Surface, Slide, slides, styles, PAYER_OPTIONS, PayerKind, PaymentState (+7 more)
...
Cohesion: 0.07
Nodes (29): SPRINT 0 — Quick Wins ✅ COMPLETE, SPRINT 10 — Mobile Bug Fixes (May 6, 2026 Session 2) ✅ COMPLETE, SPRINT 11 — Bug Fixes (May 6, 2026 Session 3) ✅ COMPLETE, SPRINT 12 — Rebrand Kompetix → Competzy (May 8, 2026 Session 4) ✅ COMPLETE, SPRINT 13 — Production Infra Templates (May 9, 2026 Session 5) ✅ LOCAL ARTIFACTS DONE, SPRINT 14 — Compliance & Security Hardening (May 8–9, 2026 Sessions 4–5) ✅ COMPLETE, SPRINT 15 — Launch 1 Polish (May 8, 2026 Session 4) ✅ COMPLETE, SPRINT 16 — School Portal Soft Launch (May 9, 2026 Session 5) ✅ COMPLETE (+21 more)

### Community 23 - "Teacher Mobile Flow"
Cohesion: 0.1
Nodes (6): pool, env, ACCOUNTS, main(), normalizePhone(), SOFT_DELETE_TABLES

### Community 24 - "Payments Backend"
Cohesion: 0.08
Nodes (27): bulk-processor.service.ts, scheduleBulkJobProcessor, scheduleRetentionEnforcement, cron.service.ts, pm2.config.js, PROJECT_PLAN.md, RUNBOOK.md, email.service.ts (+19 more)

### Community 25 - "Document Vault Flow"
Cohesion: 0.1
Nodes (15): organizerCompetitionsApi, CompetitionForm(), CATEGORIES, GRADE_LEVELS, Competition, CompetitionDetailPage(), fmtDate(), fmtRp() (+7 more)

### Community 26 - "Documents Backend"
Cohesion: 0.1
Nodes (24): cn(), StatusBadge(), Avatar(), AvatarBadge(), AvatarFallback(), AvatarGroup(), AvatarGroupCount(), AvatarImage() (+16 more)

### Community 27 - "Parent Linking Flow"
Cohesion: 0.1
Nodes (15): Kpi, LINKS, QUICK_LINKS, Activity, Competition, fmtRp(), OrganizerDashboardPage(), RecentActivity (+7 more)
...
Cohesion: 0.1
Nodes (18): authMiddleware(), Request, fileContent, parsed, router, upload, router, conditions (+10 more)
...
Cohesion: 0.1
Nodes (11): INTEREST_CATEGORIES, InterestCategory, DOC_TYPES, Document, styles, formatDateForDisplay(), ProfileEditScreen(), styles (+3 more)

### Community 32 - "Web Auth API"
Cohesion: 0.12
Nodes (22): Sidebar(), SidebarContext, SidebarContextProps, SidebarGroup(), SidebarGroupAction(), SidebarInput(), SidebarMenu(), SidebarMenuAction() (+14 more)

### Community 33 - "Express Bootstrap & Errors"
Cohesion: 0.09
Nodes (21): adminOnly(), compIdFilter, conditions, csv, csvRows, data, headers, params (+13 more)
...
Cohesion: 0.1
Nodes (15): BatchResult, BulkPaymentPage(), fmtRp(), RegistrationRow, ADMIN_QUICK, ADMIN_QUICK_LINKS, QuickLink, SchoolDashboard() (+7 more)

### Community 36 - "Mobile Tabs Misc"
Cohesion: 0.11
Nodes (12): authApi, queryClient, RootLayout(), NAV, AuthContext, AuthProvider(), Ctx, useAuth() (+4 more)
...
Cohesion: 0.2
Nodes (15): notificationsApi, organizerAuthApi, organizerProfileApi, organizerRegistrationsApi, organizerRevenueApi, registrationsApi, usersApi, ROLE_CLS (+7 more)
...
Cohesion: 0.21
Nodes (21): AuthContext (useUser), ChildrenScreen, DiscoverScreen, config/api (API_BASE_URL), document.service, DocumentVaultScreen, LinkParentScreen, Parent-Student PIN Invitation Flow (+13 more)

### Community 43 - "Auth Register Screen"
Cohesion: 0.13
Nodes (16): useIsMobile(), AppShell(), AppShellProps, AppShellUser, initials(), NavItem, Separator(), SidebarContent() (+8 more)

### Community 44 - "CLAUDE.md Concepts"
Cohesion: 0.13
Nodes (14): metadata, AuthContext, AuthCtx, AuthProvider(), { Provider, useHook }, useAuth(), NAV, Sidebar() (+6 more)
...
Cohesion: 0.19
Nodes (8): competitionsApi, schoolsApi, PageHeader(), Pager(), Spinner(), Toast(), CATS, EMPTY_FORM
...
Cohesion: 0.16
Nodes (8): styles, AuthTab, styles, AppInput(), AppInputProps, styles, styles, UserProfile
...
Cohesion: 0.13
Nodes (15): @react-native-async-storage/async-storage (external), auth.signup, emsifa Indonesia regions API (external), historical.service, clearCitiesCache, fetchIndonesianCities, Location Service (cities), ProfileCompletionScreen (+7 more)

### Community 61 - "Cluster 61"
Cohesion: 0.19
Nodes (11): styles, acceptInvitation(), approveLink(), DebugInvitation, getDebugInvitations(), getMyChildren(), getPendingInvitations(), inviteParent() (+3 more)

### Community 62 - "Cluster 62"
Cohesion: 0.15
Nodes (8): Radius, styles, Tab, GeometricHeader, GeometricHeaderImpl(), Palette, paletteColors(), Props
...
Cohesion: 0.16
Nodes (9): audit(), AuditOptions, REDACT_KEYS, organizerOnly(), csvRows, csvUpload, headers, router (+1 more)
...
Cohesion: 0.15
Nodes (12): CompetitionStudent, DashboardSummary, Deadline, getDashboardSummary(), getMyCompetitions(), getMyStudents(), getUpcomingDeadlines(), linkStudent() (+4 more)
...
Cohesion: 0.15
Nodes (7): AuthContextType, RegistrationStatus, MenuItem, ROLE_EMOJI, ROLE_ICON, ROLE_LABEL, styles

### Community 70 - "Cluster 70"
Cohesion: 0.17
Nodes (9): cached, competitions, conditions, now, recommendationsCache, router, values, getRecommendations() (+1 more)
...
Cohesion: 0.24
Nodes (12): analytics, CompetitionDetailArchive, CompetitionDetailPage, competitions.service, favorites.service, IconSymbol, MyCompetitionsScreen, NotificationTabIcon (+4 more)
...
Cohesion: 0.2
Nodes (6): Registration, create(), CreateParams, RegistrationDetail, remove(), updateStatus()
...
## Knowledge Gaps
- **913 isolated node(s):** `{ defineConfig }`, `expoConfig`, `RegistrationStatus`, `AuthContextType`, `BulkJob` (+908 more)
...
- **Why does `Button()` connect `Web UI Components` to `Admin Mobile Screens`, `Web Auth API`, `Mobile Admin Service`, `Auth & Competitions Routes`, `Auth & Twilio OTP`, `Mobile Theme System`, `Mobile App Bootstrap`, `Registrations Routes`, `Auth Register Screen`, `Document Vault Flow`, `Documents Backend`?**
  _High betweenness centrality (0.046) - this node is a cross-community bridge._
- **Why does `Card()` connect `Auth & Competitions Routes` to `Admin Mobile Screens`, `Mobile Admin Service`, `Auth & Twilio OTP`, `Mobile Theme System`, `Mobile App Bootstrap`, `Web UI Components`, `Web Competitions Page`, `Document Vault Flow`, `Documents Backend`, `Parent Linking Flow`?**
  _High betweenness centrality (0.024) - this node is a cross-community bridge._
- **Why does `cn()` connect `Documents Backend` to `Admin Mobile Screens`, `Web Auth API`, `Mobile Admin Service`, `Auth & Competitions Routes`, `Auth & Twilio OTP`, `Mobile Theme System`, `Mobile App Bootstrap`, `Auth Register Screen`, `Cluster 79`, `Web UI Components`, `Cluster 55`, `Document Vault Flow`, `Parent Linking Flow`?**
