...
## Corpus Check
- 279 files · ~3,348,742 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2339 nodes · 4360 edges · 206 communities (131 shown, 75 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 72 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `25c773a9`
...
## Communities (206 total, 75 thin omitted)
...
Cohesion: 0.08
Nodes (29): CHECK_TYPE_LABEL, CHECK_TYPE_OPTIONS, CheckType, FlowEditorDialog(), FlowStep, FORM_DEFAULTS, ACTIONABLE, ACTIONABLE_STATUSES (+21 more)

### Community 6 - "Admin / Audit Middleware"
Cohesion: 0.06
Nodes (31): schoolHttp, { Provider, useHook }, SchoolContext, SchoolCtx, schoolFetch(), schoolHttp, useSchool(), BatchResult (+23 more)

### Community 7 - "Web Auth Contexts"
Cohesion: 0.07
Nodes (22): pool, ACCOUNTS, main(), normalizePhone(), authMiddleware(), Request, fileContent, parsed (+14 more)
...
Cohesion: 0.1
Nodes (29): cn(), Activity, Competition, fmtRp(), OrganizerDashboardPage(), RecentActivity, Stats, ChartCard() (+21 more)

### Community 15 - "Parent Routes & Email"
Cohesion: 0.08
Nodes (18): BulkJob, styles, Registration, School, Student, styles, FontFamily, styles (+10 more)

### Community 16 - "Web UI Components"
Cohesion: 0.11
Nodes (20): Competition, CsvRow, JobStatus, STEPS, fmt(), fmtRp(), Revenue(), RevenueData (+12 more)

### Community 17 - "Concept / Rationale Nodes"
Cohesion: 0.09
Nodes (23): env, authLimiter, bulkUploadLimiter, otpSendLimiter, otpVerifyLimiter, passwordResetLimiter, pinVerifyLimiter, code (+15 more)
...
Cohesion: 0.08
Nodes (17): organizerCompetitionsApi, CATEGORIES, CompetitionForm(), CompetitionFormProps, CompetitionFormValues, DEFAULTS, GRADE_LEVELS, STATUSES (+9 more)
...
Cohesion: 0.09
Nodes (16): navTheme, queryClient, RootLayout(), HapticTab(), NotificationTabIcon(), NotificationTabIconProps, styles, Surface (+8 more)

### Community 25 - "Document Vault Flow"
Cohesion: 0.11
Nodes (13): CatalogCompetition, CompetitionCard(), fmtDate(), Competition, CompetitionDetailPage(), fmtDate(), fmtRp(), formatCurrency() (+5 more)
...
Cohesion: 0.11
Nodes (14): Spacing, Text, HEIGHT, PAD_H, Props, Size, styles, Variant (+6 more)
...
Cohesion: 0.1
Nodes (10): STATUS_CFG, STATUS_LABEL, styles, TabKey, TABS, TabType, formatDate(), MyRegistrationDetailsScreen() (+2 more)
...
Cohesion: 0.13
Nodes (14): TYPES, Competition, Registration, STATUS_CLS, STATUS_STYLE, STATUS_TABS, Select(), SelectContent() (+6 more)

### Community 39 - "Competitions Routes & Recs"
Cohesion: 0.14
Nodes (12): styles, AuthTab, styles, AppInput(), AppInputProps, styles, Brand, Shadow (+4 more)
...
Cohesion: 0.14
Nodes (12): Radius, IoniconName, PAYER_OPTIONS, PayerKind, PaymentState, STATE_CONTENT, styles, GeometricHeader (+4 more)
...
Cohesion: 0.19
Nodes (10): AuthContext, AuthCtx, { Provider, useHook }, useAuth(), NAV, Sidebar(), DashboardLayout(), NAV (+2 more)
...
Cohesion: 0.2
Nodes (11): expo-notifications (external), k6-registration.js, loadtest README, Push Notification Service, GET /:id/calendar.ics, GET /:id/completeness, registrations.routes.ts, clearBadgeCount (+3 more)
...
## Knowledge Gaps
- **946 isolated node(s):** `{ defineConfig }`, `expoConfig`, `RegistrationStatus`, `AuthContextType`, `BulkJob` (+941 more)
...
- **Why does `Button()` connect `Document Vault Flow` to `Admin Mobile Screens`, `Express Bootstrap & Errors`, `Backend DB Bootstrap`, `Admin / Audit Middleware`, `Audit & Organizer Middleware`, `Web API Client`, `Push Notifications`, `Registrations Routes`, `Web UI Components`, `Web Competitions Page`, `Auth Login & Profile Setup`?**
  _High betweenness centrality (0.048) - this node is a cross-community bridge._
- **Why does `Card()` connect `Registrations Routes` to `Admin Mobile Screens`, `Backend DB Bootstrap`, `Admin / Audit Middleware`, `Audit & Organizer Middleware`, `Competitions Routes & Recs`, `Web API Client`, `Web UI Components`, `Web Competitions Page`, `Cluster 85`, `Document Vault Flow`?**
  _High betweenness centrality (0.025) - this node is a cross-community bridge._
- **Why does `Brand` connect `Competitions Routes & Recs` to `Express Bootstrap & Errors`, `k6 Load Test`, `Mobile Admin Service`, `Mobile Tabs Misc`, `Cluster 90`, `Cluster 68`, `Beyond Classroom PDF`, `Auth & Twilio OTP`, `Cluster 79`, `Parent Routes & Email`, `Mobile Payments Service`, `Payments Backend`, `Cluster 89`, `Cluster 56`?**
