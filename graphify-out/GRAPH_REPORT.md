...
## Corpus Check
- 272 files · ~3,341,593 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2280 nodes · 4153 edges · 205 communities (131 shown, 74 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 72 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a34b860d`
...
Cohesion: 0.05
Nodes (60): CompetitionAdminLayout(), CompetitionAdminPage(), EmcAdminPage(), PendingRow, StatusFilter, adminHttp, emcHttp, defaultCompetition (+52 more)

### Community 1 - "School Auth Context"
Cohesion: 0.08
Nodes (32): competitionsApi, CATEGORIES, CATS, FILTERS, FORM_DEFAULTS, STATUS_CLS, STATUS_STYLE, STATUSES (+24 more)
...
Cohesion: 0.09
Nodes (24): CATEGORIES, CompetitionFormProps, DEFAULTS, GRADE_LEVELS, STATUSES, TYPES, ACTIONABLE, ACTIONABLE_STATUSES (+16 more)
...
Cohesion: 0.08
Nodes (20): BulkJob, styles, Registration, School, Student, styles, Brand, Round (+12 more)

### Community 13 - "Mobile App Bootstrap"
Cohesion: 0.09
Nodes (21): fmt(), fmtRp(), Revenue(), RevenueData, RevenuePage(), ADMIN_QUICK, ADMIN_QUICK_LINKS, QuickLink (+13 more)
...
Cohesion: 0.09
Nodes (19): AuthContext, AuthCtx, AuthProvider(), { Provider, useHook }, useAuth(), NAV, Sidebar(), useAuth() (+11 more)

### Community 17 - "Concept / Rationale Nodes"
Cohesion: 0.1
Nodes (21): authLimiter, otpSendLimiter, otpVerifyLimiter, passwordResetLimiter, pinVerifyLimiter, code, e164, email (+13 more)
...
Cohesion: 0.1
Nodes (17): Spacing, Text, Type, styles, styles, HEIGHT, PAD_H, Props (+9 more)
...
Cohesion: 0.17
Nodes (13): FILTERS, Competition, STATUS_BADGE, STATUS_STYLE, Deadline, Student, Student, Table() (+5 more)
...
Cohesion: 0.1
Nodes (19): authMiddleware(), Request, bulkUploadLimiter, fileContent, parsed, router, upload, router (+11 more)
...
Cohesion: 0.14
Nodes (11): notificationsApi, schoolsApi, usersApi, PageHeader(), Pager(), Spinner(), Toast(), CATS (+3 more)
...
Cohesion: 0.09
Nodes (9): Shadow, Slide, slides, styles, styles, Tab, styles, Props (+1 more)
...
Cohesion: 0.13
Nodes (16): useIsMobile(), AppShell(), AppShellProps, AppShellUser, initials(), NavItem, Separator(), SidebarFooter() (+8 more)
...
Cohesion: 0.13
Nodes (18): Sidebar(), SidebarContent(), SidebarContext, SidebarContextProps, SidebarGroupAction(), SidebarInput(), SidebarMenuAction(), SidebarMenuBadge() (+10 more)
...
Cohesion: 0.17
Nodes (10): Surface, MenuItem, ROLE_EMOJI, ROLE_ICON, ROLE_LABEL, styles, Pill, PillImpl() (+2 more)
...
Cohesion: 0.18
Nodes (11): Current Task Status (as of May 13, 2026 — Session 10), EMC Port (begins 2026-05-13) — Wave 1 ✅ COMPLETE (4 phases shipped), EMC Port (begins 2026-05-13) — Wave 1 ✅ COMPLETE · Wave 2 ✅ COMPLETE, EMC Port (begins 2026-05-13) — Wave 1 ✅ COMPLETE · Wave 2 🚧 IN EXECUTION, EMC Port (begins 2026-05-13) — Wave 1 IN EXECUTION (4 phases), Manual rollout still required (Sprint 13/17 — needs your access), Manual rollout still required (Sprint 13/17 — needs your access), Manual rollout still required (Sprint 13/17 — needs your access) (+3 more)
...
Cohesion: 0.28
Nodes (6): metadata, Toaster(), Tooltip(), TooltipContent(), TooltipProvider(), TooltipTrigger()
...
## Knowledge Gaps
- **910 isolated node(s):** `{ defineConfig }`, `expoConfig`, `RegistrationStatus`, `AuthContextType`, `BulkJob` (+905 more)
...
- **Why does `Button()` connect `School Auth Context` to `Admin Mobile Screens`, `Auth & Competitions Routes`, `Cron & Background Jobs`, `Themed Components & Hooks`, `Auth Register Screen`, `Mobile App Bootstrap`, `Admin Routes (Backend)`, `Web API Index`, `Document Vault Flow`, `Documents Backend`?**
  _High betweenness centrality (0.046) - this node is a cross-community bridge._
- **Why does `Card()` connect `Mobile App Bootstrap` to `Admin Mobile Screens`, `School Auth Context`, `Mobile Admin Service`, `Auth & Competitions Routes`, `Cron & Background Jobs`, `Web UI Components`, `Web API Index`, `Document Vault Flow`, `Documents Backend`, `Analytics & Competition Detail`?**
  _High betweenness centrality (0.021) - this node is a cross-community bridge._
- **Why does `cn()` connect `Documents Backend` to `Admin Mobile Screens`, `School Auth Context`, `Auth & Competitions Routes`, `Cron & Background Jobs`, `Themed Components & Hooks`, `Auth Register Screen`, `Cluster 76`, `Mobile App Bootstrap`, `Cluster 83`, `Reset Project Script`, `Web API Index`, `Document Vault Flow`, `Analytics & Competition Detail`?**
