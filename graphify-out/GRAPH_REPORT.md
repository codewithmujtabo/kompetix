...
## Corpus Check
- 305 files · ~3,378,590 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2563 nodes · 5063 edges · 194 communities (120 shown, 74 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 78 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a052d2af`
...
## Communities (194 total, 74 thin omitted)

### Community 0 - "Admin Mobile Screens"
Cohesion: 0.07
Nodes (48): questionBankHttp, { Provider, useHook }, CATEGORIES, CompetitionFormProps, DEFAULTS, GRADE_LEVELS, STATUSES, Answer (+40 more)
...
Cohesion: 0.05
Nodes (38): styles, AuthTab, styles, AppInput(), AppInputProps, styles, Elevation, FontFamily (+30 more)
...
Cohesion: 0.1
Nodes (27): schoolHttp, ExamRow, QueueRow, Competition, STATUS_BADGE, STATUS_STYLE, fmt(), fmtRp() (+19 more)

### Community 9 - "Cron & Background Jobs"
Cohesion: 0.08
Nodes (29): FILTERS, CATEGORIES, CATS, CompetitionsPage(), Field(), FILTERS, fmtForInput(), FORM_DEFAULTS (+21 more)

### Community 10 - "Web API Client"
Cohesion: 0.07
Nodes (35): CompetitionForm(), CompetitionFormValues, CATEGORIES, GRADE_LEVELS, ExamsListPage(), GradingQueuePage(), QuestionEditorPage(), PaperExamsPage() (+27 more)
...
Cohesion: 0.06
Nodes (27): Spacing, Text, Type, DOC_TYPES, Document, IoniconName, styles, Deadline (+19 more)
...
Cohesion: 0.07
Nodes (28): CHECK_TYPE_LABEL, CHECK_TYPE_OPTIONS, CheckType, FlowEditorDialog(), FlowStep, FORM_DEFAULTS, ExamLite, PaperExam (+20 more)
...
Cohesion: 0.08
Nodes (25): schoolHttp, { Provider, useHook }, SchoolContext, SchoolCtx, schoolFetch(), useSchool(), BatchResult, BulkPaymentPage() (+17 more)
...
Cohesion: 0.08
Nodes (18): navTheme, queryClient, RootLayout(), HapticTab(), NotificationTabIcon(), NotificationTabIconProps, styles, Surface (+10 more)
...
Cohesion: 0.18
Nodes (15): CompetitionAdminLayout(), { Provider, useHook }, BrandPanel(), Props, CompetitionPortalConfig, CatalogCompetition, CompetitionCard(), fmtDate() (+7 more)
...
Cohesion: 0.11
Nodes (13): OrganizerProvider(), SchoolProvider(), NAV, OrganizerLayoutInner(), QuestionBankProvider(), NAV, ADMIN_NAV, SchoolLayout() (+5 more)
...
Cohesion: 0.15
Nodes (9): organizerCompetitionsApi, Competition, CompetitionDetailPage(), fmtDate(), fmtRp(), formatCurrency(), STATUS_BADGE, CATEGORIES (+1 more)
...
Cohesion: 0.28
Nodes (7): organizerHttp, OrganizerContext, OrganizerCtx, { Provider, useHook }, useOrganizer(), OrganizerDashboard(), OrganizerLogin()
...
## Knowledge Gaps
- **1056 isolated node(s):** `{ defineConfig }`, `expoConfig`, `RegistrationStatus`, `AuthContextType`, `BulkJob` (+1051 more)
...
- **Why does `Button()` connect `Admin Mobile Screens` to `Express Bootstrap & Errors`, `k6 Load Test`, `Competitions CSV Seeder`, `Auth & Competitions Routes`, `Cron & Background Jobs`, `Web API Client`, `Mobile API Plumbing`, `Parent Linking Flow`, `Registrations Routes`, `Admin API Methods`, `Web UI Components`, `Legacy Vite/Express Stack`, `Competition Detail Mobile`, `Cluster 59`, `Cluster 61`?**
  _High betweenness centrality (0.063) - this node is a cross-community bridge._
- **Why does `Card()` connect `Web API Client` to `Admin Mobile Screens`, `Express Bootstrap & Errors`, `Mobile API Service Layer`, `Auth & Competitions Routes`, `Cron & Background Jobs`, `Parent Linking Flow`, `Web UI Components`, `Profile Completion`, `Legacy Vite/Express Stack`, `Competition Detail Mobile`, `Cluster 59`, `Cluster 61`?**
  _High betweenness centrality (0.030) - this node is a cross-community bridge._
- **Why does `cn()` connect `Parent Linking Flow` to `Admin Mobile Screens`, `Competitions CSV Seeder`, `Competitions Routes & Recs`, `Auth & Competitions Routes`, `Cron & Background Jobs`, `Web API Client`, `Cluster 75`, `Mobile API Plumbing`, `Admin API Methods`, `Web UI Components`, `Profile Completion`, `Legacy Vite/Express Stack`, `Cluster 60`, `Cluster 61`?**
