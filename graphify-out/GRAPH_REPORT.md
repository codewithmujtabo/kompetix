...
## Corpus Check
- 269 files · ~3,344,800 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2228 nodes · 3777 edges · 197 communities (122 shown, 75 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 72 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ce7b8f1c`
...
## Communities (197 total, 75 thin omitted)
...
Cohesion: 0.06
Nodes (63): useIsMobile(), cn(), AppShell(), AppShellProps, AppShellUser, initials(), NavItem, Avatar() (+55 more)
...
Cohesion: 0.08
Nodes (38): STATUS_CLS, STATUS_STYLE, StatusBadge(), STATUSES, FORM_DEFAULTS, PendingSchool, STATUS_BADGE, Pager() (+30 more)
...
Cohesion: 0.07
Nodes (24): Shadow, Spacing, Text, Type, styles, Tab, MenuItem, ROLE_EMOJI (+16 more)
...
Cohesion: 0.08
Nodes (22): Kpi, LINKS, QUICK_LINKS, Segment, ChartCard(), ChartCardProps, PageHeader(), PageHeaderProps (+14 more)
...
Cohesion: 0.1
Nodes (18): CATEGORIES, CATS, FILTERS, FORM_DEFAULTS, TYPES, Badge(), badgeVariants, Input() (+10 more)
...
Cohesion: 0.1
Nodes (27): base, docType, ext, router, upload, ext, fields, photoUpload (+19 more)
...
Cohesion: 0.08
Nodes (18): ALL_GRADES, Grade, GRADES, Role, ROLES, SD, SMA, SMP (+10 more)
...
Cohesion: 0.09
Nodes (12): Surface, Slide, slides, styles, PAYER_OPTIONS, PayerKind, PaymentState, STATE_CONTENT (+4 more)
...
Cohesion: 0.13
Nodes (15): AuthContext, AuthCtx, { Provider, useHook }, useAuth(), NAV, Sidebar(), useAuth(), DashboardLayout() (+7 more)
...
Cohesion: 0.22
Nodes (7): metadata, queryClient, RootLayout(), AuthProvider(), AuthProvider(), ThemeProvider(), Toaster()
...
## Knowledge Gaps
- **885 isolated node(s):** `{ defineConfig }`, `expoConfig`, `RegistrationStatus`, `AuthContextType`, `BulkJob` (+880 more)
...
- **Why does `Button()` connect `Web Admin Layout` to `Cron & Background Jobs`, `School Auth Context`, `Parent Routes & Email`?**
  _High betweenness centrality (0.044) - this node is a cross-community bridge._
- **Why does `cn()` connect `School Auth Context` to `Web Admin Layout`, `Mobile App Bootstrap`, `Parent Routes & Email`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **Why does `Card()` connect `Mobile App Bootstrap` to `Web Admin Layout`, `School Auth Context`, `Mobile Admin Service`, `Parent Routes & Email`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
