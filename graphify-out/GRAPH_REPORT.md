# Graph Report - competzy  (2026-05-15)

## Corpus Check
- 269 files · ~3,344,700 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2224 nodes · 3695 edges · 204 communities (130 shown, 74 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 72 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9e6f5283`
...
Cohesion: 0.07
Nodes (42): CATEGORIES, CATS, FILTERS, FORM_DEFAULTS, STATUS_CLS, STATUS_STYLE, StatusBadge(), STATUSES (+34 more)
...
Cohesion: 0.07
Nodes (43): DashboardLayout(), NAV, useIsMobile(), AppShell(), AppShellProps, AppShellUser, initials(), NavItem (+35 more)
...
Cohesion: 0.06
Nodes (27): Shadow, Spacing, Text, Type, PAYER_OPTIONS, PayerKind, PaymentState, STATE_CONTENT (+19 more)
...
Cohesion: 0.09
Nodes (27): cn(), Avatar(), AvatarBadge(), AvatarFallback(), AvatarGroup(), AvatarGroupCount(), AvatarImage(), DropdownMenuCheckboxItem() (+19 more)

### Community 14 - "Registrations Routes"
Cohesion: 0.09
Nodes (20): Kpi, LINKS, QUICK_LINKS, ChartCard(), ChartCardProps, PageHeader(), PageHeaderProps, ACCENT (+12 more)
...
Cohesion: 0.08
Nodes (19): OrganizerContext, OrganizerCtx, OrganizerProvider(), { Provider, useHook }, useOrganizer(), Competition, OrganizerDashboard(), RecentActivity (+11 more)
...
Cohesion: 0.2
Nodes (18): defaultCompetition, destinationFor(), goTo(), Mode, ROLES, RoleSelector(), ArrowRightIcon(), base (+10 more)

### Community 24 - "Payments Backend"
Cohesion: 0.1
Nodes (19): authMiddleware(), Request, fileContent, parsed, router, upload, router, conditions (+11 more)

### Community 25 - "Document Vault Flow"
Cohesion: 0.1
Nodes (18): metadata, queryClient, RootLayout(), AuthContext, AuthCtx, AuthProvider(), { Provider, useHook }, useAuth() (+10 more)
...
Cohesion: 0.12
Nodes (5): pool, env, main(), normalizePhone(), SOFT_DELETE_TABLES
...
Cohesion: 0.26
Nodes (12): CompetitionAdminLayout(), CompetitionAdminPage(), PendingRow, StatusFilter, { Provider, useHook }, competitionPaths(), competitionRegistry, getCompetitionConfig() (+4 more)
...
Cohesion: 0.19
Nodes (8): EmcAdminPage(), emcHttp, { Provider, useHook }, EMC, PortalCompetition, usePortalComp(), EmcDashboardPage(), EmcRegisterPage()
...
Cohesion: 0.12
Nodes (7): organizerCompetitionsApi, CATEGORIES, GRADE_LEVELS, CATEGORIES, GRADE_LEVELS, Competition, STATUS_BADGE
...
Cohesion: 0.12
Nodes (10): Surface, Slide, slides, styles, Props, Variant, Pill, PillImpl() (+2 more)
...
Cohesion: 0.18
Nodes (4): adminHttp, PendingSchool, STATUS_BADGE, Segment
...
Cohesion: 0.23
Nodes (8): UnifiedLogin(), ThemeToggle(), ForgotPasswordPage(), ResetPasswordInner(), Theme, ThemeContext, ThemeContextValue, useTheme()
...
Cohesion: 0.18
Nodes (10): ext, fields, photoUpload, roleData, router, sFields, sValues, tFields (+2 more)
...
Cohesion: 0.22
Nodes (9): Current Task Status (as of May 13, 2026 — Session 10), EMC Port (begins 2026-05-13) — Wave 1 ✅ COMPLETE (4 phases shipped), EMC Port (begins 2026-05-13) — Wave 1 ✅ COMPLETE · Wave 2 🚧 IN EXECUTION, EMC Port (begins 2026-05-13) — Wave 1 IN EXECUTION (4 phases), Manual rollout still required (Sprint 13/17 — needs your access), Manual rollout still required (Sprint 13/17 — needs your access), Manual rollout still required (Sprint 13/17 — needs your access), Manual rollout still required (Sprint 13/17 — needs your access) (+1 more)
...
Cohesion: 0.32
Nodes (6): organizerHttp, Competition, CompetitionDetailPage(), fmtDate(), formatCurrency(), STATUS_BADGE
...
## Knowledge Gaps
- **883 isolated node(s):** `{ defineConfig }`, `expoConfig`, `RegistrationStatus`, `AuthContextType`, `BulkJob` (+878 more)
...
- **Why does `Button()` connect `Admin Mobile Screens` to `Web Admin Layout`, `Mobile App Bootstrap`, `Admin / Audit Middleware`?**
  _High betweenness centrality (0.040) - this node is a cross-community bridge._
- **Why does `cn()` connect `Mobile App Bootstrap` to `Admin Mobile Screens`, `Cluster 74`, `Web Admin Layout`, `Registrations Routes`?**
  _High betweenness centrality (0.021) - this node is a cross-community bridge._
- **Why does `Card()` connect `Registrations Routes` to `Admin Mobile Screens`, `Mobile Payments Service`, `Mobile App Bootstrap`?**
