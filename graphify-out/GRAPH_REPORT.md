...
## Corpus Check
- 288 files · ~3,358,658 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2425 nodes · 4633 edges · 201 communities (127 shown, 74 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 72 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `03afa252`
...
5. `Card()` - 40 edges
6. `Button()` - 38 edges
7. `Sprint Plan (Full Roadmap)` - 36 edges
8. `pool` - 34 edges
...
## Communities (201 total, 74 thin omitted)

### Community 0 - "Admin Mobile Screens"
Cohesion: 0.05
Nodes (66): CompetitionAdminLayout(), CompetitionAdminPage(), EmcAdminPage(), PendingRow, StatusFilter, adminHttp, emcHttp, questionBankHttp (+58 more)

### Community 1 - "School Auth Context"
Cohesion: 0.07
Nodes (43): CATEGORIES, CATS, CompetitionsPage(), Field(), FILTERS, fmtForInput(), FORM_DEFAULTS, CHECK_TYPE_LABEL (+35 more)

### Community 2 - "Mobile API Service Layer"
Cohesion: 0.1
Nodes (30): FILTERS, schoolHttp, Competition, STATUS_BADGE, STATUS_STYLE, QuestionRow, STATUS_STYLE, Subject (+22 more)
...
Cohesion: 0.08
Nodes (37): Answer, COGNITIVE, GRADE_OPTIONS, LEVELS, LoadedQuestion, QuestionEditorPage(), TaxItem, TopicTag (+29 more)

### Community 5 - "Backend DB Bootstrap"
Cohesion: 0.05
Nodes (35): compFilter(), liveFilter(), SOFT_DELETE_TABLES, softDelete(), adminOnly(), requireRole(), CHECK_TYPES, CheckType (+27 more)
...
Cohesion: 0.07
Nodes (31): env, authLimiter, otpSendLimiter, otpVerifyLimiter, passwordResetLimiter, pinVerifyLimiter, code, e164 (+23 more)
...
Cohesion: 0.06
Nodes (24): navTheme, queryClient, RootLayout(), Surface, AuthContextType, AuthProvider(), Registration, RegistrationStatus (+16 more)
...
Cohesion: 0.1
Nodes (31): useIsMobile(), AppShellProps, AppShellUser, NavItem, Sidebar(), SidebarContent(), SidebarContext, SidebarContextProps (+23 more)
...
Cohesion: 0.08
Nodes (18): Text, Type, styles, Tab, HEIGHT, PAD_H, Props, Size (+10 more)
...
Cohesion: 0.11
Nodes (19): defaultCompetition, destinationFor(), goTo(), Mode, ROLES, STATUS_CLS, STATUS_STYLE, StatusBadge() (+11 more)

### Community 28 - "Organizer Competition Forms"
Cohesion: 0.1
Nodes (14): Radius, Shadow, Spacing, Slide, slides, styles, formatDate(), MyRegistrationDetailsScreen() (+6 more)
...
Cohesion: 0.13
Nodes (9): CATEGORIES, CompetitionFormProps, DEFAULTS, GRADE_LEVELS, STATUSES, SchoolPendingPage(), PagerProps, Button() (+1 more)
...
Cohesion: 0.17
Nodes (13): bulkUploadLimiter, fileContent, parsed, router, upload, hashPassword(), CsvRow, parseAndValidateCsv() (+5 more)
...
## Knowledge Gaps
- **988 isolated node(s):** `{ defineConfig }`, `expoConfig`, `RegistrationStatus`, `AuthContextType`, `BulkJob` (+983 more)
...
- **Why does `Button()` connect `Mobile API Plumbing` to `Admin Mobile Screens`, `School Auth Context`, `Mobile API Service Layer`, `Database Columns & Keys`, `Web API Client`, `Cluster 79`, `Web Competitions Page`, `Web API Index`, `Document Vault Flow`, `Parent Linking Flow`?**
  _High betweenness centrality (0.058) - this node is a cross-community bridge._
- **Why does `Card()` connect `Database Columns & Keys` to `Admin Mobile Screens`, `School Auth Context`, `Mobile API Service Layer`, `Web API Client`, `Mobile API Plumbing`, `Cluster 79`, `Document Vault Flow`, `Parent Linking Flow`, `Organizer Competition Forms`, `School Admin Routes`?**
  _High betweenness centrality (0.029) - this node is a cross-community bridge._
- **Why does `Brand` connect `Mobile Payments Service` to `Express Bootstrap & Errors`, `k6 Load Test`, `Competitions CSV Seeder`, `Auth & Competitions Routes`, `Registrations Routes`, `Web UI Components`, `Profile Completion`, `Mobile Registrations Service`, `Web API Index`, `Organizer Competition Forms`?**
