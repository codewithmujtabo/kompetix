...
## Corpus Check
- 316 files · ~3,392,223 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2645 nodes · 5313 edges · 201 communities (128 shown, 73 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 83 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5d8b354d`
...
Cohesion: 0.04
Nodes (46): styles, AuthTab, styles, AppInput(), AppInputProps, styles, Brand, Shadow (+38 more)
...
Cohesion: 0.08
Nodes (40): FILTERS, commerceHttp, ACTIONABLE, ACTIONABLE_STATUSES, Competition, Credential, Registration, STATUS_CLS (+32 more)

### Community 4 - "Database Columns & Keys"
Cohesion: 0.04
Nodes (55): base, codes, compId, discounted, id, imageUpload, { limit, offset, page }, mapProduct() (+47 more)

### Community 5 - "Backend DB Bootstrap"
Cohesion: 0.05
Nodes (44): env, authLimiter, bulkUploadLimiter, otpSendLimiter, otpVerifyLimiter, passwordResetLimiter, pinVerifyLimiter, code (+36 more)

### Community 6 - "Admin / Audit Middleware"
Cohesion: 0.08
Nodes (36): BatchResult, BulkPaymentPage(), fmtRp(), RegistrationRow, ExamRow, ExamsListPage(), GradingQueuePage(), QueueRow (+28 more)

### Community 7 - "Web Auth Contexts"
Cohesion: 0.06
Nodes (30): pool, ACCOUNTS, main(), normalizePhone(), authMiddleware(), Request, cached, competitions (+22 more)
...
Cohesion: 0.06
Nodes (31): schoolHttp, { Provider, useHook }, SchoolContext, SchoolCtx, schoolFetch(), schoolHttp, useSchool(), BulkRegistrationPage() (+23 more)
...
Cohesion: 0.09
Nodes (30): defaultCompetition, destinationFor(), goTo(), Mode, ROLES, CATEGORIES, CATS, CompetitionsPage() (+22 more)
...
Cohesion: 0.06
Nodes (31): liveFilter(), SOFT_DELETE_TABLES, softDelete(), requireRole(), compId, hasCompAccess(), id, loadQuestion() (+23 more)
...
Cohesion: 0.09
Nodes (18): CatalogCompetition, CompetitionCard(), fmtDate(), Competition, STATUS_BADGE, STATUS_STYLE, ExamResultPage(), Section (+10 more)
...
Cohesion: 0.12
Nodes (22): Sidebar(), SidebarContext, SidebarContextProps, SidebarGroupAction(), SidebarInput(), SidebarInset(), SidebarMenuAction(), SidebarMenuBadge() (+14 more)
...
Cohesion: 0.11
Nodes (14): compFilter(), adminOnly(), CHECK_TYPES, CheckType, compId, FlowStep, loadFlow(), router (+6 more)
...
Cohesion: 0.17
Nodes (15): EmcAdminPage(), PendingRow, StatusFilter, emcHttp, PortalCompetition, usePortalComp(), EmcDashboardPage(), RegistrationRow (+7 more)
...
Cohesion: 0.13
Nodes (6): adminHttp, questionMakerHttp, Area, AREA_DEFAULTS, TC_DEFAULTS, TestCenter
...
Cohesion: 0.33
Nodes (5): createRoleAuth(), Http, RoleAuthConfig, RoleAuthCtx, { Provider, useHook }
...
## Knowledge Gaps
- **1095 isolated node(s):** `{ defineConfig }`, `expoConfig`, `RegistrationStatus`, `AuthContextType`, `BulkJob` (+1090 more)
...
- **Why does `Button()` connect `Teacher Mobile Flow` to `Admin Mobile Screens`, `School Auth Context`, `k6 Load Test`, `Web Admin Layout`, `Admin / Audit Middleware`, `Cluster 73`, `Web API Client`, `Auth Register Screen`, `Mobile Theme System`, `Admin API Methods`, `Mobile Auth Service`, `Cluster 82`, `Cluster 55`, `Payments Backend`, `Cluster 63`?**
  _High betweenness centrality (0.060) - this node is a cross-community bridge._
- **Why does `Card()` connect `Admin / Audit Middleware` to `Admin Mobile Screens`, `School Auth Context`, `Web Admin Layout`, `Cluster 73`, `Web API Client`, `Mobile Theme System`, `Admin API Methods`, `Profile Completion`, `Cluster 82`, `Teacher Mobile Flow`, `Payments Backend`, `Cluster 63`?**
  _High betweenness centrality (0.030) - this node is a cross-community bridge._
- **Why does `cn()` connect `Payments Backend` to `Admin Mobile Screens`, `Cluster 64`, `k6 Load Test`, `Web Admin Layout`, `Admin / Audit Middleware`, `Web API Client`, `Mobile Theme System`, `Profile Completion`, `Cluster 81`, `Cluster 82`, `Cluster 55`, `Competition Detail Mobile`, `Teacher Mobile Flow`?**
