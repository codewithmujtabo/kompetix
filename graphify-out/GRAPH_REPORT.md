...
## Corpus Check
- 273 files · ~3,341,705 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2275 nodes · 4089 edges · 205 communities (131 shown, 74 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 72 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `708ed385`
...
8. `Type` - 29 edges
9. `Card()` - 29 edges
10. `🏆 Beyond Classroom - K-12 Competition Hub for Indonesia` - 29 edges
...
## Communities (205 total, 74 thin omitted)

### Community 0 - "Admin Mobile Screens"
Cohesion: 0.06
Nodes (55): CompetitionAdminLayout(), CompetitionAdminPage(), EmcAdminPage(), PendingRow, StatusFilter, adminHttp, emcHttp, defaultCompetition (+47 more)
...
Cohesion: 0.07
Nodes (29): Activity, Competition, fmtRp(), OrganizerDashboardPage(), RecentActivity, Stats, fmt(), fmtRp() (+21 more)
...
Cohesion: 0.1
Nodes (27): schoolHttp, { Provider, useHook }, SchoolContext, SchoolCtx, schoolFetch(), schoolHttp, useSchool(), BulkRegistrationPage() (+19 more)
...
Cohesion: 0.1
Nodes (20): CATEGORIES, CATS, FILTERS, FORM_DEFAULTS, STATUS_CLS, STATUS_STYLE, STATUSES, FORM_DEFAULTS (+12 more)
...
Cohesion: 0.09
Nodes (22): CATEGORIES, CompetitionFormProps, DEFAULTS, GRADE_LEVELS, STATUSES, TYPES, ACTIONABLE, ACTIONABLE_STATUSES (+14 more)

### Community 13 - "Mobile App Bootstrap"
Cohesion: 0.08
Nodes (18): BulkJob, styles, Registration, School, Student, styles, Round, styles (+10 more)
...
Cohesion: 0.1
Nodes (16): organizerCompetitionsApi, CompetitionForm(), CompetitionFormValues, CATEGORIES, GRADE_LEVELS, Competition, CompetitionDetailPage(), fmtDate() (+8 more)
...
Cohesion: 0.07
Nodes (27): SPRINT 0 — Quick Wins ✅ COMPLETE, SPRINT 10 — Mobile Bug Fixes (May 6, 2026 Session 2) ✅ COMPLETE, SPRINT 11 — Bug Fixes (May 6, 2026 Session 3) ✅ COMPLETE, SPRINT 12 — Rebrand Kompetix → Competzy (May 8, 2026 Session 4) ✅ COMPLETE, SPRINT 13 — Production Infra Templates (May 9, 2026 Session 5) ✅ LOCAL ARTIFACTS DONE, SPRINT 14 — Compliance & Security Hardening (May 8–9, 2026 Sessions 4–5) ✅ COMPLETE, SPRINT 15 — Launch 1 Polish (May 8, 2026 Session 4) ✅ COMPLETE, SPRINT 16 — School Portal Soft Launch (May 9, 2026 Session 5) ✅ COMPLETE (+19 more)
...
Cohesion: 0.1
Nodes (16): Spacing, Text, Type, styles, HEIGHT, PAD_H, Props, Size (+8 more)
...
Cohesion: 0.12
Nodes (22): Sidebar(), SidebarContext, SidebarContextProps, SidebarFooter(), SidebarGroupAction(), SidebarInput(), SidebarMenuAction(), SidebarMenuButton() (+14 more)
...
Cohesion: 0.09
Nodes (11): Shadow, styles, Tab, MenuItem, ROLE_EMOJI, ROLE_ICON, ROLE_LABEL, styles (+3 more)
...
Cohesion: 0.13
Nodes (20): cn(), StatusBadge(), Avatar(), AvatarBadge(), AvatarFallback(), AvatarGroup(), AvatarGroupCount(), AvatarImage() (+12 more)

### Community 34 - "k6 Load Test"
Cohesion: 0.13
Nodes (14): Competition, Registration, STATUS_CLS, STATUS_STYLE, STATUS_TABS, Pager(), Input(), Tabs() (+6 more)
...
Cohesion: 0.11
Nodes (10): INTEREST_CATEGORIES, InterestCategory, DOC_TYPES, Document, styles, formatDateForDisplay(), ProfileEditScreen(), styles (+2 more)

### Community 37 - "Competitions CSV Seeder"
Cohesion: 0.15
Nodes (17): fileContent, parsed, router, upload, hashPassword(), CsvRow, parseAndValidateCsv(), ProcessingError (+9 more)
...
Cohesion: 0.13
Nodes (14): authMiddleware(), Request, router, conditions, params, router, notifications, router (+6 more)
...
Cohesion: 0.17
Nodes (9): styles, AuthTab, styles, AppInput(), AppInputProps, styles, Brand, styles (+1 more)
...
Cohesion: 0.16
Nodes (6): Competition, STATUS_BADGE, STATUS_STYLE, PagerProps, Button(), buttonVariants
...
Cohesion: 0.14
Nodes (7): authApi, queryClient, RootLayout(), NAV, AuthContext, AuthProvider(), Ctx

### Community 59 - "Cluster 59"
Cohesion: 0.18
Nodes (11): organizerHttp, OrganizerContext, OrganizerCtx, OrganizerProvider(), { Provider, useHook }, useOrganizer(), OrganizerDashboard(), NAV (+3 more)
...
Cohesion: 0.18
Nodes (6): HapticTab(), NotificationTabIcon(), NotificationTabIconProps, styles, AuthContextType, RegistrationStatus

### Community 65 - "Cluster 65"
Cohesion: 0.15
Nodes (11): Radius, PAYER_OPTIONS, PayerKind, PaymentState, STATE_CONTENT, styles, GeometricHeader, GeometricHeaderImpl() (+3 more)

### Community 66 - "Cluster 66"
Cohesion: 0.19
Nodes (9): BatchResult, BulkPaymentPage(), fmtRp(), RegistrationRow, CompetitionStudent, MyCompetitions(), TeacherCompetition, Badge() (+1 more)
...
Cohesion: 0.17
Nodes (8): Surface, Slide, slides, styles, Pill, PillImpl(), Props, tonePalette()
...
Cohesion: 0.2
Nodes (10): Current Task Status (as of May 13, 2026 — Session 10), EMC Port (begins 2026-05-13) — Wave 1 ✅ COMPLETE (4 phases shipped), EMC Port (begins 2026-05-13) — Wave 1 ✅ COMPLETE · Wave 2 🚧 IN EXECUTION, EMC Port (begins 2026-05-13) — Wave 1 IN EXECUTION (4 phases), Manual rollout still required (Sprint 13/17 — needs your access), Manual rollout still required (Sprint 13/17 — needs your access), Manual rollout still required (Sprint 13/17 — needs your access), Manual rollout still required (Sprint 13/17 — needs your access) (+2 more)
...
## Knowledge Gaps
- **907 isolated node(s):** `{ defineConfig }`, `expoConfig`, `RegistrationStatus`, `AuthContextType`, `BulkJob` (+902 more)
...
- **Why does `Button()` connect `Cluster 56` to `Express Bootstrap & Errors`, `k6 Load Test`, `Cluster 66`, `Backend DB Bootstrap`, `Web Auth Contexts`, `Competitions Routes & Recs`, `Cron & Background Jobs`, `Mobile Theme System`, `Admin Routes (Backend)`, `Payments Backend`, `Documents Backend`?**
  _High betweenness centrality (0.039) - this node is a cross-community bridge._
- **Why does `Card()` connect `Backend DB Bootstrap` to `Express Bootstrap & Errors`, `k6 Load Test`, `Cluster 66`, `Web Auth Contexts`, `Cron & Background Jobs`, `Mobile Theme System`, `Admin Routes (Backend)`, `Cluster 56`, `Cluster 57`, `School Admin Routes`?**
  _High betweenness centrality (0.024) - this node is a cross-community bridge._
- **Why does `cn()` connect `Express Bootstrap & Errors` to `k6 Load Test`, `Cluster 66`, `Backend DB Bootstrap`, `Web Auth Contexts`, `Competitions Routes & Recs`, `Cron & Background Jobs`, `Mobile Theme System`, `Cluster 80`, `Admin Routes (Backend)`, `Cluster 55`, `Cluster 56`, `Documents Backend`?**
