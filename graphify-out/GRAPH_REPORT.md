...
## Corpus Check
- 294 files · ~3,363,909 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2456 nodes · 4764 edges · 209 communities (135 shown, 74 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 72 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `82e6e1e4`
...
Cohesion: 0.09
Nodes (33): CATEGORIES, CompetitionFormProps, DEFAULTS, GRADE_LEVELS, STATUSES, CHECK_TYPE_LABEL, CHECK_TYPE_OPTIONS, CheckType (+25 more)
...
Cohesion: 0.11
Nodes (32): questionBankHttp, { Provider, useHook }, ExamRow, ExamsListPage(), ExamEditorPage(), ExamQuestion, GRADE_OPTIONS, LoadedExam (+24 more)
...
Cohesion: 0.09
Nodes (26): FILTERS, schoolHttp, Competition, STATUS_BADGE, STATUS_STYLE, fmt(), fmtRp(), Revenue() (+18 more)
...
Cohesion: 0.12
Nodes (15): BulkJob, styles, styles, AuthTab, styles, AppInput(), AppInputProps, styles (+7 more)
...
Cohesion: 0.12
Nodes (12): emcHttp, questionMakerHttp, { Provider, useHook }, { Provider, useHook }, createRoleAuth(), Http, RoleAuthConfig, RoleAuthCtx (+4 more)
...
Cohesion: 0.13
Nodes (18): adminHttp, defaultCompetition, destinationFor(), goTo(), Mode, ROLES, RoleSelector(), UnifiedLogin() (+10 more)
...
Cohesion: 0.1
Nodes (13): AppUser, GradeLevel, MOCK_USER, UserRole, AuthContext, AuthContextType, RegistrationStatus, IoniconName (+5 more)
...
Cohesion: 0.1
Nodes (11): navTheme, queryClient, Surface, styles, Tab, MenuItem, ROLE_EMOJI, ROLE_ICON (+3 more)
...
Cohesion: 0.13
Nodes (16): cached, competitions, conditions, now, recommendationsCache, router, values, initializeCronJobs() (+8 more)
...
Cohesion: 0.29
Nodes (11): CompetitionAdminLayout(), CompetitionAdminPage(), competitionPaths(), competitionRegistry, defaultPortalConfig(), getCompetitionConfig(), usePortalComp(), CompetitionDashboardLayout() (+3 more)
...
Cohesion: 0.12
Nodes (10): Radius, IoniconName, styles, TYPE_EMOJI, TYPE_ICON, GeometricHeader, GeometricHeaderImpl(), Palette (+2 more)
...
Cohesion: 0.13
Nodes (10): PortalCompetition, AccessInfo, AffiliatedCredential, CheckType, EmcDashboardPage(), FlowProgress, FlowProgressStep, RegistrationRow (+2 more)
...
Cohesion: 0.19
Nodes (8): EmcAdminPage(), PendingRow, StatusFilter, BrandPanel(), Props, CompetitionPortalConfig, EMC, CompetitionPortalConfig
...
## Knowledge Gaps
- **997 isolated node(s):** `{ defineConfig }`, `expoConfig`, `RegistrationStatus`, `AuthContextType`, `BulkJob` (+992 more)
...
- **Why does `Button()` connect `Admin Mobile Screens` to `Web Auth API`, `Express Bootstrap & Errors`, `School Auth Context`, `Database Columns & Keys`, `Admin / Audit Middleware`, `Auth & Competitions Routes`, `Mobile Doc & User Services`, `Cluster 83`, `Cluster 84`, `Mobile Payments Service`, `Cluster 55`, `Cluster 62`, `Documents Backend`, `Analytics & Competition Detail`?**
  _High betweenness centrality (0.061) - this node is a cross-community bridge._
- **Why does `Card()` connect `Admin / Audit Middleware` to `Admin Mobile Screens`, `School Auth Context`, `Database Columns & Keys`, `Auth & Competitions Routes`, `Cluster 81`, `Cluster 83`, `Cluster 84`, `Cluster 62`, `Documents Backend`, `Parent Linking Flow`, `Analytics & Competition Detail`, `Auth Login & Profile Setup`?**
  _High betweenness centrality (0.025) - this node is a cross-community bridge._
- **Why does `cn()` connect `Documents Backend` to `Admin Mobile Screens`, `Express Bootstrap & Errors`, `School Auth Context`, `Web Auth API`, `Database Columns & Keys`, `Admin / Audit Middleware`, `Auth & Competitions Routes`, `Cluster 83`, `Cluster 84`, `Cluster 85`, `Mobile Payments Service`, `Reset Project Script`, `Auth Login & Profile Setup`, `Cluster 63`?**
