...
## Corpus Check
- 272 files · ~3,342,553 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2285 nodes · 4169 edges · 193 communities (119 shown, 74 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 72 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `54d0aa09`
...
Cohesion: 0.05
Nodes (61): CompetitionAdminLayout(), CompetitionAdminPage(), EmcAdminPage(), PendingRow, StatusFilter, emcHttp, metadata, RoleSelector() (+53 more)

### Community 1 - "School Auth Context"
Cohesion: 0.05
Nodes (46): http, organizerHttp, req(), token(), authApi, competitionsApi, notificationsApi, organizerAuthApi (+38 more)

### Community 2 - "Mobile API Service Layer"
Cohesion: 0.09
Nodes (28): FILTERS, CATEGORIES, CATS, FILTERS, FORM_DEFAULTS, STATUS_CLS, STATUS_STYLE, STATUSES (+20 more)
...
Cohesion: 0.07
Nodes (23): Spacing, Text, Type, Slide, slides, styles, PAYER_OPTIONS, PayerKind (+15 more)

### Community 8 - "Auth & Competitions Routes"
Cohesion: 0.09
Nodes (25): adminHttp, defaultCompetition, destinationFor(), goTo(), Mode, ROLES, SchoolPendingPage(), Competition (+17 more)

### Community 9 - "Cron & Background Jobs"
Cohesion: 0.07
Nodes (27): schoolHttp, { Provider, useHook }, SchoolContext, SchoolCtx, schoolFetch(), schoolHttp, useSchool(), BatchResult (+19 more)
...
Cohesion: 0.07
Nodes (19): navTheme, queryClient, RootLayout(), FontFamily, Surface, AuthContextType, AuthProvider(), RegistrationStatus (+11 more)
...
Cohesion: 0.1
Nodes (20): CATEGORIES, CompetitionFormProps, CompetitionFormValues, DEFAULTS, GRADE_LEVELS, STATUSES, TYPES, ACTIONABLE (+12 more)
...
Cohesion: 0.1
Nodes (25): Sidebar(), SidebarContent(), SidebarContext, SidebarContextProps, SidebarFooter(), SidebarGroup(), SidebarGroupAction(), SidebarInput() (+17 more)
...
Cohesion: 0.13
Nodes (16): DashboardLayout(), NAV, useIsMobile(), AppShell(), AppShellProps, AppShellUser, initials(), NavItem (+8 more)
...
Cohesion: 0.23
Nodes (20): AuthContext (useUser), ChildrenScreen, DiscoverScreen, config/api (API_BASE_URL), document.service, DocumentVaultScreen, LinkParentScreen, Parent-Student PIN Invitation Flow (+12 more)
...
- **Why does `Button()` connect `Auth & Competitions Routes` to `Admin Mobile Screens`, `Mobile API Service Layer`, `Competitions Routes & Recs`, `Cron & Background Jobs`, `Profile Completion`, `Mobile Doc & User Services`, `Web Competitions Page`, `Document Vault Flow`, `Parent Linking Flow`?**
  _High betweenness centrality (0.047) - this node is a cross-community bridge._
- **Why does `cn()` connect `Parent Linking Flow` to `Mobile API Service Layer`, `Database Columns & Keys`, `Competitions Routes & Recs`, `Auth & Competitions Routes`, `Cron & Background Jobs`, `Cluster 73`, `Mobile Doc & User Services`, `Web Competitions Page`, `Mobile Payments Service`, `Document Vault Flow`?**
  _High betweenness centrality (0.027) - this node is a cross-community bridge._
- **Why does `Card()` connect `Database Columns & Keys` to `Admin Mobile Screens`, `Mobile API Service Layer`, `Auth & Competitions Routes`, `Cron & Background Jobs`, `Profile Completion`, `Mobile Doc & User Services`, `Web Competitions Page`, `Parent Linking Flow`?**
