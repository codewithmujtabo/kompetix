...
## Corpus Check
- 287 files · ~3,357,396 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2403 nodes · 4516 edges · 196 communities (121 shown, 75 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 72 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1cf6e2ec`
...
4. `Brand` - 41 edges
5. `Card()` - 36 edges
6. `Sprint Plan (Full Roadmap)` - 36 edges
7. `Button()` - 35 edges
8. `pool` - 34 edges
9. `Text` - 32 edges
10. `Spacing` - 32 edges
...
## Communities (196 total, 75 thin omitted)

### Community 0 - "Admin Mobile Screens"
Cohesion: 0.05
Nodes (57): CompetitionAdminLayout(), CompetitionAdminPage(), EmcAdminPage(), PendingRow, StatusFilter, emcHttp, questionMakerHttp, defaultCompetition (+49 more)

### Community 1 - "School Auth Context"
Cohesion: 0.05
Nodes (45): http, organizerHttp, req(), token(), authApi, competitionsApi, notificationsApi, organizerAuthApi (+37 more)

### Community 2 - "Mobile API Service Layer"
Cohesion: 0.06
Nodes (34): Kpi, LINKS, QUICK_LINKS, Activity, Competition, fmtRp(), OrganizerDashboardPage(), RecentActivity (+26 more)
...
Cohesion: 0.1
Nodes (29): adminHttp, CATEGORIES, CATS, CompetitionsPage(), Field(), FILTERS, fmtForInput(), FORM_DEFAULTS (+21 more)
...
Cohesion: 0.07
Nodes (30): CATEGORIES, CompetitionFormProps, DEFAULTS, GRADE_LEVELS, STATUSES, ACTIONABLE, ACTIONABLE_STATUSES, Competition (+22 more)

### Community 10 - "Web API Client"
Cohesion: 0.06
Nodes (36): cn(), StatusBadge(), SchoolPendingPage(), Avatar(), AvatarBadge(), AvatarFallback(), AvatarGroup(), AvatarGroupCount() (+28 more)
...
Cohesion: 0.08
Nodes (19): pool, env, ACCOUNTS, main(), normalizePhone(), authMiddleware(), Request, router (+11 more)
...
Cohesion: 0.06
Nodes (35): SPRINT 0 — Quick Wins ✅ COMPLETE, SPRINT 10 — Mobile Bug Fixes (May 6, 2026 Session 2) ✅ COMPLETE, SPRINT 11 — Bug Fixes (May 6, 2026 Session 3) ✅ COMPLETE, SPRINT 12 — Rebrand Kompetix → Competzy (May 8, 2026 Session 4) ✅ COMPLETE, SPRINT 13 — Production Infra Templates (May 9, 2026 Session 5) ✅ LOCAL ARTIFACTS DONE, SPRINT 14 — Compliance & Security Hardening (May 8–9, 2026 Sessions 4–5) ✅ COMPLETE, SPRINT 15 — Launch 1 Polish (May 8, 2026 Session 4) ✅ COMPLETE, SPRINT 16 — School Portal Soft Launch (May 9, 2026 Session 5) ✅ COMPLETE (+27 more)
...
Cohesion: 0.08
Nodes (20): Shadow, Spacing, Type, styles, UserProfile, styles, HEIGHT, PAD_H (+12 more)
...
Cohesion: 0.09
Nodes (25): fileContent, parsed, router, upload, childrenMap, expiresAt, normalizedEmail, params (+17 more)
...
Cohesion: 0.13
Nodes (17): TYPES, STATUS_CLS, STATUS_STYLE, STATUSES, Badge(), badgeVariants, PageHeader(), Pager() (+9 more)

### Community 30 - "Analytics & Competition Detail"
Cohesion: 0.08
Nodes (19): styles, AuthTab, styles, ALL_GRADES, Grade, GRADES, Role, ROLES (+11 more)
...
Cohesion: 0.1
Nodes (15): navTheme, queryClient, RootLayout(), FontFamily, Surface, AuthContextType, AuthProvider(), RegistrationStatus (+7 more)

### Community 34 - "k6 Load Test"
Cohesion: 0.11
Nodes (18): metadata, RoleSelector(), UnifiedLogin(), HubAuthShell(), HubAuthShellProps, ThemeToggle(), ForgotPasswordPage(), ResetPasswordInner() (+10 more)
...
Cohesion: 0.11
Nodes (12): INTEREST_CATEGORIES, InterestCategory, Text, DOC_TYPES, Document, IoniconName, styles, formatDateForDisplay() (+4 more)
...
Cohesion: 0.17
Nodes (11): AuthContext, AuthCtx, AuthProvider(), { Provider, useHook }, useAuth(), NAV, Sidebar(), DashboardLayout() (+3 more)
...
Cohesion: 0.18
Nodes (9): SchoolProvider(), QuestionBankProvider(), NAV, ADMIN_NAV, SchoolLayout(), SchoolLayoutInner(), TEACHER_NAV, AppShell() (+1 more)
...
## Knowledge Gaps
- **981 isolated node(s):** `{ defineConfig }`, `expoConfig`, `RegistrationStatus`, `AuthContextType`, `BulkJob` (+976 more)
...
- **Why does `Button()` connect `Database Columns & Keys` to `Admin Mobile Screens`, `Web Auth API`, `Mobile API Service Layer`, `Cron & Background Jobs`, `Web API Client`, `Mobile Doc & User Services`, `Admin Routes (Backend)`, `Legacy Vite/Express Stack`, `Web API Index`, `School Admin Routes`?**
  _High betweenness centrality (0.056) - this node is a cross-community bridge._
- **Why does `Card()` connect `Mobile API Service Layer` to `Admin Mobile Screens`, `Web Auth API`, `Database Columns & Keys`, `Cron & Background Jobs`, `Web API Client`, `Admin Routes (Backend)`, `Legacy Vite/Express Stack`, `Web API Index`, `School Admin Routes`?**
  _High betweenness centrality (0.031) - this node is a cross-community bridge._
- **Why does `Brand` connect `Mobile Theme System` to `Express Bootstrap & Errors`, `Competitions CSV Seeder`, `Themed Components & Hooks`, `Cluster 74`, `Auth Register Screen`, `Mobile App Bootstrap`, `Cluster 79`, `Profile Completion`, `Cluster 84`, `Legacy Vite/Express Stack`, `Cluster 85`, `Analytics & Competition Detail`, `Cluster 62`?**
