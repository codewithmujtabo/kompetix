...
## Corpus Check
- 339 files · ~3,412,357 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2788 nodes · 5825 edges · 202 communities (129 shown, 73 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 94 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d896474f`
...
Cohesion: 0.04
Nodes (55): BulkJob, styles, styles, AuthTab, styles, AppInput(), AppInputProps, styles (+47 more)

### Community 1 - "School Auth Context"
Cohesion: 0.06
Nodes (61): DEFAULTS, marketingHttp, questionBankHttp, { Provider, useHook }, CATEGORIES, CompetitionFormProps, DEFAULTS, GRADE_LEVELS (+53 more)
...
Cohesion: 0.08
Nodes (34): FILTERS, schoolHttp, ExamRow, QueueRow, Competition, STATUS_BADGE, STATUS_STYLE, ProctoringSession (+26 more)

### Community 5 - "Backend DB Bootstrap"
Cohesion: 0.07
Nodes (40): AnnouncementsPage(), commerceHttp, ExamsListPage(), GradingQueuePage(), QuestionEditorPage(), MaterialsPage(), Order, OrderItem (+32 more)
...
Cohesion: 0.08
Nodes (29): CompetitionForm(), CATEGORIES, GRADE_LEVELS, QuestionBankDashboard(), QuestionRow, ADMIN_QUICK, ADMIN_QUICK_LINKS, QuickLink (+21 more)

### Community 14 - "Registrations Routes"
Cohesion: 0.05
Nodes (40): mapOrder(), mapVoucherGroup(), pageParams(), productCompIfAccessible(), voucherGroupCompIfAccessible(), ansByQ, byNumber, chosen (+32 more)
...
Cohesion: 0.06
Nodes (18): navTheme, queryClient, RootLayout(), styles, WINDOW_NOTE, AppUser, GradeLevel, MOCK_USER (+10 more)
...
Cohesion: 0.12
Nodes (22): CATEGORIES, CATS, CompetitionsPage(), Field(), FILTERS, fmtForInput(), FORM_DEFAULTS, FlowEditorDialog() (+14 more)
...
Cohesion: 0.09
Nodes (24): Auth Service (Mobile), bulk-processor.service.ts, scheduleBulkJobProcessor, scheduleRetentionEnforcement, cron.service.ts, pm2.config.js, PROJECT_PLAN.md, RUNBOOK.md (+16 more)

### Community 43 - "Auth Register Screen"
Cohesion: 0.1
Nodes (19): byExam, choiceQids, CLEARED, compId, deadline, examId, id, optionsByQ (+11 more)
...
Cohesion: 0.1
Nodes (22): config/api API_BASE_URL, expo-notifications (external), k6-registration.js, loadtest README, midtrans.service.ts, payments.routes.ts, POST /school-batch, POST /api/payments/snap (+14 more)
...
Cohesion: 0.14
Nodes (10): organizerCompetitionsApi, CompetitionFormValues, CATEGORIES, GRADE_LEVELS, Competition, CompetitionDetailPage(), fmtDate(), fmtRp() (+2 more)
...
Cohesion: 0.19
Nodes (6): CatalogCompetition, CompetitionCard(), fmtDate(), Suggestion, Button(), buttonVariants
...
## Knowledge Gaps
- **1145 isolated node(s):** `{ defineConfig }`, `expoConfig`, `RegistrationStatus`, `AuthContextType`, `BulkJob` (+1140 more)
...
- **Why does `Button()` connect `Cluster 66` to `Admin Mobile Screens`, `School Auth Context`, `Database Columns & Keys`, `Backend DB Bootstrap`, `Mobile App Bootstrap`, `Web UI Components`, `Payments Backend`, `Documents Backend`, `Parent Linking Flow`, `School Admin Routes`, `Express Bootstrap & Errors`, `Mobile Admin Service`, `Cluster 57`, `Cluster 61`, `Cluster 73`, `Cluster 80`, `Cluster 81`, `Cluster 96`, `Cluster 102`, `Cluster 103`?**
  _High betweenness centrality (0.068) - this node is a cross-community bridge._
- **Why does `Card()` connect `Mobile App Bootstrap` to `Admin Mobile Screens`, `School Auth Context`, `Cluster 66`, `Cluster 96`, `Database Columns & Keys`, `Backend DB Bootstrap`, `Cluster 102`, `Cluster 103`, `Mobile Admin Service`, `Cluster 73`, `Express Bootstrap & Errors`, `Cluster 80`, `Cluster 81`, `Mobile Registrations Service`, `Cluster 61`, `Payments Backend`, `Parent Linking Flow`, `School Admin Routes`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
- **Why does `cn()` connect `Express Bootstrap & Errors` to `Cluster 64`, `School Auth Context`, `Cluster 66`, `Cluster 65`, `Database Columns & Keys`, `Backend DB Bootstrap`, `Cluster 103`, `Mobile App Bootstrap`, `Web UI Components`, `Cluster 80`, `Mobile Registrations Service`, `Payments Backend`, `Cluster 57`, `Documents Backend`, `Parent Linking Flow`, `Cluster 61`?**
