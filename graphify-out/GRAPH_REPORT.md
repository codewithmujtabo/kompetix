...
## Corpus Check
- 272 files · ~3,342,569 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2286 nodes · 4195 edges · 199 communities (125 shown, 74 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 72 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ee7ac2cb`
...
Cohesion: 0.05
Nodes (62): CompetitionAdminLayout(), CompetitionAdminPage(), EmcAdminPage(), PendingRow, StatusFilter, adminHttp, emcHttp, schoolHttp (+54 more)

### Community 1 - "School Auth Context"
Cohesion: 0.05
Nodes (47): http, req(), token(), authApi, competitionsApi, notificationsApi, organizerAuthApi, organizerProfileApi (+39 more)
...
Cohesion: 0.06
Nodes (24): pool, ACCOUNTS, main(), normalizePhone(), SOFT_DELETE_TABLES, authMiddleware(), Request, fileContent (+16 more)
...
Cohesion: 0.09
Nodes (25): CATEGORIES, CATS, FILTERS, FORM_DEFAULTS, STATUS_CLS, STATUS_STYLE, StatusBadge(), STATUSES (+17 more)
...
Cohesion: 0.07
Nodes (27): styles, AuthTab, styles, AppInput(), AppInputProps, styles, Spacing, Text (+19 more)
...
Cohesion: 0.06
Nodes (21): navTheme, queryClient, RootLayout(), Shadow, Surface, Slide, slides, styles (+13 more)

### Community 12 - "Mobile Theme System"
Cohesion: 0.09
Nodes (21): CATEGORIES, CompetitionFormProps, DEFAULTS, GRADE_LEVELS, STATUSES, TYPES, ACTIONABLE, ACTIONABLE_STATUSES (+13 more)
...
Cohesion: 0.08
Nodes (19): organizerCompetitionsApi, CompetitionForm(), CompetitionFormValues, CATEGORIES, GRADE_LEVELS, Competition, CompetitionDetailPage(), fmtDate() (+11 more)
...
Cohesion: 0.11
Nodes (25): env, errorHandler(), HttpError, base, docType, ext, router, upload (+17 more)
...
Cohesion: 0.1
Nodes (19): { Provider, useHook }, SchoolContext, SchoolCtx, schoolFetch(), useSchool(), BatchResult, BulkPaymentPage(), fmtRp() (+11 more)

### Community 26 - "Documents Backend"
Cohesion: 0.12
Nodes (23): cn(), Avatar(), AvatarBadge(), AvatarFallback(), AvatarGroup(), AvatarGroupCount(), AvatarImage(), CardAction() (+15 more)
...
Cohesion: 0.12
Nodes (22): Sidebar(), SidebarContext, SidebarContextProps, SidebarGroup(), SidebarGroupAction(), SidebarInput(), SidebarMenuAction(), SidebarMenuBadge() (+14 more)
...
Cohesion: 0.18
Nodes (23): AuthContext (useUser), ChildrenScreen, config/api (API_BASE_URL), document.service, DocumentVaultScreen, IconSymbol, LinkParentScreen, NotificationTabIcon (+15 more)
...
Cohesion: 0.1
Nodes (10): AuthContextType, AuthProvider(), Registration, RegistrationStatus, STATUS_CFG, STATUS_LABEL, styles, TabKey (+2 more)
...
Cohesion: 0.14
Nodes (13): Competition, Registration, STATUS_CLS, STATUS_STYLE, STATUS_TABS, Tabs(), TabsContent(), TabsList() (+5 more)
...
Cohesion: 0.14
Nodes (10): cached, competitions, conditions, now, recommendationsCache, router, values, expo (+2 more)
...
## Knowledge Gaps
- **915 isolated node(s):** `{ defineConfig }`, `expoConfig`, `RegistrationStatus`, `AuthContextType`, `BulkJob` (+910 more)
...
- **Why does `Button()` connect `Admin / Audit Middleware` to `Admin Mobile Screens`, `Competitions Routes & Recs`, `Auth & Competitions Routes`, `Auth Register Screen`, `Mobile Theme System`, `Web UI Components`, `Concept / Rationale Nodes`, `Document Vault Flow`, `Documents Backend`, `School Admin Routes`?**
  _High betweenness centrality (0.048) - this node is a cross-community bridge._
- **Why does `cn()` connect `Documents Backend` to `Admin Mobile Screens`, `Admin / Audit Middleware`, `Competitions Routes & Recs`, `Cluster 73`, `Auth Register Screen`, `Mobile Theme System`, `Web UI Components`, `Concept / Rationale Nodes`, `Mobile Registrations Service`, `Mobile Doc & User Services`, `Document Vault Flow`, `School Admin Routes`?**
  _High betweenness centrality (0.025) - this node is a cross-community bridge._
- **Why does `Card()` connect `Mobile Doc & User Services` to `Admin Mobile Screens`, `School Auth Context`, `Admin / Audit Middleware`, `Competitions Routes & Recs`, `Auth & Twilio OTP`, `Mobile Theme System`, `Web UI Components`, `Concept / Rationale Nodes`, `Document Vault Flow`, `Documents Backend`?**
