...
## Corpus Check
- 339 files · ~3,411,814 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2785 nodes · 5820 edges · 210 communities (137 shown, 73 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 94 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `20e6cf81`
...
3. `Card()` - 67 edges
4. `Button()` - 65 edges
5. `apiRequest()` - 65 edges
6. `PageHeader()` - 51 edges
7. `Sprint Plan (Full Roadmap)` - 46 edges
8. `getCompetitionConfig()` - 45 edges
9. `Brand` - 44 edges
10. `Badge()` - 44 edges
...
## Communities (210 total, 73 thin omitted)

### Community 0 - "Admin Mobile Screens"
Cohesion: 0.04
Nodes (53): Registration, apiRequest(), RequestOptions, AuthResponse, getMe(), sendOtp(), sendPhoneOtp(), create() (+45 more)

### Community 1 - "School Auth Context"
Cohesion: 0.06
Nodes (42): schoolHttp, BatchResult, RegistrationRow, Competition, STATUS_BADGE, STATUS_STYLE, Activity, Competition (+34 more)

### Community 2 - "Mobile API Service Layer"
Cohesion: 0.04
Nodes (43): ExamResultScreen(), styles, sum(), styles, WINDOW_NOTE, Shadow, Spacing, Text (+35 more)

### Community 3 - "Web Admin Layout"
Cohesion: 0.08
Nodes (46): DEFAULTS, commerceHttp, marketingHttp, DEFAULTS, GRADES, Order, OrderItem, OrdersPage() (+38 more)
...
Cohesion: 0.07
Nodes (44): CATEGORIES, CompetitionFormProps, DEFAULTS, GRADE_LEVELS, STATUSES, CHECK_TYPE_LABEL, CHECK_TYPE_OPTIONS, CheckType (+36 more)
...
Cohesion: 0.07
Nodes (34): QuestionEditorPage(), ReviewQuestionPage(), cn(), StatusBadge(), SchoolPendingPage(), Avatar(), AvatarBadge(), AvatarFallback() (+26 more)
...
Cohesion: 0.06
Nodes (21): navTheme, queryClient, RootLayout(), AppUser, GradeLevel, MOCK_USER, UserRole, Surface (+13 more)
...
Cohesion: 0.08
Nodes (23): AnnouncementsPage(), questionBankHttp, { Provider, useHook }, ExamRow, ExamsListPage(), GradingQueuePage(), QueueRow, ExamEditorPage() (+15 more)
...
Cohesion: 0.11
Nodes (15): adminHttp, HubAuthShell(), HubAuthShellProps, GradingSession, GradingSessionPage(), Option, sum(), PagerProps (+7 more)
...
Cohesion: 0.17
Nodes (15): CompetitionAdminLayout(), CompetitionAnnouncementsLayout(), { Provider, useHook }, competitionPaths(), getCompetitionConfig(), CompetitionDashboardLayout(), CompetitionExamLayout(), CompetitionFeedbackLayout() (+7 more)
...
Cohesion: 0.15
Nodes (21): mapProduct(), base, docType, ext, router, upload, mapAnnouncement(), mapMaterial() (+13 more)
...
Cohesion: 0.2
Nodes (18): announcement(), area(), exam(), localToday(), main(), material(), product(), question() (+10 more)
...
Cohesion: 0.19
Nodes (13): errorHandler(), HttpError, initializeCronJobs(), scheduleBulkJobProcessor(), scheduleCompetitionDayReminders(), scheduleDeadlineReminders(), scheduleDeadlineUrgencyReminders(), scheduleNotificationSender() (+5 more)
...
Cohesion: 0.36
Nodes (6): BrandPanel(), Props, CompetitionPortalConfig, CompetitionPortalConfig, competitionRegistry, defaultPortalConfig()
...
## Knowledge Gaps
- **1144 isolated node(s):** `{ defineConfig }`, `expoConfig`, `RegistrationStatus`, `AuthContextType`, `BulkJob` (+1139 more)
...
- **Why does `Button()` connect `Organizer Competition Forms` to `School Auth Context`, `Mobile API Service Layer`, `Web Admin Layout`, `Admin / Audit Middleware`, `Mobile Doc & User Services`, `Web Competitions Page`, `Web API Index`, `Document Vault Flow`, `Documents Backend`, `Auth Login & Profile Setup`, `Themed Components & Hooks`, `Cluster 61`, `Cluster 82`, `Cluster 83`, `Cluster 88`, `Cluster 100`, `Cluster 101`, `Cluster 107`, `Cluster 108`, `Cluster 109`?**
  _High betweenness centrality (0.070) - this node is a cross-community bridge._
- **Why does `cn()` connect `Mobile Doc & User Services` to `School Auth Context`, `Web Admin Layout`, `Admin / Audit Middleware`, `Themed Components & Hooks`, `Mobile API Plumbing`, `Cluster 109`, `Cluster 80`, `Web Competitions Page`, `Cluster 83`, `Web API Index`, `Teacher Mobile Flow`, `Cluster 88`, `Organizer Competition Forms`, `Cluster 62`?**
  _High betweenness centrality (0.031) - this node is a cross-community bridge._
- **Why does `Card()` connect `School Auth Context` to `Mobile API Service Layer`, `Web Admin Layout`, `Admin / Audit Middleware`, `Mobile Doc & User Services`, `Web Competitions Page`, `Teacher Mobile Flow`, `Document Vault Flow`, `Documents Backend`, `Organizer Competition Forms`, `Auth Login & Profile Setup`, `Cluster 61`, `Cluster 82`, `Cluster 83`, `Cluster 88`, `Cluster 90`, `Cluster 100`, `Cluster 101`, `Cluster 107`, `Cluster 108`, `Cluster 109`?**
