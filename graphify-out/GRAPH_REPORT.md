...
## Corpus Check
- 326 files · ~3,403,750 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2724 nodes · 5604 edges · 200 communities (127 shown, 73 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 94 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `959dd7ca`
...
## Communities (200 total, 73 thin omitted)

### Community 0 - "Admin Mobile Screens"
Cohesion: 0.05
Nodes (42): styles, AuthTab, styles, AppInput(), AppInputProps, styles, INTEREST_CATEGORIES, InterestCategory (+34 more)

### Community 1 - "School Auth Context"
Cohesion: 0.06
Nodes (50): Announcement, DEFAULTS, questionBankHttp, { Provider, useHook }, CATEGORIES, CompetitionFormProps, DEFAULTS, GRADE_LEVELS (+42 more)
...
Cohesion: 0.06
Nodes (37): http, req(), token(), authApi, competitionsApi, notificationsApi, organizerAuthApi, organizerCompetitionsApi (+29 more)

### Community 4 - "Database Columns & Keys"
Cohesion: 0.07
Nodes (44): commerceHttp, marketingHttp, CATEGORIES, CATS, CompetitionsPage(), Field(), FILTERS, fmtForInput() (+36 more)

### Community 5 - "Backend DB Bootstrap"
Cohesion: 0.08
Nodes (33): FILTERS, adminHttp, schoolHttp, ExamRow, QueueRow, Competition, STATUS_BADGE, STATUS_STYLE (+25 more)
...
Cohesion: 0.06
Nodes (29): useSchool(), BatchResult, BulkPaymentPage(), fmtRp(), RegistrationRow, BulkRegistrationPage(), Competition, CsvRow (+21 more)
...
Cohesion: 0.09
Nodes (29): AnnouncementsPage(), ExamsListPage(), GradingQueuePage(), QuestionEditorPage(), ProctoringPage(), CompetitionPicker(), useQuestionBank(), QuestionBankDashboard() (+21 more)
...
Cohesion: 0.08
Nodes (29): Competition, CompetitionDetailPage(), fmtDate(), fmtRp(), formatCurrency(), STATUS_BADGE, STATUS_STYLE, cn() (+21 more)

### Community 24 - "Payments Backend"
Cohesion: 0.07
Nodes (28): useIsMobile(), AppShellProps, AppShellUser, NavItem, Avatar(), AvatarBadge(), AvatarFallback(), AvatarGroup() (+20 more)
...
Cohesion: 0.09
Nodes (22): defaultCompetition, destinationFor(), goTo(), Mode, ROLES, Order, OrderItem, OrdersPage() (+14 more)
...
Cohesion: 0.16
Nodes (18): CompetitionAdminLayout(), { Provider, useHook }, BrandPanel(), Props, CompetitionPortalConfig, competitionPaths(), CompetitionPortalConfig, competitionRegistry (+10 more)
...
Cohesion: 0.11
Nodes (22): announcementRecipients(), announcementScopeIfAccessible(), assetUpload, bonus, code, compId, custom, id (+14 more)
...
Cohesion: 0.22
Nodes (16): announcement(), area(), exam(), localToday(), main(), product(), question(), referral() (+8 more)

### Community 63 - "Cluster 63"
Cohesion: 0.14
Nodes (12): requireRole(), areaId, id, { limit, offset, page }, loadTestCenter(), mapTestCenter(), name, pageParams() (+4 more)
...
## Knowledge Gaps
- **1129 isolated node(s):** `{ defineConfig }`, `expoConfig`, `RegistrationStatus`, `AuthContextType`, `BulkJob` (+1124 more)
...
- **Why does `Button()` connect `Database Columns & Keys` to `Admin Mobile Screens`, `School Auth Context`, `Backend DB Bootstrap`, `Parent Routes & Email`, `Web Competitions Page`, `Admin Routes (Backend)`, `Teacher Mobile Flow`, `Payments Backend`, `Documents Backend`, `School Admin Routes`, `Competitions CSV Seeder`, `Cluster 60`, `Cluster 61`, `Cluster 76`, `Cluster 78`, `Cluster 83`, `Cluster 93`, `Cluster 99`, `Cluster 100`?**
  _High betweenness centrality (0.068) - this node is a cross-community bridge._
- **Why does `cn()` connect `Teacher Mobile Flow` to `School Auth Context`, `Cluster 56`, `Database Columns & Keys`, `Backend DB Bootstrap`, `Mobile Tabs Misc`, `Cluster 76`, `Parent Routes & Email`, `Web Competitions Page`, `Admin Routes (Backend)`, `Payments Backend`, `Documents Backend`?**
  _High betweenness centrality (0.027) - this node is a cross-community bridge._
- **Why does `Card()` connect `Backend DB Bootstrap` to `Admin Mobile Screens`, `School Auth Context`, `Web Auth API`, `Cluster 99`, `Database Columns & Keys`, `Cluster 100`, `Mobile Tabs Misc`, `Cluster 76`, `Cluster 78`, `Parent Routes & Email`, `School Admin Routes`, `Admin Routes (Backend)`, `Teacher Mobile Flow`, `Documents Backend`, `Cluster 60`, `Cluster 93`?**
