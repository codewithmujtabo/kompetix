...
## Corpus Check
- 244 files · ~3,338,251 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2051 nodes · 3222 edges · 196 communities (121 shown, 75 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 70 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6d23615b`
...
6. `Radius` - 29 edges
7. `Type` - 29 edges
8. `🏆 Beyond Classroom - K-12 Competition Hub for Indonesia` - 29 edges
9. `Text` - 28 edges
10. `Sprint Plan (Full Roadmap)` - 28 edges
...
Cohesion: 0.06
Nodes (58): CompetitionAdminLayout(), CompetitionAdminPage(), EmcAdminPage(), PendingRow, StatusFilter, adminHttp, emcHttp, defaultCompetition (+50 more)
...
Cohesion: 0.07
Nodes (22): BulkJob, styles, styles, Surface, Text, Type, Slide, slides (+14 more)
...
Cohesion: 0.08
Nodes (20): Registration, School, Student, styles, HapticTab(), NotificationTabIcon(), NotificationTabIconProps, styles (+12 more)

### Community 14 - "Registrations Routes"
Cohesion: 0.1
Nodes (22): env, authLimiter, bulkUploadLimiter, otpSendLimiter, otpVerifyLimiter, passwordResetLimiter, pinVerifyLimiter, code (+14 more)
...
Cohesion: 0.08
Nodes (20): AuthTab, styles, ALL_GRADES, Grade, GRADES, Role, ROLES, SD (+12 more)

### Community 20 - "Admin Routes (Backend)"
Cohesion: 0.12
Nodes (13): registrationsApi, schoolsApi, usersApi, CATS, FORM_DEFAULTS, STATUS_CLS, STATUSES, PageHeader() (+5 more)
...
Cohesion: 0.1
Nodes (16): Shadow, Spacing, Button, HEIGHT, PAD_H, Props, Size, styles (+8 more)
...
Cohesion: 0.1
Nodes (12): AppUser, GradeLevel, MOCK_USER, UserRole, AuthContext, AuthContextType, RegistrationStatus, PAYER_OPTIONS (+4 more)
...
Cohesion: 0.13
Nodes (9): authApi, queryClient, RootLayout(), NAV, AuthProvider(), Ctx, useAuth(), DashboardLayout() (+1 more)
...
Cohesion: 0.26
Nodes (12): competitionsApi, notificationsApi, organizerAuthApi, organizerProfileApi, organizerRegistrationsApi, organizerRevenueApi, AuthUser, Competition (+4 more)
...
Cohesion: 0.21
Nodes (10): styles, approveLink(), DebugInvitation, getDebugInvitations(), getMyChildren(), getPendingInvitations(), inviteParent(), InviteParentResponse (+2 more)

### Community 54 - "Competition Detail Mobile"
Cohesion: 0.22
Nodes (9): organizerHttp, OrganizerContext, OrganizerCtx, OrganizerProvider(), { Provider, useHook }, useOrganizer(), NAV, OrganizerLayoutInner() (+1 more)
...
Cohesion: 0.18
Nodes (5): organizerCompetitionsApi, CATEGORIES, GRADE_LEVELS, CATEGORIES, GRADE_LEVELS
...
Cohesion: 0.25
Nodes (8): auth.signup, historical.service, parents.service, ProfileCompletionScreen, HistoryScreen, Schools Service (Mobile), user.service, users.service
...
Cohesion: 0.38
Nodes (5): Competition, CompetitionDetailPage(), fmtDate(), formatCurrency(), STATUS_BADGE

### Community 79 - "Cluster 79"
Cohesion: 0.29
Nodes (4): ACTIONABLE_STATUSES, Competition, Registration, STATUS_CLS
...
Cohesion: 0.4
Nodes (3): fmt(), Revenue(), RevenueData

### Community 87 - "Cluster 87"
Cohesion: 0.33
Nodes (4): Competition, OrganizerDashboard(), RecentActivity, Stats
...
## Knowledge Gaps
- **866 isolated node(s):** `{ defineConfig }`, `expoConfig`, `RegistrationStatus`, `AuthContextType`, `BulkJob` (+861 more)
...
- **Why does `useAuth()` connect `Mobile Tabs Misc` to `k6 Load Test`, `Competitions Routes & Recs`, `Auth Login & Profile Setup`?**
  _High betweenness centrality (0.029) - this node is a cross-community bridge._
- **Why does `AuthUser` connect `Audit & Organizer Middleware` to `Admin Mobile Screens`, `School Auth Context`, `k6 Load Test`, `Mobile Tabs Misc`, `Competition Detail Mobile`?**
  _High betweenness centrality (0.029) - this node is a cross-community bridge._
- **Why does `apiRequest()` connect `School Admin Routes` to `Cluster 66`, `Cluster 67`, `Backend DB Bootstrap`, `Cluster 69`, `Cluster 72`, `Mobile App Bootstrap`, `Cluster 77`, `Cluster 83`, `Cluster 84`, `Profile Edit & Interests`, `Cluster 58`, `Organizer Competition Forms`?**
