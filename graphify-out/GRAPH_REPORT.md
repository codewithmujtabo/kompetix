...
## Corpus Check
- 273 files · ~3,343,221 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2263 nodes · 3946 edges · 202 communities (128 shown, 74 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 72 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c0412e74`
...
Cohesion: 0.05
Nodes (65): useIsMobile(), cn(), AppShell(), AppShellProps, AppShellUser, initials(), NavItem, Avatar() (+57 more)

### Community 2 - "Mobile API Service Layer"
Cohesion: 0.05
Nodes (41): schoolHttp, { Provider, useHook }, SchoolContext, SchoolCtx, schoolFetch(), schoolHttp, SchoolProvider(), useSchool() (+33 more)

### Community 3 - "Web Admin Layout"
Cohesion: 0.07
Nodes (35): Competition, STATUS_BADGE, STATUS_STYLE, ACTIONABLE, ACTIONABLE_STATUSES, Competition, Registration, STATUS_CLS (+27 more)
...
Cohesion: 0.1
Nodes (21): CATEGORIES, CATS, FILTERS, FORM_DEFAULTS, FORM_DEFAULTS, Pager(), PagerProps, Button() (+13 more)
...
Cohesion: 0.08
Nodes (15): Text, Type, Slide, slides, styles, styles, Tab, formatDate() (+7 more)
...
Cohesion: 0.1
Nodes (21): Activity, Competition, fmtRp(), OrganizerDashboardPage(), RecentActivity, Stats, Segment, ChartCard() (+13 more)
...
Cohesion: 0.12
Nodes (17): CATEGORIES, CompetitionFormProps, DEFAULTS, GRADE_LEVELS, STATUSES, TYPES, Input(), Label() (+9 more)
...
Cohesion: 0.1
Nodes (18): schoolAdminOnly(), actorRole, expectedSig, linkedIds, orderId, redirectToken, registrationId, { registrationId, payerKind, payerUserId } (+10 more)
...
Cohesion: 0.13
Nodes (12): Shadow, Spacing, HEIGHT, PAD_H, Props, Size, styles, Variant (+4 more)
...
Cohesion: 0.16
Nodes (9): organizerCompetitionsApi, CompetitionForm(), CompetitionFormValues, CATEGORIES, GRADE_LEVELS, CATEGORIES, GRADE_LEVELS, PageHeader() (+1 more)
...
Cohesion: 0.2
Nodes (9): Competition, CompetitionDetailPage(), fmtDate(), fmtRp(), formatCurrency(), STATUS_BADGE, STATUS_STYLE, Badge() (+1 more)
...
Cohesion: 0.17
Nodes (10): Surface, PAYER_OPTIONS, PayerKind, PaymentState, STATE_CONTENT, styles, Pill, PillImpl() (+2 more)
...
## Knowledge Gaps
- **901 isolated node(s):** `{ defineConfig }`, `expoConfig`, `RegistrationStatus`, `AuthContextType`, `BulkJob` (+896 more)
...
- **Why does `Button()` connect `Auth & Twilio OTP` to `School Auth Context`, `Web Admin Layout`, `Auth Register Screen`, `Web API Index`, `Cluster 59`?**
  _High betweenness centrality (0.047) - this node is a cross-community bridge._
- **Why does `Card()` connect `Admin Routes (Backend)` to `School Auth Context`, `Mobile API Service Layer`, `Web Admin Layout`, `Auth Register Screen`, `Auth & Twilio OTP`, `Mobile Payments Service`, `Web API Index`, `Cluster 59`?**
  _High betweenness centrality (0.023) - this node is a cross-community bridge._
- **Why does `Brand` connect `Cron & Background Jobs` to `Web Auth API`, `Cluster 65`, `Cluster 66`, `Cluster 67`, `Cluster 68`, `Express Bootstrap & Errors`, `Web API Client`, `Auth Register Screen`, `Cluster 76`, `Registrations Routes`, `Profile Completion`, `Profile Edit & Interests`, `Cluster 58`, `School Admin Routes`?**
