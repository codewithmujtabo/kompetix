...
## Corpus Check
- 290 files · ~3,360,279 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2433 nodes · 4685 edges · 203 communities (128 shown, 75 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 72 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `12c4496e`
...
5. `Brand` - 41 edges
6. `Button()` - 40 edges
7. `Sprint Plan (Full Roadmap)` - 37 edges
8. `PageHeader()` - 35 edges
9. `pool` - 34 edges
10. `Text` - 32 edges
...
Cohesion: 0.05
Nodes (63): CompetitionAdminLayout(), CompetitionAdminPage(), EmcAdminPage(), PendingRow, StatusFilter, emcHttp, questionMakerHttp, RoleSelector() (+55 more)

### Community 1 - "School Auth Context"
Cohesion: 0.07
Nodes (48): adminHttp, questionBankHttp, { Provider, useHook }, Activity, Competition, fmtRp(), OrganizerDashboardPage(), RecentActivity (+40 more)

### Community 2 - "Mobile API Service Layer"
Cohesion: 0.05
Nodes (43): env, errorHandler(), HttpError, schoolAdminOnly(), actorRole, expectedSig, linkedIds, orderId (+35 more)
...
Cohesion: 0.11
Nodes (29): FILTERS, defaultCompetition, destinationFor(), goTo(), Mode, ROLES, CATEGORIES, CATS (+21 more)

### Community 11 - "Auth & Twilio OTP"
Cohesion: 0.08
Nodes (26): CATEGORIES, CompetitionFormProps, DEFAULTS, GRADE_LEVELS, STATUSES, CHECK_TYPE_LABEL, CHECK_TYPE_OPTIONS, CheckType (+18 more)
...
Cohesion: 0.09
Nodes (28): cn(), Competition, STATUS_BADGE, STATUS_STYLE, fmt(), fmtRp(), Revenue(), RevenueData (+20 more)
...
Cohesion: 0.09
Nodes (21): ACTIONABLE, ACTIONABLE_STATUSES, Competition, Credential, Registration, STATUS_CLS, STATUS_STYLE, STATUS_CLS (+13 more)

### Community 19 - "Web Competitions Page"
Cohesion: 0.06
Nodes (36): SPRINT 0 — Quick Wins ✅ COMPLETE, SPRINT 10 — Mobile Bug Fixes (May 6, 2026 Session 2) ✅ COMPLETE, SPRINT 11 — Bug Fixes (May 6, 2026 Session 3) ✅ COMPLETE, SPRINT 12 — Rebrand Kompetix → Competzy (May 8, 2026 Session 4) ✅ COMPLETE, SPRINT 13 — Production Infra Templates (May 9, 2026 Session 5) ✅ LOCAL ARTIFACTS DONE, SPRINT 14 — Compliance & Security Hardening (May 8–9, 2026 Sessions 4–5) ✅ COMPLETE, SPRINT 15 — Launch 1 Polish (May 8, 2026 Session 4) ✅ COMPLETE, SPRINT 16 — School Portal Soft Launch (May 9, 2026 Session 5) ✅ COMPLETE (+28 more)
...
Cohesion: 0.07
Nodes (20): navTheme, queryClient, RootLayout(), Surface, AuthContextType, AuthProvider(), Registration, RegistrationStatus (+12 more)
...
Cohesion: 0.09
Nodes (22): authLimiter, bulkUploadLimiter, otpSendLimiter, otpVerifyLimiter, passwordResetLimiter, code, e164, email (+14 more)
...
Cohesion: 0.09
Nodes (17): Shadow, Text, Type, styles, Tab, HEIGHT, PAD_H, Props (+9 more)
...
Cohesion: 0.11
Nodes (18): Answer, COGNITIVE, Competition, CompetitionDetailPage(), fmtDate(), fmtRp(), formatCurrency(), GRADE_OPTIONS (+10 more)
...
Cohesion: 0.13
Nodes (11): styles, AuthTab, styles, AppInput(), AppInputProps, styles, Spacing, styles (+3 more)
...
Cohesion: 0.13
Nodes (7): Slide, slides, styles, formatDate(), MyRegistrationDetailsScreen(), styles, styles
...
- **Why does `Button()` connect `Web API Client` to `Admin Mobile Screens`, `School Auth Context`, `Database Columns & Keys`, `Auth & Twilio OTP`, `Mobile App Bootstrap`, `Mobile Doc & User Services`, `Admin Routes (Backend)`, `Documents Backend`, `Auth Login & Profile Setup`?**
  _High betweenness centrality (0.055) - this node is a cross-community bridge._
- **Why does `Card()` connect `School Auth Context` to `Admin Mobile Screens`, `Database Columns & Keys`, `Mobile API Plumbing`, `Auth & Twilio OTP`, `Web API Client`, `Mobile App Bootstrap`, `Mobile Doc & User Services`, `School Admin Routes`, `Auth Login & Profile Setup`?**
  _High betweenness centrality (0.034) - this node is a cross-community bridge._
- **Why does `cn()` connect `Mobile App Bootstrap` to `School Auth Context`, `Database Columns & Keys`, `Cluster 73`, `Web API Client`, `Auth & Twilio OTP`, `Cluster 74`, `Cluster 75`, `Mobile Doc & User Services`, `Admin Routes (Backend)`, `Profile Edit & Interests`, `Cluster 90`, `Auth Login & Profile Setup`?**
