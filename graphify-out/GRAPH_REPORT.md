...
## Corpus Check
- 341 files · ~3,413,004 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2796 nodes · 5845 edges · 205 communities (132 shown, 73 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 94 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `32442751`
...
Cohesion: 0.06
Nodes (52): commerceHttp, CATEGORIES, CATS, CompetitionsPage(), Field(), FILTERS, fmtForInput(), FORM_DEFAULTS (+44 more)
...
Cohesion: 0.08
Nodes (35): schoolHttp, ExamRow, QueueRow, Competition, STATUS_BADGE, STATUS_STYLE, ProctoringSession, CompetitionPicker() (+27 more)

### Community 5 - "Backend DB Bootstrap"
Cohesion: 0.05
Nodes (38): ExamResultScreen(), styles, sum(), Radius, Shadow, Spacing, Text, Type (+30 more)
...
Cohesion: 0.09
Nodes (25): QuestionBankDashboard(), QuestionRow, ADMIN_QUICK, ADMIN_QUICK_LINKS, QuickLink, SchoolInfo, Stats, TEACHER_QUICK (+17 more)
...
Cohesion: 0.12
Nodes (22): CompetitionAdminPage(), EmcAdminPage(), FILTERS, PendingRow, StatusFilter, emcHttp, CompetitionCheckoutPage(), rupiah() (+14 more)
...
Cohesion: 0.14
Nodes (20): CompetitionAdminLayout(), CompetitionAnnouncementsLayout(), Announcement, AnnouncementCard(), CompetitionAnnouncementsPage(), fmtDate(), { Provider, useHook }, competitionPaths() (+12 more)
...
Cohesion: 0.08
Nodes (15): navTheme, queryClient, RootLayout(), HapticTab(), NotificationTabIcon(), NotificationTabIconProps, styles, Surface (+7 more)
...
Cohesion: 0.17
Nodes (21): adminHttp, defaultCompetition, destinationFor(), goTo(), Mode, ROLES, RoleSelector(), UnifiedLogin() (+13 more)
...
Cohesion: 0.11
Nodes (12): AnnouncementCard(), fmtDate(), styles, ExamPlayerScreen(), fmtClock(), styles, styles, WINDOW_NOTE (+4 more)
...
Cohesion: 0.16
Nodes (13): metadata, AuthProvider(), HubAuthShell(), HubAuthShellProps, ThemeToggle(), ForgotPasswordPage(), ResetPasswordInner(), Theme (+5 more)
...
Cohesion: 0.12
Nodes (16): AnnouncementsPage(), ExamsListPage(), GradingQueuePage(), QuestionEditorPage(), MaterialsPage(), OrdersPage(), rupiah(), PaperExamsPage() (+8 more)
...
- **Why does `Button()` connect `Admin Mobile Screens` to `Mobile API Service Layer`, `Database Columns & Keys`, `Backend DB Bootstrap`, `Concept / Rationale Nodes`, `Web Competitions Page`, `Admin Routes (Backend)`, `Document Vault Flow`, `Organizer Competition Forms`, `Web Auth API`, `Beyond Classroom PDF`, `Mobile Payments Service`, `Cluster 57`, `Cluster 58`, `Cluster 74`, `Cluster 83`, `Cluster 84`, `Cluster 98`, `Cluster 99`, `Cluster 104`, `Cluster 105`?**
  _High betweenness centrality (0.067) - this node is a cross-community bridge._
- **Why does `cn()` connect `Organizer Competition Forms` to `Web Auth API`, `Admin Mobile Screens`, `Mobile API Service Layer`, `Cluster 64`, `Database Columns & Keys`, `Competitions Routes & Recs`, `Beyond Classroom PDF`, `Concept / Rationale Nodes`, `Cluster 82`, `Web Competitions Page`, `Cluster 83`, `Cluster 84`, `Cluster 56`, `Cluster 57`, `Cluster 58`?**
  _High betweenness centrality (0.039) - this node is a cross-community bridge._
- **Why does `Card()` connect `Concept / Rationale Nodes` to `Admin Mobile Screens`, `Mobile API Service Layer`, `Cluster 98`, `Database Columns & Keys`, `Backend DB Bootstrap`, `Cluster 99`, `Competitions Routes & Recs`, `Cluster 104`, `Cluster 105`, `Cluster 74`, `Mobile Tabs Misc`, `Web Competitions Page`, `Admin Routes (Backend)`, `Cluster 83`, `Cluster 84`, `Document Vault Flow`, `Cluster 58`, `Organizer Competition Forms`?**
