...
## Corpus Check
- 277 files · ~3,347,013 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2329 nodes · 4347 edges · 204 communities (129 shown, 75 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 72 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `14d6981a`
...
6. `Button()` - 33 edges
7. `pool` - 33 edges
8. `Sprint Plan (Full Roadmap)` - 33 edges
9. `Text` - 32 edges
10. `Spacing` - 32 edges
...
## Communities (204 total, 75 thin omitted)

### Community 0 - "Admin Mobile Screens"
Cohesion: 0.05
Nodes (59): CompetitionAdminLayout(), CompetitionAdminPage(), EmcAdminPage(), PendingRow, StatusFilter, emcHttp, metadata, RoleSelector() (+51 more)

### Community 1 - "School Auth Context"
Cohesion: 0.06
Nodes (36): schoolHttp, { Provider, useHook }, SchoolContext, SchoolCtx, schoolFetch(), useSchool(), BatchResult, BulkPaymentPage() (+28 more)

### Community 2 - "Mobile API Service Layer"
Cohesion: 0.09
Nodes (31): adminHttp, CatalogCompetition, CATEGORIES, CATS, CompetitionCard(), CompetitionsPage(), Field(), FILTERS (+23 more)
...
Cohesion: 0.1
Nodes (25): FILTERS, schoolHttp, Competition, CsvRow, JobStatus, STEPS, Competition, STATUS_BADGE (+17 more)
...
Cohesion: 0.06
Nodes (32): SPRINT 0 — Quick Wins ✅ COMPLETE, SPRINT 10 — Mobile Bug Fixes (May 6, 2026 Session 2) ✅ COMPLETE, SPRINT 11 — Bug Fixes (May 6, 2026 Session 3) ✅ COMPLETE, SPRINT 12 — Rebrand Kompetix → Competzy (May 8, 2026 Session 4) ✅ COMPLETE, SPRINT 13 — Production Infra Templates (May 9, 2026 Session 5) ✅ LOCAL ARTIFACTS DONE, SPRINT 14 — Compliance & Security Hardening (May 8–9, 2026 Sessions 4–5) ✅ COMPLETE, SPRINT 15 — Launch 1 Polish (May 8, 2026 Session 4) ✅ COMPLETE, SPRINT 16 — School Portal Soft Launch (May 9, 2026 Session 5) ✅ COMPLETE (+24 more)
...
Cohesion: 0.11
Nodes (17): CATEGORIES, CompetitionFormProps, DEFAULTS, GRADE_LEVELS, STATUSES, TYPES, ACTIONABLE, ACTIONABLE_STATUSES (+9 more)

### Community 20 - "Admin Routes (Backend)"
Cohesion: 0.11
Nodes (20): competitionsApi, notificationsApi, organizerAuthApi, organizerProfileApi, organizerRegistrationsApi, organizerRevenueApi, registrationsApi, usersApi (+12 more)

### Community 21 - "Legacy Vite/Express Stack"
Cohesion: 0.1
Nodes (19): Spacing, Text, Type, HEIGHT, PAD_H, Props, Size, styles (+11 more)

### Community 22 - "Web API Index"
Cohesion: 0.08
Nodes (12): Shadow, Slide, slides, styles, styles, Tab, formatDate(), MyRegistrationDetailsScreen() (+4 more)

### Community 23 - "Teacher Mobile Flow"
Cohesion: 0.1
Nodes (17): organizerHttp, organizerCompetitionsApi, CompetitionForm(), CompetitionFormValues, CATEGORIES, GRADE_LEVELS, Competition, CompetitionDetailPage() (+9 more)
...
Cohesion: 0.11
Nodes (23): Separator(), Sidebar(), SidebarContext, SidebarContextProps, SidebarGroupAction(), SidebarHeader(), SidebarInput(), SidebarMenuAction() (+15 more)
...
Cohesion: 0.08
Nodes (22): adminOnly(), compIdFilter, conditions, csv, csvRows, data, headers, params (+14 more)
...
Cohesion: 0.14
Nodes (15): defaultCompetition, destinationFor(), goTo(), Mode, ROLES, Competition, Registration, STATUS_CLS (+7 more)

### Community 39 - "Competitions Routes & Recs"
Cohesion: 0.16
Nodes (9): schoolsApi, PageHeader(), Pager(), Spinner(), Toast(), CATS, EMPTY_FORM, ROLE_CLS (+1 more)
...
Cohesion: 0.14
Nodes (5): pool, env, ACCOUNTS, main(), normalizePhone()
...
Cohesion: 0.12
Nodes (16): actorRole, expectedSig, linkedIds, orderId, redirectToken, registrationId, { registrationId, payerKind, payerUserId }, { registrationIds } (+8 more)
...
Cohesion: 0.14
Nodes (15): useIsMobile(), AppShell(), AppShellProps, AppShellUser, initials(), NavItem, SidebarContent(), SidebarFooter() (+7 more)
...
Cohesion: 0.14
Nodes (9): useAuth(), Dashboard(), DashboardPage(), fmtRp(), Kpi, LINKS, QUICK_LINKS, Login() (+1 more)
...
Cohesion: 0.22
Nodes (8): Activity, Competition, fmtRp(), OrganizerDashboardPage(), RecentActivity, Stats, ChartCard(), ChartCardProps
...
Cohesion: 0.29
Nodes (5): fileContent, parsed, router, upload, parseAndValidateCsv()
...
## Knowledge Gaps
- **938 isolated node(s):** `{ defineConfig }`, `expoConfig`, `RegistrationStatus`, `AuthContextType`, `BulkJob` (+933 more)
...
- **Why does `Button()` connect `Mobile API Service Layer` to `Admin Mobile Screens`, `School Auth Context`, `Audit & Organizer Middleware`, `Admin / Audit Middleware`, `Profile Completion`, `Web Competitions Page`, `Admin Routes (Backend)`, `Legacy Vite/Express Stack`, `Teacher Mobile Flow`, `Parent Linking Flow`, `Organizer Competition Forms`?**
  _High betweenness centrality (0.048) - this node is a cross-community bridge._
- **Why does `cn()` connect `Parent Linking Flow` to `School Auth Context`, `Mobile API Service Layer`, `Audit & Organizer Middleware`, `Admin / Audit Middleware`, `Cluster 79`, `Cluster 80`, `Profile Completion`, `Web Competitions Page`, `Admin Routes (Backend)`, `Cluster 55`, `Teacher Mobile Flow`, `Organizer Competition Forms`?**
  _High betweenness centrality (0.023) - this node is a cross-community bridge._
- **Why does `Card()` connect `School Auth Context` to `Admin Mobile Screens`, `Mobile API Service Layer`, `Audit & Organizer Middleware`, `Admin / Audit Middleware`, `Cluster 80`, `Web Competitions Page`, `Admin Routes (Backend)`, `Profile Edit & Interests`, `Web API Index`, `Teacher Mobile Flow`, `Parent Linking Flow`?**
  _High betweenness centrality (0.023) - this node is a cross-community bridge._
