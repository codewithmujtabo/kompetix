...
## Corpus Check
- 272 files · ~3,345,212 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2245 nodes · 3881 edges · 199 communities (125 shown, 74 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 72 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a5acc7d0`
...
Cohesion: 0.07
Nodes (29): Kpi, LINKS, QUICK_LINKS, Competition, STATUS_BADGE, STATUS_STYLE, Activity, Competition (+21 more)
...
Cohesion: 0.1
Nodes (23): ACTIONABLE, ACTIONABLE_STATUSES, Competition, Registration, STATUS_CLS, STATUS_STYLE, STATUS_CLS, STATUS_STYLE (+15 more)
...
Cohesion: 0.12
Nodes (22): fmt(), fmtRp(), Revenue(), RevenueData, RevenuePage(), FORM_DEFAULTS, Pager(), PagerProps (+14 more)

### Community 16 - "Web UI Components"
Cohesion: 0.09
Nodes (25): bulkUploadLimiter, fileContent, parsed, router, upload, childrenMap, expiresAt, normalizedEmail (+17 more)
...
Cohesion: 0.1
Nodes (16): competitionsApi, CATEGORIES, CATS, FILTERS, FORM_DEFAULTS, TYPES, Label(), Select() (+8 more)
...
Cohesion: 0.1
Nodes (13): BulkJob, styles, INTEREST_CATEGORIES, InterestCategory, Surface, DOC_TYPES, Document, styles (+5 more)

### Community 27 - "Parent Linking Flow"
Cohesion: 0.1
Nodes (17): organizerHttp, notificationsApi, organizerAuthApi, organizerCompetitionsApi, organizerProfileApi, organizerRegistrationsApi, organizerRevenueApi, registrationsApi (+9 more)
...
Cohesion: 0.2
Nodes (7): schoolsApi, PageHeader(), Pager(), Spinner(), Toast(), CATS, EMPTY_FORM
...
Cohesion: 0.3
Nodes (9): usersApi, ROLE_CLS, ROLES, AuthUser, Competition, Pagination, PendingRegistration, School (+1 more)
...
Cohesion: 0.22
Nodes (7): ScrollArea(), ScrollBar(), Tabs(), TabsContent(), TabsList(), tabsListVariants, TabsTrigger()
...
## Knowledge Gaps
- **892 isolated node(s):** `{ defineConfig }`, `expoConfig`, `RegistrationStatus`, `AuthContextType`, `BulkJob` (+887 more)
...
- **Why does `Button()` connect `Mobile Theme System` to `School Auth Context`, `Database Columns & Keys`, `Push Notifications`, `Parent Routes & Email`, `Legacy Vite/Express Stack`?**
  _High betweenness centrality (0.040) - this node is a cross-community bridge._
- **Why does `cn()` connect `School Auth Context` to `Database Columns & Keys`, `Cluster 76`, `Mobile Theme System`, `Parent Routes & Email`, `Legacy Vite/Express Stack`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **Why does `Card()` connect `Database Columns & Keys` to `School Auth Context`, `Mobile Theme System`, `Push Notifications`, `Parent Routes & Email`, `Legacy Vite/Express Stack`?**
