...
## Corpus Check
- 273 files · ~3,343,575 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2296 nodes · 4271 edges · 206 communities (132 shown, 74 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 72 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b9cc7115`
...
Cohesion: 0.06
Nodes (36): http, req(), token(), authApi, competitionsApi, notificationsApi, organizerAuthApi, organizerProfileApi (+28 more)

### Community 1 - "School Auth Context"
Cohesion: 0.07
Nodes (39): CATEGORIES, CATS, CompetitionsPage(), Field(), FILTERS, fmtForInput(), FORM_DEFAULTS, ACTIONABLE (+31 more)
...
Cohesion: 0.06
Nodes (31): Kpi, LINKS, QUICK_LINKS, Activity, Competition, fmtRp(), OrganizerDashboardPage(), RecentActivity (+23 more)
...
Cohesion: 0.12
Nodes (22): FILTERS, schoolHttp, Competition, STATUS_BADGE, STATUS_STYLE, fmt(), fmtRp(), Revenue() (+14 more)
...
Cohesion: 0.12
Nodes (19): adminHttp, defaultCompetition, destinationFor(), goTo(), Mode, ROLES, RoleSelector(), UnifiedLogin() (+11 more)

### Community 15 - "Parent Routes & Email"
Cohesion: 0.09
Nodes (20): { Provider, useHook }, SchoolContext, SchoolCtx, schoolFetch(), useSchool(), BatchResult, BulkPaymentPage(), fmtRp() (+12 more)
...
Cohesion: 0.06
Nodes (31): SPRINT 0 — Quick Wins ✅ COMPLETE, SPRINT 10 — Mobile Bug Fixes (May 6, 2026 Session 2) ✅ COMPLETE, SPRINT 11 — Bug Fixes (May 6, 2026 Session 3) ✅ COMPLETE, SPRINT 12 — Rebrand Kompetix → Competzy (May 8, 2026 Session 4) ✅ COMPLETE, SPRINT 13 — Production Infra Templates (May 9, 2026 Session 5) ✅ LOCAL ARTIFACTS DONE, SPRINT 14 — Compliance & Security Hardening (May 8–9, 2026 Sessions 4–5) ✅ COMPLETE, SPRINT 15 — Launch 1 Polish (May 8, 2026 Session 4) ✅ COMPLETE, SPRINT 16 — School Portal Soft Launch (May 9, 2026 Session 5) ✅ COMPLETE (+23 more)
...
Cohesion: 0.08
Nodes (17): Shadow, Spacing, Slide, slides, styles, HEIGHT, PAD_H, Props (+9 more)
...
Cohesion: 0.09
Nodes (14): navTheme, queryClient, RootLayout(), Surface, AuthContextType, AuthProvider(), Registration, RegistrationStatus (+6 more)
...
Cohesion: 0.12
Nodes (21): Sidebar(), SidebarContext, SidebarContextProps, SidebarGroup(), SidebarGroupAction(), SidebarInput(), SidebarMenuAction(), SidebarMenuButton() (+13 more)
...
Cohesion: 0.13
Nodes (18): errorHandler(), HttpError, Province, provinces, regencies, Regency, router, initializeCronJobs() (+10 more)

### Community 36 - "Mobile Tabs Misc"
Cohesion: 0.18
Nodes (12): EmcAdminPage(), PendingRow, StatusFilter, emcHttp, schoolHttp, PortalCompetition, usePortalComp(), CompetitionDashboardPage() (+4 more)
...
Cohesion: 0.11
Nodes (12): organizerCompetitionsApi, CATEGORIES, CompetitionForm(), CompetitionFormProps, CompetitionFormValues, DEFAULTS, GRADE_LEVELS, STATUSES (+4 more)
...
Cohesion: 0.13
Nodes (11): styles, AuthTab, styles, AppInput(), AppInputProps, styles, Text, styles (+3 more)

### Community 42 - "Mobile API Plumbing"
Cohesion: 0.18
Nodes (18): base, docType, ext, router, upload, deleteFile(), deleteLocalFile(), deleteS3() (+10 more)
...
Cohesion: 0.12
Nodes (15): useIsMobile(), AppShellProps, AppShellUser, NavItem, Separator(), SidebarContent(), SidebarFooter(), SidebarGroupContent() (+7 more)

### Community 45 - "Historical Phone Login"
Cohesion: 0.17
Nodes (9): TYPES, FORM_DEFAULTS, PageHeader(), Pager(), Spinner(), Toast(), ROLE_CLS, ROLE_STYLE (+1 more)
...
Cohesion: 0.25
Nodes (10): CompetitionAdminLayout(), CompetitionAdminPage(), CatalogCompetition, CompetitionCard(), fmtDate(), competitionPaths(), competitionRegistry, getCompetitionConfig() (+2 more)
...
Cohesion: 0.16
Nodes (10): Competition, CompetitionDetailPage(), fmtDate(), fmtRp(), formatCurrency(), STATUS_BADGE, STATUS_STYLE, SchoolPendingPage() (+2 more)
...
Cohesion: 0.13
Nodes (6): styles, Tab, formatDate(), MyRegistrationDetailsScreen(), styles, styles
...
Cohesion: 0.36
Nodes (11): ArrowRightIcon(), base, EyeIcon(), EyeOffIcon(), LockIcon(), MailIcon(), MapPinIcon(), PhoneIcon() (+3 more)
...
Cohesion: 0.24
Nodes (6): { Provider, useHook }, { Provider, useHook }, createRoleAuth(), Http, RoleAuthConfig, RoleAuthCtx
...
Cohesion: 0.22
Nodes (5): create(), CreateParams, RegistrationDetail, remove(), updateStatus()
...
Cohesion: 0.31
Nodes (7): SchoolProvider(), ADMIN_NAV, SchoolLayout(), SchoolLayoutInner(), TEACHER_NAV, AppShell(), initials()
...
Cohesion: 0.25
Nodes (6): IoniconName, PAYER_OPTIONS, PayerKind, PaymentState, STATE_CONTENT, styles
...
## Knowledge Gaps
- **918 isolated node(s):** `{ defineConfig }`, `expoConfig`, `RegistrationStatus`, `AuthContextType`, `BulkJob` (+913 more)
...
- **Why does `Button()` connect `Profile Edit & Interests` to `School Auth Context`, `Mobile Tabs Misc`, `Competitions Routes & Recs`, `Web API Client`, `CLAUDE.md Concepts`, `Historical Phone Login`, `Registrations Routes`, `Parent Routes & Email`, `Mobile Registrations Service`, `Admin Routes (Backend)`, `Payments Backend`, `Cluster 58`, `Analytics & Competition Detail`?**
  _High betweenness centrality (0.051) - this node is a cross-community bridge._
- **Why does `Card()` connect `Web API Client` to `School Auth Context`, `Web Admin Layout`, `Mobile Tabs Misc`, `Competitions Routes & Recs`, `Historical Phone Login`, `Registrations Routes`, `Parent Routes & Email`, `Mobile Registrations Service`, `Admin Routes (Backend)`, `Profile Edit & Interests`, `Payments Backend`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **Why does `cn()` connect `Payments Backend` to `School Auth Context`, `Web Admin Layout`, `Web API Client`, `CLAUDE.md Concepts`, `Historical Phone Login`, `Registrations Routes`, `Parent Routes & Email`, `Cluster 80`, `Profile Edit & Interests`, `Cluster 88`, `Cluster 57`, `Analytics & Competition Detail`?**
