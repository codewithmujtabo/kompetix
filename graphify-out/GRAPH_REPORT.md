...
## Corpus Check
- 304 files · ~3,376,489 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2553 nodes · 5010 edges · 194 communities (120 shown, 74 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 78 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `88c56947`
...
Cohesion: 0.05
Nodes (55): CompetitionAdminLayout(), CompetitionAdminPage(), EmcAdminPage(), PendingRow, StatusFilter, emcHttp, questionMakerHttp, { Provider, useHook } (+47 more)

### Community 1 - "School Auth Context"
Cohesion: 0.05
Nodes (53): navTheme, queryClient, styles, AuthTab, styles, Elevation, Fonts, Motion (+45 more)

### Community 2 - "Mobile API Service Layer"
Cohesion: 0.04
Nodes (44): apiRequest(), RequestOptions, AuthResponse, getMe(), sendOtp(), sendPhoneOtp(), create(), Document (+36 more)
...
Cohesion: 0.08
Nodes (34): CATEGORIES, CATS, CompetitionsPage(), Field(), FILTERS, fmtForInput(), FORM_DEFAULTS, CHECK_TYPE_LABEL (+26 more)
...
Cohesion: 0.09
Nodes (37): questionBankHttp, { Provider, useHook }, CATEGORIES, CompetitionFormProps, DEFAULTS, GRADE_LEVELS, STATUSES, Answer (+29 more)
...
Cohesion: 0.08
Nodes (26): ExamRow, ExamsListPage(), Competition, STATUS_BADGE, STATUS_STYLE, Access, Competition, GRADES (+18 more)
...
Cohesion: 0.1
Nodes (25): CatalogCompetition, CompetitionCard(), fmtDate(), QueueRow, ExamEditorPage(), ExamQuestion, GRADE_OPTIONS, LoadedExam (+17 more)
...
Cohesion: 0.1
Nodes (24): Competition, CompetitionDetailPage(), fmtDate(), fmtRp(), formatCurrency(), ReviewQuestionPage(), STATUS_BADGE, cn() (+16 more)
...
Cohesion: 0.1
Nodes (20): FILTERS, adminHttp, defaultCompetition, destinationFor(), goTo(), Mode, ROLES, Competition (+12 more)

### Community 31 - "Auth Login & Profile Setup"
Cohesion: 0.12
Nodes (21): GradingQueuePage(), QuestionEditorPage(), Activity, Competition, fmtRp(), OrganizerDashboardPage(), RecentActivity, Stats (+13 more)
...
Cohesion: 0.24
Nodes (14): authApi, notificationsApi, organizerAuthApi, organizerProfileApi, organizerRegistrationsApi, organizerRevenueApi, registrationsApi, usersApi (+6 more)
...
Cohesion: 0.11
Nodes (8): AuthContext, AuthContextType, Registration, RegistrationStatus, IoniconName, styles, TYPE_EMOJI, TYPE_ICON
...
Cohesion: 0.15
Nodes (8): NAV, AuthProvider(), Ctx, useAuth(), Dashboard(), DashboardPage(), fmtRp(), LINKS
...
Cohesion: 0.15
Nodes (10): AppInput(), AppInputProps, styles, INTEREST_CATEGORIES, InterestCategory, formatDateForDisplay(), ProfileEditScreen(), styles (+2 more)
...
Cohesion: 0.2
Nodes (10): subjectColorFor(), GeometricHeader, GeometricHeaderImpl(), Palette, paletteColors(), Props, pickLetter(), Props (+2 more)
...
Cohesion: 0.22
Nodes (8): metadata, RootLayout(), AuthProvider(), Toaster(), Tooltip(), TooltipContent(), TooltipProvider(), TooltipTrigger()
...
## Knowledge Gaps
- **1051 isolated node(s):** `{ defineConfig }`, `expoConfig`, `RegistrationStatus`, `AuthContextType`, `BulkJob` (+1046 more)
...
- **Why does `Button()` connect `Parent Routes & Email` to `Admin Mobile Screens`, `School Auth Context`, `Backend DB Bootstrap`, `Cron & Background Jobs`, `Web API Client`, `Auth & Twilio OTP`, `Cluster 75`, `Web API Index`, `Documents Backend`, `Analytics & Competition Detail`, `Auth Login & Profile Setup`?**
  _High betweenness centrality (0.058) - this node is a cross-community bridge._
- **Why does `Card()` connect `Parent Routes & Email` to `Admin Mobile Screens`, `School Auth Context`, `Backend DB Bootstrap`, `Cron & Background Jobs`, `Web API Client`, `Auth & Twilio OTP`, `Cluster 75`, `Cluster 81`, `Documents Backend`, `Analytics & Competition Detail`, `Auth Login & Profile Setup`?**
  _High betweenness centrality (0.032) - this node is a cross-community bridge._
- **Why does `Brand` connect `Web Competitions Page` to `School Auth Context`, `Cluster 66`, `Admin / Audit Middleware`, `Cluster 71`, `Beyond Classroom PDF`, `Themed Components & Hooks`, `Push Notifications`, `Reset Project Script`, `Mobile Payments Service`, `School Admin Routes`?**
