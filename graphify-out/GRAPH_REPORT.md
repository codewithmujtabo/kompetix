...
## Corpus Check
- 240 files · ~3,336,786 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2032 nodes · 3153 edges · 199 communities (125 shown, 74 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 70 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `350f8291`
...
Cohesion: 0.05
Nodes (56): CompetitionAdminLayout(), CompetitionAdminPage(), EmcAdminPage(), PendingRow, StatusFilter, adminHttp, emcHttp, defaultCompetition (+48 more)
...
Cohesion: 0.07
Nodes (20): Spacing, Text, Type, Slide, slides, styles, styles, Tab (+12 more)
...
Cohesion: 0.1
Nodes (12): pool, main(), normalizePhone(), audit(), AuditOptions, REDACT_KEYS, organizerOnly(), csvRows (+4 more)
...
Cohesion: 0.13
Nodes (12): registrationsApi, useAuth(), CATS, FORM_DEFAULTS, STATUS_CLS, STATUSES, PageHeader(), Pager() (+4 more)
...
Cohesion: 0.08
Nodes (25): SPRINT 0 — Quick Wins ✅ COMPLETE, SPRINT 10 — Mobile Bug Fixes (May 6, 2026 Session 2) ✅ COMPLETE, SPRINT 11 — Bug Fixes (May 6, 2026 Session 3) ✅ COMPLETE, SPRINT 12 — Rebrand Kompetix → Competzy (May 8, 2026 Session 4) ✅ COMPLETE, SPRINT 13 — Production Infra Templates (May 9, 2026 Session 5) ✅ LOCAL ARTIFACTS DONE, SPRINT 14 — Compliance & Security Hardening (May 8–9, 2026 Sessions 4–5) ✅ COMPLETE, SPRINT 15 — Launch 1 Polish (May 8, 2026 Session 4) ✅ COMPLETE, SPRINT 16 — School Portal Soft Launch (May 9, 2026 Session 5) ✅ COMPLETE (+17 more)

### Community 24 - "Payments Backend"
Cohesion: 0.1
Nodes (16): Radius, Shadow, Button, HEIGHT, PAD_H, Props, Size, styles (+8 more)
...
Cohesion: 0.18
Nodes (23): analytics, AuthContext (useUser), ChildrenScreen, CompetitionDetailArchive, CompetitionDetailPage, DiscoverScreen, competitions.service, favorites.service (+15 more)

### Community 28 - "Organizer Competition Forms"
Cohesion: 0.12
Nodes (11): INTEREST_CATEGORIES, InterestCategory, Surface, DOC_TYPES, Document, styles, formatDateForDisplay(), ProfileEditScreen() (+3 more)
...
Cohesion: 0.11
Nodes (11): authApi, queryClient, RootLayout(), NAV, AuthContext, AuthProvider(), Ctx, useAuth() (+3 more)
...
Cohesion: 0.2
Nodes (10): initializeCronJobs(), scheduleBulkJobProcessor(), scheduleCompetitionDayReminders(), scheduleDeadlineReminders(), scheduleDeadlineUrgencyReminders(), scheduleNotificationSender(), scheduleRetentionEnforcement(), expo (+2 more)
...
Cohesion: 0.15
Nodes (7): AuthContextType, RegistrationStatus, PAYER_OPTIONS, PayerKind, PaymentState, STATE_CONTENT, styles
...
Cohesion: 0.2
Nodes (8): metadata, AuthContext, AuthCtx, AuthProvider(), { Provider, useHook }, NAV, Sidebar(), ThemeProvider()
...
Cohesion: 0.24
Nodes (7): useOrganizer(), Competition, OrganizerDashboard(), RecentActivity, Stats, OrganizerLayoutInner(), OrganizerLogin()
...
Cohesion: 0.29
Nodes (5): OrganizerContext, OrganizerCtx, OrganizerProvider(), { Provider, useHook }, NAV
...
Cohesion: 0.33
Nodes (6): Current Task Status (as of May 13, 2026 — Session 10), EMC Port (begins 2026-05-13) — Wave 1 ✅ COMPLETE (4 phases shipped), EMC Port (begins 2026-05-13) — Wave 1 IN EXECUTION (4 phases), Manual rollout still required (Sprint 13/17 — needs your access), Manual rollout still required (Sprint 13/17 — needs your access), Manual rollout still required (Sprint 13/17 — needs your access)
...
## Knowledge Gaps
- **860 isolated node(s):** `{ defineConfig }`, `expoConfig`, `RegistrationStatus`, `AuthContextType`, `BulkJob` (+855 more)
...
- **Why does `AuthUser` connect `k6 Load Test` to `Admin Mobile Screens`, `School Auth Context`, `Cluster 74`, `Analytics & Competition Detail`, `Cluster 63`?**
  _High betweenness centrality (0.038) - this node is a cross-community bridge._
- **Why does `useAuth()` connect `Analytics & Competition Detail` to `Cluster 80`, `Express Bootstrap & Errors`, `Cluster 63`, `Cluster 55`?**
  _High betweenness centrality (0.035) - this node is a cross-community bridge._
- **Why does `AuthProvider()` connect `Analytics & Competition Detail` to `Cluster 55`?**
