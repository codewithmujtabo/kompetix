...
## Corpus Check
- 279 files · ~3,348,039 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2338 nodes · 4359 edges · 203 communities (129 shown, 74 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 72 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a93c3ee8`
...
Cohesion: 0.05
Nodes (67): CompetitionAdminLayout(), CompetitionAdminPage(), EmcAdminPage(), PendingRow, StatusFilter, adminHttp, emcHttp, schoolHttp (+59 more)
...
Cohesion: 0.08
Nodes (32): FILTERS, { Provider, useHook }, SchoolContext, SchoolCtx, schoolFetch(), schoolHttp, useSchool(), BulkRegistrationPage() (+24 more)
...
Cohesion: 0.07
Nodes (29): Kpi, LINKS, QUICK_LINKS, Activity, Competition, fmtRp(), OrganizerDashboardPage(), RecentActivity (+21 more)
...
Cohesion: 0.1
Nodes (28): CATEGORIES, CATS, CompetitionsPage(), Field(), FILTERS, fmtForInput(), FORM_DEFAULTS, CHECK_TYPE_LABEL (+20 more)
...
Cohesion: 0.05
Nodes (35): audit(), AuditOptions, REDACT_KEYS, organizerOnly(), compIdFilter, conditions, csv, csvRows (+27 more)
...
Cohesion: 0.1
Nodes (17): compFilter(), liveFilter(), SOFT_DELETE_TABLES, softDelete(), adminOnly(), CHECK_TYPES, CheckType, compId (+9 more)
...
Cohesion: 0.17
Nodes (13): competitionsApi, notificationsApi, schoolsApi, usersApi, PageHeader(), Pager(), Spinner(), Toast() (+5 more)
...
Cohesion: 0.12
Nodes (18): organizerHttp, AuthContext, AuthCtx, { Provider, useHook }, createRoleAuth(), Http, RoleAuthConfig, RoleAuthCtx (+10 more)
...
Cohesion: 0.13
Nodes (20): apiRequest(), create(), Document, list(), remove(), acceptInvitation(), approveLink(), DebugInvitation (+12 more)
...
Cohesion: 0.11
Nodes (18): useIsMobile(), AppShell(), AppShellProps, AppShellUser, initials(), NavItem, Separator(), SidebarContent() (+10 more)
...
Cohesion: 0.13
Nodes (10): BatchResult, BulkPaymentPage(), fmtRp(), RegistrationRow, Competition, STATUS_BADGE, STATUS_STYLE, SchoolPendingPage() (+2 more)
...
Cohesion: 0.11
Nodes (6): Slide, slides, styles, styles, Tab, styles

### Community 52 - "Mobile Payments Service"
Cohesion: 0.18
Nodes (10): FORM_DEFAULTS, Pager(), PagerProps, PageHeader(), Pager(), Spinner(), Toast(), ROLE_CLS (+2 more)
...
Cohesion: 0.27
Nodes (9): organizerAuthApi, organizerProfileApi, organizerRegistrationsApi, organizerRevenueApi, registrationsApi, Competition, Pagination, PendingRegistration (+1 more)
...
Cohesion: 0.18
Nodes (6): RequestOptions, School, SchoolSearchParams, SchoolSearchResponse, getProfile(), updateProfile()
...
Cohesion: 0.22
Nodes (7): useAuth(), NAV, Sidebar(), DashboardLayout(), NAV, Login(), NavSection
...
## Knowledge Gaps
- **945 isolated node(s):** `{ defineConfig }`, `expoConfig`, `RegistrationStatus`, `AuthContextType`, `BulkJob` (+940 more)
...
- **Why does `Button()` connect `Beyond Classroom PDF` to `Admin Mobile Screens`, `Mobile API Service Layer`, `Competitions CSV Seeder`, `Audit & Organizer Middleware`, `Web Auth Contexts`, `Mobile Theme System`, `Parent Routes & Email`, `Mobile Payments Service`, `Web API Index`, `Payments Backend`?**
  _High betweenness centrality (0.048) - this node is a cross-community bridge._
- **Why does `Card()` connect `Database Columns & Keys` to `Admin Mobile Screens`, `Mobile API Service Layer`, `Web Auth Contexts`, `Beyond Classroom PDF`, `Mobile Theme System`, `Historical Phone Login`, `Mobile Payments Service`, `Web API Index`, `Payments Backend`?**
  _High betweenness centrality (0.026) - this node is a cross-community bridge._
- **Why does `cn()` connect `Payments Backend` to `Admin Mobile Screens`, `Mobile API Service Layer`, `Database Columns & Keys`, `Competitions CSV Seeder`, `Audit & Organizer Middleware`, `Web Auth Contexts`, `Beyond Classroom PDF`, `Cluster 75`, `Mobile Theme System`, `Mobile Payments Service`, `Web API Index`, `Cluster 58`?**
