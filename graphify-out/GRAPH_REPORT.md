...
## Corpus Check
- 331 files · ~3,407,613 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2742 nodes · 5709 edges · 202 communities (129 shown, 73 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 94 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6e463be5`
...
3. `Card()` - 65 edges
4. `Button()` - 63 edges
5. `apiRequest()` - 59 edges
6. `PageHeader()` - 50 edges
7. `Sprint Plan (Full Roadmap)` - 44 edges
8. `Badge()` - 43 edges
9. `Brand` - 41 edges
10. `Skeleton()` - 41 edges
...
Cohesion: 0.05
Nodes (49): BulkJob, styles, styles, AuthTab, styles, AppInput(), AppInputProps, styles (+41 more)
...
Cohesion: 0.08
Nodes (30): FILTERS, schoolHttp, Competition, CsvRow, JobStatus, STEPS, ExamRow, QueueRow (+22 more)
...
Cohesion: 0.07
Nodes (32): CATEGORIES, CATS, CompetitionCard(), CompetitionsPage(), Field(), FILTERS, fmtDate(), fmtForInput() (+24 more)
...
Cohesion: 0.04
Nodes (45): code:block6 (T5 (reg_number) ──────────► T16 (mobile shows it)), Dependency Map, SPRINT 0 — Quick Wins ✅ COMPLETE, SPRINT 10 — Mobile Bug Fixes (May 6, 2026 Session 2) ✅ COMPLETE, SPRINT 11 — Bug Fixes (May 6, 2026 Session 3) ✅ COMPLETE, SPRINT 12 — Rebrand Kompetix → Competzy (May 8, 2026 Session 4) ✅ COMPLETE, SPRINT 13 — Production Infra Templates (May 9, 2026 Session 5) ✅ LOCAL ARTIFACTS DONE, SPRINT 14 — Compliance & Security Hardening (May 8–9, 2026 Sessions 4–5) ✅ COMPLETE (+37 more)

### Community 16 - "Web UI Components"
Cohesion: 0.09
Nodes (32): AnnouncementsPage(), ExamsListPage(), GradingQueuePage(), QuestionEditorPage(), MaterialsPage(), ExamLite, PaperExam, PaperExamsPage() (+24 more)
...
Cohesion: 0.09
Nodes (37): announcement(), area(), exam(), localToday(), main(), material(), product(), question() (+29 more)
...
Cohesion: 0.16
Nodes (20): CompetitionAdminLayout(), CompetitionAdminPage(), CompetitionAnnouncementsLayout(), CompetitionAnnouncementsPage(), { Provider, useHook }, competitionPaths(), competitionRegistry, defaultPortalConfig() (+12 more)
...
Cohesion: 0.09
Nodes (25): announcementRecipients(), announcementScopeIfAccessible(), assetUpload, bonus, code, compId, custom, id (+17 more)
...
Cohesion: 0.12
Nodes (18): EmcAdminPage(), PendingRow, StatusFilter, emcHttp, PortalCompetition, usePortalComp(), AccessInfo, AffiliatedCredential (+10 more)
...
Cohesion: 0.11
Nodes (11): questionMakerHttp, { Provider, useHook }, createRoleAuth(), Http, RoleAuthConfig, RoleAuthCtx, { Provider, useHook }, ExamResultPage() (+3 more)
...
Cohesion: 0.13
Nodes (7): formatDate(), MyRegistrationDetailsScreen(), styles, IoniconName, styles, TYPE_EMOJI, TYPE_ICON
...
Cohesion: 0.19
Nodes (7): BatchResult, RegistrationRow, CatalogCompetition, CompetitionStudent, TeacherCompetition, Badge(), badgeVariants
...
Cohesion: 0.33
Nodes (5): Order, OrderItem, OrdersPage(), rupiah(), TABS
...
Cohesion: 0.4
Nodes (4): metadata, AuthProvider(), ThemeProvider(), Toaster()
...
Cohesion: 0.67
Nodes (3): Announcement, AnnouncementCard(), fmtDate()
...
## Knowledge Gaps
- **1130 isolated node(s):** `{ defineConfig }`, `expoConfig`, `RegistrationStatus`, `AuthContextType`, `BulkJob` (+1125 more)
...
- **Why does `Button()` connect `School Auth Context` to `Admin Mobile Screens`, `Database Columns & Keys`, `Admin / Audit Middleware`, `Web API Client`, `Web UI Components`, `Web Competitions Page`, `Payments Backend`, `Analytics & Competition Detail`, `Express Bootstrap & Errors`, `Competitions Routes & Recs`, `CLAUDE.md Concepts`, `Reset Project Script`, `Cluster 68`, `Cluster 82`, `Cluster 83`, `Cluster 91`, `Cluster 96`, `Cluster 103`, `Cluster 106`?**
  _High betweenness centrality (0.075) - this node is a cross-community bridge._
- **Why does `cn()` connect `Express Bootstrap & Errors` to `School Auth Context`, `Database Columns & Keys`, `Cluster 68`, `Admin / Audit Middleware`, `Cluster 103`, `Competitions Routes & Recs`, `Audit & Organizer Middleware`, `Web API Client`, `Web UI Components`, `Cluster 80`, `Cluster 81`, `Web Competitions Page`, `Cluster 83`, `Reset Project Script`, `Legacy Vite/Express Stack`, `Cluster 61`?**
  _High betweenness centrality (0.028) - this node is a cross-community bridge._
- **Why does `Card()` connect `Web UI Components` to `Admin Mobile Screens`, `School Auth Context`, `Database Columns & Keys`, `Admin / Audit Middleware`, `Web API Client`, `Legacy Vite/Express Stack`, `Payments Backend`, `Analytics & Competition Detail`, `Express Bootstrap & Errors`, `Competitions CSV Seeder`, `Audit & Organizer Middleware`, `CLAUDE.md Concepts`, `Cluster 68`, `Cluster 82`, `Cluster 83`, `Cluster 91`, `Cluster 96`, `Cluster 103`, `Cluster 106`?**
