...
## Corpus Check
- 312 files · ~3,388,701 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2628 nodes · 5268 edges · 198 communities (125 shown, 73 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 81 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `80f44999`
...
Cohesion: 0.07
Nodes (53): FILTERS, commerceHttp, { Provider, useHook }, ExamRow, ExamsListPage(), GradingQueuePage(), QueueRow, QuestionEditorPage() (+45 more)
...
Cohesion: 0.05
Nodes (38): styles, Elevation, Fonts, Motion, Shadow, Spacing, SubjectColors, Text (+30 more)

### Community 3 - "Web Admin Layout"
Cohesion: 0.04
Nodes (46): compFilter(), liveFilter(), SOFT_DELETE_TABLES, softDelete(), audit(), AuditOptions, REDACT_KEYS, CHECK_TYPES (+38 more)
...
Cohesion: 0.04
Nodes (53): requireRole(), base, codes, compId, discounted, id, imageUpload, { limit, offset, page } (+45 more)
...
Cohesion: 0.08
Nodes (32): defaultCompetition, destinationFor(), goTo(), Mode, ROLES, ExamEditorPage(), ExamQuestion, GRADE_OPTIONS (+24 more)
...
Cohesion: 0.08
Nodes (32): CATEGORIES, CATS, CompetitionsPage(), Field(), FILTERS, fmtForInput(), FORM_DEFAULTS, CHECK_TYPE_LABEL (+24 more)
...
Cohesion: 0.07
Nodes (36): adminHttp, Competition, CompetitionDetailPage(), fmtDate(), fmtRp(), formatCurrency(), ReviewQuestionPage(), STATUS_BADGE (+28 more)
...
Cohesion: 0.08
Nodes (32): questionBankHttp, CATEGORIES, CompetitionFormProps, DEFAULTS, GRADE_LEVELS, STATUSES, Answer, COGNITIVE (+24 more)
...
Cohesion: 0.05
Nodes (35): adminOnly(), organizerOnly(), compId, compIdFilter, conditions, csv, csvRows, data (+27 more)
...
Cohesion: 0.1
Nodes (16): CatalogCompetition, CompetitionCard(), fmtDate(), ACTIONABLE, ACTIONABLE_STATUSES, Competition, Credential, Registration (+8 more)

### Community 32 - "Web Auth API"
Cohesion: 0.18
Nodes (17): http, req(), token(), notificationsApi, organizerAuthApi, organizerProfileApi, organizerRegistrationsApi, organizerRevenueApi (+9 more)
...
Cohesion: 0.12
Nodes (13): AuthTab, styles, AppInput(), AppInputProps, styles, INTEREST_CATEGORIES, InterestCategory, FontFamily (+5 more)
...
Cohesion: 0.25
Nodes (11): CompetitionAdminPage(), EmcAdminPage(), PendingRow, StatusFilter, emcHttp, PortalCompetition, usePortalComp(), EmcDashboardPage() (+3 more)
...
Cohesion: 0.36
Nodes (8): CompetitionAdminLayout(), competitionPaths(), competitionRegistry, defaultPortalConfig(), getCompetitionConfig(), CompetitionDashboardLayout(), CompetitionDashboardPage(), CompetitionExamLayout()
...
## Knowledge Gaps
- **1086 isolated node(s):** `{ defineConfig }`, `expoConfig`, `RegistrationStatus`, `AuthContextType`, `BulkJob` (+1081 more)
...
- **Why does `Button()` connect `Web Auth Contexts` to `Admin Mobile Screens`, `Mobile API Service Layer`, `Cluster 99`, `Admin / Audit Middleware`, `Cluster 71`, `Auth & Twilio OTP`, `Mobile App Bootstrap`, `Parent Routes & Email`, `Mobile Registrations Service`, `Web API Index`, `Cluster 58`, `Auth Login & Profile Setup`?**
  _High betweenness centrality (0.064) - this node is a cross-community bridge._
- **Why does `Card()` connect `Mobile App Bootstrap` to `Admin Mobile Screens`, `Mobile API Service Layer`, `Cluster 99`, `Admin / Audit Middleware`, `Web Auth Contexts`, `Cluster 71`, `Auth & Twilio OTP`, `Historical Phone Login`, `Parent Routes & Email`, `Auth Login & Profile Setup`?**
  _High betweenness centrality (0.028) - this node is a cross-community bridge._
- **Why does `cn()` connect `Mobile App Bootstrap` to `Admin Mobile Screens`, `Admin / Audit Middleware`, `Web Auth Contexts`, `Auth & Twilio OTP`, `Historical Phone Login`, `Parent Routes & Email`, `Cluster 80`, `Cluster 81`, `Cluster 79`, `Web API Index`, `Cluster 89`, `Cluster 57`, `Auth Login & Profile Setup`?**
