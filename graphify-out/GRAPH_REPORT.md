...
## Corpus Check
- 276 files · ~3,345,533 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2313 nodes · 4308 edges · 200 communities (126 shown, 74 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 72 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `07172a75`
...
Cohesion: 0.05
Nodes (70): CompetitionAdminLayout(), CompetitionAdminPage(), EmcAdminPage(), PendingRow, StatusFilter, adminHttp, emcHttp, metadata (+62 more)

### Community 1 - "School Auth Context"
Cohesion: 0.08
Nodes (35): competitionsApi, notificationsApi, CATEGORIES, CATS, CompetitionsPage(), Field(), FILTERS, fmtForInput() (+27 more)

### Community 2 - "Mobile API Service Layer"
Cohesion: 0.06
Nodes (31): pool, ACCOUNTS, main(), normalizePhone(), authMiddleware(), Request, fileContent, parsed (+23 more)
...
Cohesion: 0.07
Nodes (26): http, req(), token(), authApi, schoolsApi, NAV, PageHeader(), Pager() (+18 more)
...
Cohesion: 0.08
Nodes (18): BulkJob, styles, HapticTab(), NotificationTabIcon(), NotificationTabIconProps, styles, Round, styles (+10 more)

### Community 14 - "Registrations Routes"
Cohesion: 0.12
Nodes (20): FILTERS, Competition, STATUS_BADGE, STATUS_STYLE, fmt(), fmtRp(), Revenue(), RevenueData (+12 more)
...
Cohesion: 0.07
Nodes (23): organizerHttp, organizerAuthApi, organizerCompetitionsApi, organizerProfileApi, organizerRegistrationsApi, organizerRevenueApi, registrationsApi, usersApi (+15 more)

### Community 17 - "Concept / Rationale Nodes"
Cohesion: 0.1
Nodes (18): ACTIONABLE, ACTIONABLE_STATUSES, Competition, Registration, STATUS_CLS, STATUS_STYLE, STATUS_CLS, STATUS_STYLE (+10 more)
...
Cohesion: 0.09
Nodes (20): Spacing, Text, Type, styles, HEIGHT, PAD_H, Props, Size (+12 more)
...
Cohesion: 0.09
Nodes (19): navTheme, queryClient, RootLayout(), Surface, AuthContextType, AuthProvider(), RegistrationStatus, CompetitionStudent (+11 more)
...
Cohesion: 0.12
Nodes (21): childrenMap, expiresAt, normalizedEmail, params, pin, router, smtpReady, studentColumns (+13 more)
...
Cohesion: 0.11
Nodes (10): Slide, slides, styles, IoniconName, PAYER_OPTIONS, PayerKind, PaymentState, STATE_CONTENT (+2 more)
...
Cohesion: 0.11
Nodes (9): Registration, School, Student, styles, Shadow, styles, Tab, Props (+1 more)

### Community 45 - "Historical Phone Login"
Cohesion: 0.15
Nodes (15): Elevation, Fonts, Motion, Radius, subjectColorFor(), SubjectColors, GeometricHeader, GeometricHeaderImpl() (+7 more)
...
Cohesion: 0.24
Nodes (7): PageHeader(), Pager(), Spinner(), Toast(), ROLE_CLS, ROLE_STYLE, ROLES
...
## Knowledge Gaps
- **927 isolated node(s):** `{ defineConfig }`, `expoConfig`, `RegistrationStatus`, `AuthContextType`, `BulkJob` (+922 more)
...
- **Why does `Button()` connect `School Auth Context` to `Admin Mobile Screens`, `Cluster 66`, `Web Admin Layout`, `Registrations Routes`, `Parent Routes & Email`, `Web UI Components`, `Concept / Rationale Nodes`, `Mobile Doc & User Services`, `Legacy Vite/Express Stack`, `School Admin Routes`?**
  _High betweenness centrality (0.052) - this node is a cross-community bridge._
- **Why does `Card()` connect `Web Admin Layout` to `Admin Mobile Screens`, `School Auth Context`, `Cluster 66`, `CLAUDE.md Concepts`, `Registrations Routes`, `Web UI Components`, `Concept / Rationale Nodes`, `Mobile Doc & User Services`, `School Admin Routes`?**
  _High betweenness centrality (0.024) - this node is a cross-community bridge._
- **Why does `cn()` connect `School Admin Routes` to `Admin Mobile Screens`, `School Auth Context`, `Cluster 66`, `Web Admin Layout`, `Cluster 98`, `Cluster 71`, `Registrations Routes`, `Parent Routes & Email`, `Web UI Components`, `Concept / Rationale Nodes`, `Mobile Doc & User Services`, `Reset Project Script`, `Cluster 61`?**
