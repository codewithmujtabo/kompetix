...
## Summary
- 2286 nodes · 4195 edges · 197 communities (123 shown, 74 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 72 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `10f8cd00`
...
Cohesion: 0.1
Nodes (21): CATEGORIES, CompetitionFormProps, CompetitionFormValues, DEFAULTS, GRADE_LEVELS, STATUSES, TYPES, Competition (+13 more)

### Community 11 - "Auth & Twilio OTP"
Cohesion: 0.09
Nodes (22): CATEGORIES, CATS, FILTERS, FORM_DEFAULTS, STATUS_CLS, STATUS_STYLE, StatusBadge(), STATUSES (+14 more)
...
Cohesion: 0.07
Nodes (19): navTheme, queryClient, RootLayout(), Surface, AuthContextType, AuthProvider(), Registration, RegistrationStatus (+11 more)

### Community 17 - "Concept / Rationale Nodes"
Cohesion: 0.08
Nodes (23): Activity, Competition, fmtRp(), OrganizerDashboardPage(), RecentActivity, Stats, ADMIN_QUICK, ADMIN_QUICK_LINKS (+15 more)
...
Cohesion: 0.09
Nodes (22): { Provider, useHook }, SchoolContext, SchoolCtx, schoolFetch(), useSchool(), BatchResult, BulkPaymentPage(), fmtRp() (+14 more)

### Community 22 - "Web API Index"
Cohesion: 0.07
Nodes (14): Shadow, Slide, slides, styles, styles, Tab, MenuItem, ROLE_EMOJI (+6 more)
...
Cohesion: 0.09
Nodes (21): Radius, subjectColorFor(), Type, HEIGHT, PAD_H, Props, Size, styles (+13 more)

### Community 26 - "Documents Backend"
Cohesion: 0.11
Nodes (16): ACTIONABLE, ACTIONABLE_STATUSES, Competition, Registration, STATUS_CLS, STATUS_STYLE, FORM_DEFAULTS, PendingSchool (+8 more)
...
Cohesion: 0.1
Nodes (13): INTEREST_CATEGORIES, InterestCategory, Spacing, DOC_TYPES, Document, IoniconName, styles, formatDateForDisplay() (+5 more)
...
Cohesion: 0.12
Nodes (22): Sidebar(), SidebarContext, SidebarContextProps, SidebarGroupAction(), SidebarGroupLabel(), SidebarInput(), SidebarMenuAction(), SidebarMenuBadge() (+14 more)
...
- **Why does `Button()` connect `Web API Client` to `Admin Mobile Screens`, `Web Auth API`, `Auth & Twilio OTP`, `Historical Phone Login`, `Registrations Routes`, `Parent Routes & Email`, `Legacy Vite/Express Stack`, `Document Vault Flow`, `Documents Backend`, `Analytics & Competition Detail`?**
  _High betweenness centrality (0.048) - this node is a cross-community bridge._
- **Why does `cn()` connect `Analytics & Competition Detail` to `Admin Mobile Screens`, `Web Auth API`, `Cluster 73`, `Web API Client`, `Auth & Twilio OTP`, `Historical Phone Login`, `Registrations Routes`, `Parent Routes & Email`, `Concept / Rationale Nodes`, `Reset Project Script`, `Legacy Vite/Express Stack`, `Documents Backend`?**
  _High betweenness centrality (0.025) - this node is a cross-community bridge._
- **Why does `Card()` connect `Concept / Rationale Nodes` to `Admin Mobile Screens`, `School Auth Context`, `Web API Client`, `Auth & Twilio OTP`, `Registrations Routes`, `Parent Routes & Email`, `Legacy Vite/Express Stack`, `Web API Index`, `Documents Backend`, `Analytics & Competition Detail`?**
