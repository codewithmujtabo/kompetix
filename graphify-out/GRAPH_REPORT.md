...
## Corpus Check
- 273 files · ~3,343,613 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2259 nodes · 3931 edges · 195 communities (121 shown, 74 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 72 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `91cbbd8f`
...
7. `Radius` - 29 edges
8. `Type` - 29 edges
9. `🏆 Beyond Classroom - K-12 Competition Hub for Indonesia` - 29 edges
10. `Text` - 28 edges
...
Cohesion: 0.05
Nodes (71): useIsMobile(), cn(), StatusBadge(), AppShell(), AppShellProps, AppShellUser, initials(), NavItem (+63 more)

### Community 2 - "Mobile API Service Layer"
Cohesion: 0.07
Nodes (39): Competition, STATUS_BADGE, STATUS_STYLE, ACTIONABLE, ACTIONABLE_STATUSES, Competition, Registration, STATUS_CLS (+31 more)

### Community 3 - "Web Admin Layout"
Cohesion: 0.05
Nodes (38): schoolHttp, { Provider, useHook }, SchoolContext, SchoolCtx, schoolFetch(), schoolHttp, SchoolProvider(), useSchool() (+30 more)

### Community 4 - "Database Columns & Keys"
Cohesion: 0.07
Nodes (31): CATEGORIES, CATS, FILTERS, FORM_DEFAULTS, CATEGORIES, CompetitionFormProps, DEFAULTS, GRADE_LEVELS (+23 more)
...
Cohesion: 0.07
Nodes (22): BulkJob, styles, Shadow, Spacing, Text, Type, styles, Tab (+14 more)
...
Cohesion: 0.07
Nodes (23): CATEGORY_EMOJIS, CompetitionDetailPage(), formatDate(), formatPrice(), STATUS_PILL, STATUS_PILL_CFG, styles, CategoryAccent (+15 more)

### Community 14 - "Registrations Routes"
Cohesion: 0.08
Nodes (23): Kpi, LINKS, QUICK_LINKS, Activity, Competition, fmtRp(), OrganizerDashboardPage(), RecentActivity (+15 more)

### Community 15 - "Parent Routes & Email"
Cohesion: 0.08
Nodes (17): Registration, School, Student, styles, HapticTab(), NotificationTabIcon(), NotificationTabIconProps, styles (+9 more)
...
Cohesion: 0.09
Nodes (21): authMiddleware(), Request, cached, competitions, conditions, now, recommendationsCache, router (+13 more)
...
Cohesion: 0.1
Nodes (13): INTEREST_CATEGORIES, InterestCategory, Surface, DOC_TYPES, Document, styles, formatDateForDisplay(), ProfileEditScreen() (+5 more)
...
Cohesion: 0.09
Nodes (11): AuthContextType, RegistrationStatus, PAYER_OPTIONS, PayerKind, PaymentState, STATE_CONTENT, styles, IoniconName (+3 more)
...
Cohesion: 0.1
Nodes (17): errorHandler(), HttpError, fileContent, parsed, router, upload, Province, provinces (+9 more)
...
Cohesion: 0.23
Nodes (14): notificationsApi, organizerAuthApi, organizerProfileApi, organizerRegistrationsApi, organizerRevenueApi, registrationsApi, schoolsApi, usersApi (+6 more)
...
Cohesion: 0.17
Nodes (9): competitionsApi, PageHeader(), Pager(), Spinner(), Toast(), CATS, EMPTY_FORM, ROLE_CLS (+1 more)
...
Cohesion: 0.17
Nodes (6): Slide, slides, styles, formatDate(), MyRegistrationDetailsScreen(), styles
...
Cohesion: 0.24
Nodes (9): initializeCronJobs(), scheduleBulkJobProcessor(), scheduleCompetitionDayReminders(), scheduleDeadlineReminders(), scheduleDeadlineUrgencyReminders(), scheduleNotificationSender(), scheduleRetentionEnforcement(), getRecommendations() (+1 more)
...
## Knowledge Gaps
- **898 isolated node(s):** `{ defineConfig }`, `expoConfig`, `RegistrationStatus`, `AuthContextType`, `BulkJob` (+893 more)
...
- **Why does `Button()` connect `Mobile API Service Layer` to `School Auth Context`, `Web API Client`, `Database Columns & Keys`, `Legacy Vite/Express Stack`?**
  _High betweenness centrality (0.044) - this node is a cross-community bridge._
- **Why does `cn()` connect `School Auth Context` to `Mobile API Service Layer`, `Database Columns & Keys`, `Legacy Vite/Express Stack`, `Registrations Routes`?**
  _High betweenness centrality (0.021) - this node is a cross-community bridge._
- **Why does `Card()` connect `Registrations Routes` to `School Auth Context`, `Mobile API Service Layer`, `Database Columns & Keys`, `Legacy Vite/Express Stack`, `Documents Backend`?**
