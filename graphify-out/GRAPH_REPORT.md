...
## Corpus Check
- 334 files · ~3,409,175 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2755 nodes · 5756 edges · 203 communities (129 shown, 74 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 94 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `fb5b2f6e`
...
7. `getCompetitionConfig()` - 45 edges
8. `Sprint Plan (Full Roadmap)` - 45 edges
9. `Badge()` - 44 edges
10. `competitionPaths()` - 43 edges
...
Cohesion: 0.04
Nodes (52): styles, AuthTab, styles, AppInput(), AppInputProps, styles, Brand, Elevation (+44 more)

### Community 1 - "School Auth Context"
Cohesion: 0.08
Nodes (47): FILTERS, DEFAULTS, commerceHttp, marketingHttp, DEFAULTS, GRADES, Order, OrderItem (+39 more)
...
Cohesion: 0.07
Nodes (39): AnnouncementsPage(), questionBankHttp, { Provider, useHook }, ExamRow, ExamsListPage(), GradingQueuePage(), QueueRow, ExamEditorPage() (+31 more)

### Community 5 - "Backend DB Bootstrap"
Cohesion: 0.07
Nodes (46): CATEGORIES, CompetitionFormProps, DEFAULTS, GRADE_LEVELS, STATUSES, CHECK_TYPE_LABEL, CHECK_TYPE_OPTIONS, CheckType (+38 more)

### Community 6 - "Admin / Audit Middleware"
Cohesion: 0.05
Nodes (33): pool, ACCOUNTS, main(), normalizePhone(), SOFT_DELETE_TABLES, authMiddleware(), Request, bulkUploadLimiter (+25 more)
...
Cohesion: 0.04
Nodes (46): code:block6 (T5 (reg_number) ──────────► T16 (mobile shows it)), Dependency Map, SPRINT 0 — Quick Wins ✅ COMPLETE, SPRINT 10 — Mobile Bug Fixes (May 6, 2026 Session 2) ✅ COMPLETE, SPRINT 11 — Bug Fixes (May 6, 2026 Session 3) ✅ COMPLETE, SPRINT 12 — Rebrand Kompetix → Competzy (May 8, 2026 Session 4) ✅ COMPLETE, SPRINT 13 — Production Infra Templates (May 9, 2026 Session 5) ✅ LOCAL ARTIFACTS DONE, SPRINT 14 — Compliance & Security Hardening (May 8–9, 2026 Sessions 4–5) ✅ COMPLETE (+38 more)
...
Cohesion: 0.06
Nodes (32): compFilter(), liveFilter(), softDelete(), requireRole(), loadFlow(), compId, hasCompAccess(), id (+24 more)
...
Cohesion: 0.1
Nodes (25): BatchResult, RegistrationRow, CatalogCompetition, CompetitionCard(), fmtDate(), ExamResultPage(), Section, SessionResult (+17 more)
...
Cohesion: 0.1
Nodes (23): CATEGORIES, CATS, CompetitionsPage(), Field(), FILTERS, fmtForInput(), FORM_DEFAULTS, TYPES (+15 more)

### Community 22 - "Web API Index"
Cohesion: 0.11
Nodes (18): CompetitionAdminPage(), EmcAdminPage(), PendingRow, StatusFilter, Announcement, AnnouncementCard(), CompetitionAnnouncementsPage(), fmtDate() (+10 more)
...
Cohesion: 0.07
Nodes (29): schoolHttp, { Provider, useHook }, SchoolContext, SchoolCtx, schoolFetch(), SchoolProvider(), useSchool(), BulkPaymentPage() (+21 more)
...
Cohesion: 0.07
Nodes (26): schoolHttp, BulkRegistrationPage(), Competition, CsvRow, JobStatus, STEPS, cn(), Deadline (+18 more)
...
Cohesion: 0.07
Nodes (30): productCompIfAccessible(), voucherGroupCompIfAccessible(), ansByQ, byNumber, chosen, CLEARED_REG, compId, correctPt (+22 more)

### Community 29 - "School Admin Routes"
Cohesion: 0.06
Nodes (26): CHECK_TYPES, CheckType, compId, FlowStep, router, sets, steps, values (+18 more)
...
Cohesion: 0.19
Nodes (17): authApi, notificationsApi, organizerAuthApi, organizerProfileApi, organizerRegistrationsApi, organizerRevenueApi, registrationsApi, schoolsApi (+9 more)
...
Cohesion: 0.11
Nodes (10): navTheme, queryClient, RootLayout(), AuthContextType, AuthProvider(), RegistrationStatus, DOC_TYPES, Document (+2 more)

### Community 47 - "Admin API Methods"
Cohesion: 0.13
Nodes (19): Sidebar(), SidebarContent(), SidebarContext, SidebarContextProps, SidebarFooter(), SidebarGroupAction(), SidebarGroupContent(), SidebarInput() (+11 more)
...
Cohesion: 0.14
Nodes (14): Radius, subjectColorFor(), formatDate(), MyRegistrationDetailsScreen(), styles, GeometricHeader, GeometricHeaderImpl(), Palette (+6 more)
...
Cohesion: 0.14
Nodes (13): useIsMobile(), AppShellProps, AppShellUser, NavItem, Separator(), SidebarGroup(), SidebarGroupLabel(), SidebarHeader() (+5 more)
...
Cohesion: 0.18
Nodes (7): Competition, get(), ListParams, mapRow(), trackView(), Round, styles

### Community 72 - "Cluster 72"
Cohesion: 0.2
Nodes (8): fmt(), fmtRp(), Revenue(), RevenueData, RevenuePage(), ACCENT, StatAccent, StatCardProps
...
## Knowledge Gaps
- **1135 isolated node(s):** `{ defineConfig }`, `expoConfig`, `RegistrationStatus`, `AuthContextType`, `BulkJob` (+1130 more)
...
- **Why does `Button()` connect `Web Competitions Page` to `Admin Mobile Screens`, `School Auth Context`, `Cluster 99`, `Database Columns & Keys`, `Backend DB Bootstrap`, `Cluster 58`, `Cluster 76`, `Admin API Methods`, `Web UI Components`, `Cluster 81`, `Cluster 82`, `Legacy Vite/Express Stack`, `Web API Index`, `Cluster 86`, `Documents Backend`, `Parent Linking Flow`, `Cluster 60`?**
  _High betweenness centrality (0.063) - this node is a cross-community bridge._
- **Why does `cn()` connect `Documents Backend` to `School Auth Context`, `Database Columns & Keys`, `Backend DB Bootstrap`, `Web UI Components`, `Web Competitions Page`, `Legacy Vite/Express Stack`, `Payments Backend`, `Competitions CSV Seeder`, `Admin API Methods`, `Cluster 58`, `Cluster 61`, `Cluster 72`, `Cluster 76`, `Cluster 77`, `Cluster 78`, `Cluster 79`, `Cluster 81`, `Cluster 86`, `Cluster 94`?**
  _High betweenness centrality (0.032) - this node is a cross-community bridge._
- **Why does `Card()` connect `Web Competitions Page` to `Admin Mobile Screens`, `School Auth Context`, `Cluster 99`, `Database Columns & Keys`, `Backend DB Bootstrap`, `Competitions CSV Seeder`, `Mobile Admin Service`, `Cluster 72`, `Cluster 76`, `Cluster 81`, `Cluster 82`, `Legacy Vite/Express Stack`, `Web API Index`, `Cluster 86`, `Payments Backend`, `Documents Backend`, `Parent Linking Flow`, `Cluster 60`?**
