...
## Corpus Check
- 234 files · ~3,332,381 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2010 nodes · 3066 edges · 199 communities (124 shown, 75 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 70 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `27b98b4f`
...
## Communities (199 total, 75 thin omitted)
...
Cohesion: 0.07
Nodes (28): HapticTab(), NotificationTabIcon(), NotificationTabIconProps, styles, approveRegistration(), CompetitionFormData, CompetitionRound, createCompetition() (+20 more)
...
Cohesion: 0.09
Nodes (14): INTEREST_CATEGORIES, InterestCategory, Text, DOC_TYPES, Document, styles, formatDateForDisplay(), ProfileEditScreen() (+6 more)
...
Cohesion: 0.14
Nodes (11): registrationsApi, CATS, FORM_DEFAULTS, STATUS_CLS, STATUSES, PageHeader(), Pager(), Spinner() (+3 more)
...
Cohesion: 0.09
Nodes (23): SPRINT 0 — Quick Wins ✅ COMPLETE, SPRINT 10 — Mobile Bug Fixes (May 6, 2026 Session 2) ✅ COMPLETE, SPRINT 11 — Bug Fixes (May 6, 2026 Session 3) ✅ COMPLETE, SPRINT 12 — Rebrand Kompetix → Competzy (May 8, 2026 Session 4) ✅ COMPLETE, SPRINT 13 — Production Infra Templates (May 9, 2026 Session 5) ✅ LOCAL ARTIFACTS DONE, SPRINT 14 — Compliance & Security Hardening (May 8–9, 2026 Sessions 4–5) ✅ COMPLETE, SPRINT 15 — Launch 1 Polish (May 8, 2026 Session 4) ✅ COMPLETE, SPRINT 16 — School Portal Soft Launch (May 9, 2026 Session 5) ✅ COMPLETE (+15 more)
...
Cohesion: 0.13
Nodes (13): BulkJob, styles, Spacing, Type, formatDate(), MyRegistrationDetailsScreen(), styles, Pill (+5 more)
...
Cohesion: 0.12
Nodes (11): competitionsApi, notificationsApi, organizerAuthApi, organizerCompetitionsApi, organizerProfileApi, organizerRegistrationsApi, organizerRevenueApi, CATEGORIES (+3 more)

### Community 36 - "Mobile Tabs Misc"
Cohesion: 0.14
Nodes (10): styles, AuthTab, styles, AppInput(), AppInputProps, styles, Brand, styles (+2 more)

### Community 37 - "Competitions CSV Seeder"
Cohesion: 0.21
Nodes (12): Mode, ROLES, ArrowRightIcon(), base, EyeIcon(), EyeOffIcon(), LockIcon(), MailIcon() (+4 more)

### Community 38 - "Audit & Organizer Middleware"
Cohesion: 0.11
Nodes (9): queryClient, RootLayout(), NAV, Sidebar(), AuthProvider(), useAuth(), DashboardLayout(), Login() (+1 more)
...
Cohesion: 0.12
Nodes (12): Shadow, Button, HEIGHT, PAD_H, Props, Size, styles, Variant (+4 more)

### Community 43 - "Auth Register Screen"
Cohesion: 0.16
Nodes (4): pool, env, main(), normalizePhone()
...
Cohesion: 0.15
Nodes (10): AuthContext, AuthCtx, { Provider, useHook }, useAuth(), { Provider, useHook }, createRoleAuth(), Http, RoleAuthConfig (+2 more)
...
Cohesion: 0.17
Nodes (12): metadata, RoleSelector(), UnifiedLogin(), AuthProvider(), ThemeToggle(), ForgotPasswordPage(), ResetPasswordInner(), Theme (+4 more)
...
Cohesion: 0.17
Nodes (10): Registration, School, Student, styles, Radius, GeometricHeader, GeometricHeaderImpl(), Palette (+2 more)
...
Cohesion: 0.37
Nodes (8): authApi, Ctx, AuthUser, Competition, Pagination, PendingRegistration, School, User
...
Cohesion: 0.18
Nodes (7): Surface, acceptInvitation(), getMyChildren(), styles, Card, Props, Variant
...
Cohesion: 0.25
Nodes (7): code:block1 (competzy/), Competzy — Claude Project Brief, Known Issues / Quirks, Monorepo Structure, Rules — Always Follow, Session Workflow, Tech Stack
...
Cohesion: 0.29
Nodes (5): MenuItem, ROLE_EMOJI, ROLE_ICON, ROLE_LABEL, styles
...
Cohesion: 0.33
Nodes (4): Dashboard(), fmtRp(), Kpi, LINKS
...
Cohesion: 0.5
Nodes (4): code:bash (# From each subdirectory:), code:block3 (BACKEND_URL=http://localhost:3000), code:block4 (EXPO_PUBLIC_API_URL=http://<MAC_LAN_IP>:3000/api), How to Run
...
## Knowledge Gaps
- **858 isolated node(s):** `{ defineConfig }`, `expoConfig`, `RegistrationStatus`, `AuthContextType`, `BulkJob` (+853 more)
...
- **Why does `AuthUser` connect `Cluster 62` to `Admin Mobile Screens`, `Mobile Admin Service`, `Competitions CSV Seeder`, `Auth & Twilio OTP`, `Push Notifications`?**
  _High betweenness centrality (0.032) - this node is a cross-community bridge._
- **Why does `useAuth()` connect `Audit & Organizer Middleware` to `Web Auth API`, `Organizer Competition Forms`, `Cluster 62`, `Cluster 87`?**
  _High betweenness centrality (0.031) - this node is a cross-community bridge._
- **Why does `AuthProvider()` connect `Audit & Organizer Middleware` to `Web Auth API`, `Cluster 62`?**
