...
## Corpus Check
- 309 files · ~3,383,558 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2590 nodes · 5137 edges · 205 communities (132 shown, 73 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 78 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7259e38a`
...
4. `Card()` - 53 edges
5. `Button()` - 51 edges
6. `PageHeader()` - 44 edges
7. `Brand` - 41 edges
8. `Sprint Plan (Full Roadmap)` - 41 edges
9. `pool` - 39 edges
10. `Badge()` - 35 edges
...
## Communities (205 total, 73 thin omitted)

### Community 0 - "Admin Mobile Screens"
Cohesion: 0.06
Nodes (56): questionBankHttp, { Provider, useHook }, CATEGORIES, CompetitionFormProps, DEFAULTS, GRADE_LEVELS, STATUSES, CHECK_TYPE_LABEL (+48 more)

### Community 1 - "School Auth Context"
Cohesion: 0.07
Nodes (38): CATEGORIES, CATS, CompetitionsPage(), Field(), FILTERS, fmtForInput(), FORM_DEFAULTS, FlowEditorDialog() (+30 more)
...
Cohesion: 0.04
Nodes (45): compFilter(), liveFilter(), SOFT_DELETE_TABLES, softDelete(), adminOnly(), requireRole(), CHECK_TYPES, CheckType (+37 more)

### Community 4 - "Database Columns & Keys"
Cohesion: 0.07
Nodes (40): Activity, Competition, fmtRp(), OrganizerDashboardPage(), RecentActivity, Stats, CompetitionPicker(), QuestionBankDashboard() (+32 more)

### Community 5 - "Backend DB Bootstrap"
Cohesion: 0.04
Nodes (50): ansByQ, byNumber, chosen, CLEARED_REG, compId, correctPt, examCompIfAccessible(), examId (+42 more)
...
Cohesion: 0.1
Nodes (25): FILTERS, schoolHttp, ExamRow, ExamsListPage(), GradingQueuePage(), QueueRow, Competition, STATUS_BADGE (+17 more)
...
Cohesion: 0.05
Nodes (42): code:block6 (T5 (reg_number) ──────────► T16 (mobile shows it)), Dependency Map, SPRINT 0 — Quick Wins ✅ COMPLETE, SPRINT 10 — Mobile Bug Fixes (May 6, 2026 Session 2) ✅ COMPLETE, SPRINT 11 — Bug Fixes (May 6, 2026 Session 3) ✅ COMPLETE, SPRINT 12 — Rebrand Kompetix → Competzy (May 8, 2026 Session 4) ✅ COMPLETE, SPRINT 13 — Production Infra Templates (May 9, 2026 Session 5) ✅ LOCAL ARTIFACTS DONE, SPRINT 14 — Compliance & Security Hardening (May 8–9, 2026 Sessions 4–5) ✅ COMPLETE (+34 more)
...
Cohesion: 0.06
Nodes (26): schoolHttp, { Provider, useHook }, SchoolContext, SchoolCtx, schoolFetch(), useSchool(), BatchResult, BulkPaymentPage() (+18 more)
...
Cohesion: 0.06
Nodes (31): schoolAdminOnly(), actorRole, expectedSig, linkedIds, orderId, redirectToken, registrationId, { registrationId, payerKind, payerUserId } (+23 more)

### Community 21 - "Legacy Vite/Express Stack"
Cohesion: 0.08
Nodes (29): QuestionEditorPage(), ReviewQuestionPage(), cn(), StatusBadge(), SchoolPendingPage(), ExamPlayerPage(), fmt(), Avatar() (+21 more)

### Community 22 - "Web API Index"
Cohesion: 0.11
Nodes (29): area(), exam(), localToday(), main(), question(), SeedQuestion, subject(), subtopic() (+21 more)
...
Cohesion: 0.09
Nodes (20): ExamEditorPage(), ExamQuestion, GRADE_OPTIONS, LoadedExam, ExamResultPage(), Section, SessionResult, sum() (+12 more)
...
Cohesion: 0.1
Nodes (13): Spacing, Text, styles, Tab, styles, Pill, PillImpl(), Props (+5 more)
...
Cohesion: 0.09
Nodes (11): AppUser, GradeLevel, MOCK_USER, UserRole, AuthContext, AuthContextType, RegistrationStatus, IoniconName (+3 more)
...
Cohesion: 0.12
Nodes (13): useAuth(), NAV, Sidebar(), useAuth(), DashboardLayout(), NAV, Dashboard(), DashboardPage() (+5 more)
...
Cohesion: 0.13
Nodes (9): navTheme, queryClient, Surface, DOC_TYPES, Document, IoniconName, styles, Props (+1 more)
...
Cohesion: 0.2
Nodes (15): approveRegistration(), CompetitionFormData, CompetitionRound, createCompetition(), deleteCompetition(), exportRegistrationsCSV(), getAuthHeaders(), getCompetitionRegistrations() (+7 more)
...
Cohesion: 0.14
Nodes (4): getProfile(), updateProfile(), UserProfile, styles

### Community 70 - "Cluster 70"
Cohesion: 0.16
Nodes (4): NAV, AuthProvider(), Ctx, LINKS
...
Cohesion: 0.25
Nodes (4): RequestOptions, School, SchoolSearchParams, SchoolSearchResponse
...
## Knowledge Gaps
- **1064 isolated node(s):** `{ defineConfig }`, `expoConfig`, `RegistrationStatus`, `AuthContextType`, `BulkJob` (+1059 more)
...
- **Why does `Button()` connect `Payments Backend` to `Admin Mobile Screens`, `Cluster 64`, `School Auth Context`, `Mobile Admin Service`, `Database Columns & Keys`, `Express Bootstrap & Errors`, `Web API Client`, `Web UI Components`, `Reset Project Script`, `Cluster 84`, `Legacy Vite/Express Stack`, `Cluster 57`, `Cluster 59`, `Analytics & Competition Detail`?**
  _High betweenness centrality (0.061) - this node is a cross-community bridge._
- **Why does `Card()` connect `Database Columns & Keys` to `Admin Mobile Screens`, `Cluster 64`, `School Auth Context`, `Mobile Admin Service`, `Web API Client`, `Historical Phone Login`, `Web UI Components`, `Cluster 84`, `Legacy Vite/Express Stack`, `Payments Backend`, `Cluster 57`?**
  _High betweenness centrality (0.031) - this node is a cross-community bridge._
- **Why does `cn()` connect `Legacy Vite/Express Stack` to `Admin Mobile Screens`, `School Auth Context`, `Express Bootstrap & Errors`, `Database Columns & Keys`, `Web API Client`, `Web UI Components`, `Cluster 82`, `Reset Project Script`, `Cluster 84`, `Mobile Auth Service`, `Payments Backend`, `Cluster 61`, `Analytics & Competition Detail`?**
