...
## Corpus Check
- 279 files · ~3,348,663 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2340 nodes · 4361 edges · 205 communities (131 shown, 74 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 72 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `17661f76`
...
4. `Brand` - 41 edges
5. `Sprint Plan (Full Roadmap)` - 34 edges
6. `Card()` - 33 edges
7. `Button()` - 33 edges
8. `pool` - 33 edges
9. `Text` - 32 edges
...
Cohesion: 0.05
Nodes (68): CompetitionAdminLayout(), CompetitionAdminPage(), EmcAdminPage(), PendingRow, StatusFilter, adminHttp, emcHttp, metadata (+60 more)
...
Cohesion: 0.08
Nodes (33): FILTERS, schoolHttp, { Provider, useHook }, SchoolContext, SchoolCtx, schoolFetch(), schoolHttp, useSchool() (+25 more)

### Community 3 - "Web Admin Layout"
Cohesion: 0.07
Nodes (28): BatchResult, BulkPaymentPage(), fmtRp(), RegistrationRow, Competition, STATUS_BADGE, STATUS_STYLE, ADMIN_QUICK (+20 more)
...
Cohesion: 0.05
Nodes (36): adminOnly(), audit(), AuditOptions, REDACT_KEYS, organizerOnly(), compIdFilter, conditions, csv (+28 more)

### Community 8 - "Auth & Competitions Routes"
Cohesion: 0.1
Nodes (27): CATEGORIES, CompetitionsPage(), Field(), FILTERS, fmtForInput(), FORM_DEFAULTS, CATEGORIES, CompetitionFormProps (+19 more)
...
Cohesion: 0.08
Nodes (30): authLimiter, bulkUploadLimiter, otpSendLimiter, otpVerifyLimiter, passwordResetLimiter, pinVerifyLimiter, fileContent, parsed (+22 more)
...
Cohesion: 0.13
Nodes (17): CATS, STATUS_CLS, STATUS_STYLE, STATUSES, FORM_DEFAULTS, PendingSchool, STATUS_BADGE, Dialog() (+9 more)

### Community 16 - "Web UI Components"
Cohesion: 0.06
Nodes (33): SPRINT 0 — Quick Wins ✅ COMPLETE, SPRINT 10 — Mobile Bug Fixes (May 6, 2026 Session 2) ✅ COMPLETE, SPRINT 11 — Bug Fixes (May 6, 2026 Session 3) ✅ COMPLETE, SPRINT 12 — Rebrand Kompetix → Competzy (May 8, 2026 Session 4) ✅ COMPLETE, SPRINT 13 — Production Infra Templates (May 9, 2026 Session 5) ✅ LOCAL ARTIFACTS DONE, SPRINT 14 — Compliance & Security Hardening (May 8–9, 2026 Sessions 4–5) ✅ COMPLETE, SPRINT 15 — Launch 1 Polish (May 8, 2026 Session 4) ✅ COMPLETE, SPRINT 16 — School Portal Soft Launch (May 9, 2026 Session 5) ✅ COMPLETE (+25 more)
...
Cohesion: 0.11
Nodes (7): pool, env, ACCOUNTS, main(), normalizePhone(), getRecommendations(), parseInterests()
...
Cohesion: 0.12
Nodes (16): code, e164, email, expiresAt, password, router, token, tokenHash (+8 more)
...
Cohesion: 0.13
Nodes (14): Competition, Registration, STATUS_CLS, STATUS_STYLE, STATUS_TABS, Pager(), PagerProps, Tabs() (+6 more)
...
Cohesion: 0.11
Nodes (18): AppShellProps, AppShellUser, NavItem, Separator(), Sidebar(), SidebarContent(), SidebarFooter(), SidebarGroup() (+10 more)

### Community 40 - "Beyond Classroom PDF"
Cohesion: 0.12
Nodes (18): useIsMobile(), SidebarContext, SidebarContextProps, SidebarGroupAction(), SidebarGroupLabel(), SidebarInput(), SidebarMenuAction(), SidebarMenuItem() (+10 more)
...
Cohesion: 0.15
Nodes (12): CatalogCompetition, CompetitionCard(), fmtDate(), Competition, CompetitionDetailPage(), fmtDate(), fmtRp(), formatCurrency() (+4 more)
...
Cohesion: 0.13
Nodes (11): useAuth(), NAV, Sidebar(), useAuth(), Dashboard(), DashboardPage(), fmtRp(), Kpi (+3 more)
...
Cohesion: 0.24
Nodes (18): AuthContext (useUser), ChildrenScreen, config/api (API_BASE_URL), document.service, DocumentVaultScreen, LinkParentScreen, Parent-Student PIN Invitation Flow, ProfileEditScreen (+10 more)

### Community 51 - "Reset Project Script"
Cohesion: 0.12
Nodes (10): IoniconName, PAYER_OPTIONS, PayerKind, PaymentState, STATE_CONTENT, styles, formatDate(), MyRegistrationDetailsScreen() (+2 more)
...
Cohesion: 0.23
Nodes (14): analytics, CompetitionDetailArchive, CompetitionDetailPage, DiscoverScreen, competitions.service, favorites.service, IconSymbol, MyCompetitionsScreen (+6 more)
...
Cohesion: 0.21
Nodes (10): SchoolProvider(), DashboardLayout(), NAV, ADMIN_NAV, SchoolLayout(), SchoolLayoutInner(), TEACHER_NAV, AppShell() (+2 more)
...
Cohesion: 0.2
Nodes (6): ACTIONABLE, ACTIONABLE_STATUSES, Competition, Registration, STATUS_CLS, STATUS_STYLE
...
## Knowledge Gaps
- **947 isolated node(s):** `{ defineConfig }`, `expoConfig`, `RegistrationStatus`, `AuthContextType`, `BulkJob` (+942 more)
...
- **Why does `Button()` connect `Auth & Competitions Routes` to `Admin Mobile Screens`, `Mobile API Service Layer`, `Web Admin Layout`, `Mobile Tabs Misc`, `Competitions Routes & Recs`, `Beyond Classroom PDF`, `Auth Register Screen`, `Parent Routes & Email`, `Cluster 82`, `Legacy Vite/Express Stack`, `Document Vault Flow`?**
  _High betweenness centrality (0.050) - this node is a cross-community bridge._
- **Why does `Card()` connect `Web Admin Layout` to `Admin Mobile Screens`, `Mobile API Service Layer`, `Mobile Tabs Misc`, `Auth & Competitions Routes`, `Auth Register Screen`, `Historical Phone Login`, `Parent Routes & Email`, `Cluster 82`, `Legacy Vite/Express Stack`, `Document Vault Flow`, `Organizer Competition Forms`?**
  _High betweenness centrality (0.025) - this node is a cross-community bridge._
- **Why does `cn()` connect `Document Vault Flow` to `Admin Mobile Screens`, `Mobile API Service Layer`, `Web Admin Layout`, `Mobile Tabs Misc`, `Cluster 67`, `Competitions Routes & Recs`, `Auth & Competitions Routes`, `Beyond Classroom PDF`, `Auth Register Screen`, `Parent Routes & Email`, `Cluster 79`, `Cluster 82`, `Cluster 55`, `Organizer Competition Forms`?**
