...
## Corpus Check
- 328 files · ~3,404,634 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2729 nodes · 5632 edges · 196 communities (123 shown, 73 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 94 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a2680452`
...
## Communities (196 total, 73 thin omitted)

### Community 0 - "Admin Mobile Screens"
Cohesion: 0.05
Nodes (68): CompetitionAdminLayout(), CompetitionAdminPage(), EmcAdminPage(), PendingRow, StatusFilter, CompetitionAnnouncementsLayout(), Announcement, AnnouncementCard() (+60 more)

### Community 1 - "School Auth Context"
Cohesion: 0.07
Nodes (42): schoolHttp, CATEGORIES, CATS, CompetitionsPage(), Field(), FILTERS, fmtForInput(), FORM_DEFAULTS (+34 more)

### Community 2 - "Mobile API Service Layer"
Cohesion: 0.07
Nodes (40): DEFAULTS, adminHttp, commerceHttp, marketingHttp, questionMakerHttp, CHECK_TYPE_LABEL, CHECK_TYPE_OPTIONS, CheckType (+32 more)
...
Cohesion: 0.05
Nodes (39): Shadow, Spacing, Text, Type, Slide, slides, styles, IoniconName (+31 more)
...
Cohesion: 0.06
Nodes (46): questionBankHttp, { Provider, useHook }, CATEGORIES, CompetitionFormProps, DEFAULTS, GRADE_LEVELS, STATUSES, Answer (+38 more)
...
Cohesion: 0.07
Nodes (36): AnnouncementsPage(), ExamsListPage(), GradingQueuePage(), ExamEditorPage(), ExamQuestion, GRADE_OPTIONS, LoadedExam, QuestionEditorPage() (+28 more)
...
Cohesion: 0.08
Nodes (27): BatchResult, RegistrationRow, Competition, CsvRow, JobStatus, STEPS, CatalogCompetition, CompetitionCard() (+19 more)
...
Cohesion: 0.11
Nodes (33): announcement(), area(), exam(), localToday(), main(), product(), question(), referral() (+25 more)
...
Cohesion: 0.07
Nodes (16): AuthContextType, Registration, RegistrationStatus, AffiliatedAccess, create(), CreateParams, getCredentials(), RegistrationDetail (+8 more)

### Community 29 - "School Admin Routes"
Cohesion: 0.1
Nodes (19): FILTERS, defaultCompetition, destinationFor(), goTo(), Mode, ROLES, Competition, Registration (+11 more)
...
Cohesion: 0.12
Nodes (22): Sidebar(), SidebarContext, SidebarContextProps, SidebarGroupAction(), SidebarGroupLabel(), SidebarInput(), SidebarInset(), SidebarMenuAction() (+14 more)
...
Cohesion: 0.12
Nodes (13): navTheme, queryClient, RootLayout(), styles, AuthTab, styles, AppInput(), AppInputProps (+5 more)
...
Cohesion: 0.14
Nodes (8): authApi, NAV, AuthContext, Ctx, useAuth(), DashboardLayout(), Login(), LINKS
...
Cohesion: 0.18
Nodes (7): Dashboard(), DashboardPage(), fmtRp(), Kpi, LINKS, QUICK_LINKS, ChartCard()
...
## Knowledge Gaps
- **1128 isolated node(s):** `{ defineConfig }`, `expoConfig`, `RegistrationStatus`, `AuthContextType`, `BulkJob` (+1123 more)
...
- **Why does `Button()` connect `Registrations Routes` to `Admin Mobile Screens`, `School Auth Context`, `Mobile API Service Layer`, `Mobile Admin Service`, `Database Columns & Keys`, `k6 Load Test`, `Admin / Audit Middleware`, `Web Auth API`, `Auth & Twilio OTP`, `Cluster 79`, `Competition Detail Mobile`, `School Admin Routes`?**
  _High betweenness centrality (0.061) - this node is a cross-community bridge._
- **Why does `Card()` connect `Registrations Routes` to `Admin Mobile Screens`, `School Auth Context`, `Mobile API Service Layer`, `Web Auth API`, `Database Columns & Keys`, `Admin / Audit Middleware`, `Cluster 71`, `Auth & Twilio OTP`, `Cluster 79`, `Legacy Vite/Express Stack`, `School Admin Routes`?**
  _High betweenness centrality (0.035) - this node is a cross-community bridge._
- **Why does `cn()` connect `Web Auth API` to `School Auth Context`, `Mobile API Service Layer`, `k6 Load Test`, `Cluster 69`, `Admin / Audit Middleware`, `Cluster 71`, `Auth & Twilio OTP`, `Registrations Routes`, `Cluster 79`, `Cluster 78`, `Legacy Vite/Express Stack`, `Competition Detail Mobile`, `Cluster 59`, `School Admin Routes`?**
